...
def t340000_x2(z1=_, flag1=6001, flag2=6000):
    """ State 0,1 """
    while True:
...
def t340000_x5():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """ State 3,13 """
        call = t340000_x2(z1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """ State 7 """
            ...
            pass
    """ State 12 """
    assert t340000_x2(z1=6101, flag1=6001, flag2=6000)
    """ State 5 """
    ...
    if GetPlayerChrType() == 8:
        ...
        if ComparePlayerStatus(31, 0, 0) == 1:
            ...
            if ComparePlayerStatus(32, 0, 0) == 1:
                """ State 6,18 """
                call = t340000_x0(action2=10020054)
                if call.Get() == 0:
                    pass
                elif call.Get() == 1:
                    """ State 5 """
                ...
                """ State 20 """
                call = t340000_x0(action2=10020053)
                if call.Get() == 0:
                    """ State 15 """
                    if (ComparePlayerStatus(8, 4, GetLevelUpSoulCost(GetPlayerStatus(33) - GetPlayerStatus(32),
                        ...
                        assert t340000_x3(action1=10010754)
                        Goto('L0')
                elif call.Get() == 1:
                    """ State 16 """
                    Goto('L0')
            ...
            """ State 23 """
            # action:10010912:
            assert t340000_x3(action1=10010912)
        else:
            """ State 8,21 """
            # action:10010730:
            assert t340000_x3(action1=10010730)
    else:
        """ State 3,19 """
        # action:10010730:
        assert t340000_x3(action1=10010730)
