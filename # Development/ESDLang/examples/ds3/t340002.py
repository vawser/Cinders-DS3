    ...
    if GetPlayerChrType() == 8:
        ...
        if ComparePlayerStatus(31, 0, 0) == 1:
            ...
            if ComparePlayerStatus(32, 0, 0) == 1:
                """ State 6,18 """
                call = t340002_x0(action2=10020054)
                if call.Get() == 0:
                    pass
                elif call.Get() == 1:
                    """ State 5 """
                ...
                """ State 20 """
                call = t340002_x0(action2=10020053)
                if call.Get() == 0:
                    """ State 15 """
                    if (ComparePlayerStatus(8, 4, GetLevelUpSoulCost(GetPlayerStatus(33) - GetPlayerStatus(32),
                        ...
                        assert t340002_x3(action1=10010754)
                        Goto('L0')
                elif call.Get() == 1:
                    """ State 16 """
                    Goto('L0')
            ...
            """ State 23 """
            # action:10010912:
            assert t340002_x3(action1=10010912)
        else:
            """ State 8,21 """
            # action:10010730:
            assert t340002_x3(action1=10010730)
    else:
        """ State 3,19 """
        # action:10010730:
        assert t340002_x3(action1=10010730)
