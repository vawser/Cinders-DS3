...
def t370290_x5(text1=_, flag2=0, mode1=1):
    """ State 0,4 """
    assert t370290_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t370290_x13():
    ...
    while True:
        call = t370290_x15()
        assert not GetEventStatus(1347) or not GetEventStatus(9013) or GetEventStatus(13700651) == 1
        """ State 2 """
        call = t370290_x16()
...
def t370290_x19():
    ...
    if GetEventStatus(8263) == 1:
        """ State 2 """
        # talk:29002430: 
        assert t370290_x5(text1=29002430, flag2=0, mode1=1)
    else:
        """ State 3 """
        # talk:29002330: 
        assert t370290_x5(text1=29002330, flag2=0, mode1=1)
    """ State 4 """
    return 0
