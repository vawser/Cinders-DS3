...
def t400210_x6():
    ...
    if GetEventStatus(74000251) == 1:
        ...
        assert (t400210_x15(goods1=2107, goods2=2108, goods3=2109, goods4=2110, goods5=2111, goods6=2112,
                ...
                goods14=2149, goods15=2151, goods16=2116, goods17=2152, goods18=2154, goods19=2157))
...
def t400210_x15(goods1=2107, goods2=2108, goods3=2109, goods4=2110, goods5=2111, goods6=2112, goods7=2113,
    ...
    while True:
        ...
        # goods:2107:Mortician's Ashes, goods:2108:Dreamchaser's Ashes, goods:2109:Paladin's Ashes, goods:2110:Grave Warden's Ashes, goods:2111:Greirat's Ashes, goods:2112:Orbeck's Ashes, goods:2113:Cornyx's Ashes, goods:2114:Karla's Ashes, goods:2115:Irina's Ashes, goods:2150:Patches' Ashes, action:15011000:Give umbral ash
        AddTalkListDataIf(ComparePlayerInventoryNumber(3, goods1, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods2, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods3, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods4, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods5, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods6, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods7, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods8, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods9, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods10, 2, 0, 0) == 1,
                          3, 15011000, -1)
        """ State 13 """
        # goods:2107:Mortician's Ashes, goods:2108:Dreamchaser's Ashes, goods:2109:Paladin's Ashes, goods:2110:Grave Warden's Ashes, goods:2111:Greirat's Ashes, goods:2112:Orbeck's Ashes, goods:2113:Cornyx's Ashes, goods:2114:Karla's Ashes, goods:2115:Irina's Ashes, goods:2150:Patches' Ashes
        if (ComparePlayerInventoryNumber(3, goods1, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3,
            goods2, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods3, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3,
            goods4, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods5, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3,
            goods6, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods7, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3,
            goods8, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods9, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3,
            goods10, 2, 0, 0) == 1):
            """ State 16 """
            Label('L0')
            # action:15011000:Give umbral ash
            AddTalkListData(3, 15011000, -1)
        else:
            """ State 15 """
            # goods:2146:Excrement-covered Ashes, goods:2147:Prisoner Chief's Ashes, goods:2148:Xanthous Ashes, goods:2149:Hollow's Ashes, goods:2151:Dragon Chaser's Ashes, goods:2116:Yuria's Ashes, goods:2152:Easterner's Ashes
            if (ComparePlayerInventoryNumber(3, goods11, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3,
                goods12, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods13, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3,
                goods14, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods15, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3,
                goods16, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods17, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3,
                goods18, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods19, 2, 0, 0) == 1):
                Goto('L0')
            else:
                pass
        """ State 14 """
        ...
        if GetTalkListEntryResult() == 1:
            ...
            """ State 7,17 """
            call = t400210_x13(goods1=goods1, goods2=goods2, goods3=goods3, goods4=goods4, goods5=goods5,
                               goods6=goods6, goods7=goods7, goods8=goods8, goods9=goods9, goods10=goods10,
                               goods11=goods11, goods12=goods12, goods13=goods13, goods14=goods14, goods15=goods15,
                               goods16=goods16, goods17=goods17, goods18=goods18, goods19=goods19)
            if call.Get() == 1:
                pass
            elif call.Done():
                continue
