...
def t400220_x15(goods1=2118):
    ...
    while True:
        ...
        # goods:2118:Loretta's Bone, action:15012000:Give <?gdsparam@2118?> 
        AddTalkListDataIf(ComparePlayerInventoryNumber(3, goods1, 2, 0, 0) == 1 and not GetEventStatus(74000301),
                          3, 15012000, -1)
