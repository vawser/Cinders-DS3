...
def t400230_x8(goods1=2132, goods2=2133, goods3=2134, goods4=2140):
    ...
    while True:
        ...
        """ State 2 """
        # action:15013000:Learn Sorceries
        AddTalkListData(1, 15013000, -1)
        # goods:2132:Sage's Scroll, goods:2133:Logan's Scroll, goods:2134:Crystal Scroll, goods:2140:Golden Scroll, action:15013020:Give Sorcery Scroll
...
def t400230_x17():
    ...
    elif (GetEventStatus(70000200) == 1 and GetEventStatus(74000582) == 1 and not GetEventStatus(50006130)
          and (not GetEventStatus(74000587) or GetEventStatus(70000900) == 1)):
        """ State 9 """
    ...
    elif (GetEventStatus(70000200) == 1 and GetEventStatus(73301160) == 1 and GetEventStatus(73301140)
          == 1 and GetEventStatus(73301150) == 1 and GetEventStatus(73301170) == 1 and not GetEventStatus(74000555)):
        """ State 12 """
...
def t400230_x24():
    """ State 0,1 """
    if GetEventStatus(70000200) == 1 and GetEventStatus(74000582) == 1:
        """ State 2 """
