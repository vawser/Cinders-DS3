...
def t500731_x9(flag1=75000120, flag2=75000121, z1=75000121, z2=75000121, flag3=1810):
    """ State 0,5 """
    while True:
        call = t500731_x20(z7=6830, flag9=1815, flag10=6000, flag11=6000, flag12=6000, flag13=6000)
        if call.Done():
            """ State 3 """
...
def t500731_x14():
    ...
    if not GetEventStatus(75000100):
        """ State 3 """
        assert t500731_x24(text4=83000000, z6=75000100, flag7=0, mode2=1)
    else:
        """ State 2 """
        if not GetEventStatus(75000101):
            """ State 4 """
            assert t500731_x24(text4=83000100, z6=75000101, flag7=0, mode2=1)
        else:
            """ State 5 """
...
def t500731_x15():
    ...
    if GetEventStatus(15000703) == 1:
        ...
        if not GetEventStatus(50006621):
            """ State 15 """
            assert t500731_x24(text4=83000700, z6=75000104, flag7=0, mode2=1)
            """ State 16 """
        ...
        if GetEventStatus(55000450) == 1:
            ...
            if not GetEventStatus(50006620):
                ...
                if not GetEventStatus(75000104):
                    ...
                    Goto('L0')
            """ State 13 """
            assert t500731_x24(text4=83000650, z6=75000104, flag7=0, mode2=1)
        else:
            """ State 3 """
            if not GetEventStatus(75000102):
                """ State 8 """
                assert t500731_x24(text4=83000300, z6=75000102, flag7=0, mode2=1)
            else:
                """ State 4 """
                if not GetEventStatus(75000103):
                    """ State 9 """
                    assert t500731_x24(text4=83000400, z6=75000103, flag7=0, mode2=1)
                else:
                    """ State 10 """
...
def t500731_x16():
    ...
    if not GetEventStatus(50006622):
        ...
        """ State 7 """
        assert t500731_x24(text4=83000970, z6=75100200, flag7=1, mode2=1)
        """ State 11 """
        assert t500731_x27(z3=33, z4=9034, flag4=6083)
    else:
        """ State 2 """
        if not GetEventStatus(75100200):
            ...
            if not GetEventStatus(75100201):
                """ State 8 """
                assert t500731_x24(text4=83001000, z6=75100201, flag7=0, mode2=1)
            else:
                """ State 9 """
...
def t500731_x17():
    ...
    if not GetEventStatus(75100205):
        ...
        if GetEventStatus(75100232) == 1:
            """ State 11 """
            assert t500731_x19(text1=83001500, z5=75100204)
        else:
            """ State 3 """
            if GetEventStatus(75100231) == 1:
                """ State 10 """
                assert t500731_x19(text1=83001400, z5=75100203)
            else:
                """ State 4 """
                if not GetEventStatus(75100202):
                    """ State 8 """
                    assert t500731_x19(text1=83001200, z5=75100202)
                else:
                    """ State 9 """
                    assert t500731_x19(text1=83001300, z5=75100202)
    else:
        """ State 5 """
        if not GetEventStatus(75100206):
            """ State 6 """
            assert t500731_x24(text4=83001700, z6=75100206, flag7=0, mode2=1)
        else:
            """ State 7 """
...
def t500731_x18():
    ...
    if DoesSelfHaveSpEffect(159) == 1:
        """ State 5 """
        assert t500731_x27(z3=27, z4=9028, flag4=6077)
    else:
        pass
    """ State 1 """
    if not GetEventStatus(75100207):
        """ State 3 """
        assert t500731_x24(text4=83001900, z6=75100207, flag7=0, mode2=1)
    else:
        """ State 4 """
...
def t500731_x19(text1=_, z5=_):
    ...
    if GetTalkListEntryResult() == 1:
        """ State 7 """
        assert t500731_x24(text4=83001600, z6=75100205, flag7=0, mode2=1)
        """ State 5 """
        Label('L0')
        SetEventState(z5, 1)
...
def t500731_x20(z7=6830, flag9=1815, flag10=6000, flag11=6000, flag12=6000, flag13=6000):
    """ State 0,1 """
    while True:
...
def t500731_x24(text4=_, z6=_, flag7=_, mode2=1):
    """ State 0,5 """
    assert t500731_x22() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t500731_x27(z3=_, z4=_, flag4=_):
    """ State 0,1 """
