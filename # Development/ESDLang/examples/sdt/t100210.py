...
def t100210_1():
    ...
    while True:
        call = t100210_x6(flag5=1519, flag6=1515, flag7=1501, val1=5, val2=30, val3=40, val4=10, val5=12,
                          flag8=6001, val6=7002100, flag9=6000, flag10=6001, flag11=6000, flag12=6000,
                          mode1=1, val7=1000000, val8=1000000, val9=1000000, mode2=1, mode3=1, mode4=0,
                          val10=1000000, val11=1000000, mode5=0, flag13=6000, mode6=0)
...
def t100210_1000():
    ...
    if GetEventStatus(1502) == 1:
        ...
        if GetEventStatus(71000350) == 1:
            ...
            assert t100210_x5(text5=21000100, flag18=0, mode12=1)
        else:
            """ State 5,9 """
            # talk:21000200:Hmm...
            assert t100210_x5(text5=21000200, flag18=0, mode12=1)
    else:
        """ State 3,7 """
        # talk:21000000:You've done well to come this far. 
        assert t100210_x4(text6=21000000, z2=71000350, flag19=0, mode13=1)
    """ State 1 """
    c1119(0)
    ...
    if GetEventStatus(1515) == 1:
        ...
        while True:
            if not GetEventStatus(71000351) and GetEventStatus(71000389) == 1:
                """ State 6 """
                # talk:21000010:   
                assert t100210_x3(text1=21000010, flag1=71000351, flag20=1, mode14=1)
                ...
                assert t100210_x5(text5=21060100, flag18=1, mode12=1)
    """ State 2 """
    while True:
        assert not GetEventStatus(71000391)
        """ State 5 """
        # talk:21030100:Nothing but a rogue after all!
        assert t100210_x3(text1=21030100, flag1=71000391, flag20=1, mode14=1)
...
def t100210_1103():
    ...
    if GetEventStatus(1515) == 1 or GetEventStatus(1516) == 1:
        ...
        assert t100210_x5(text5=21030200, flag18=1, mode12=1)
    else:
        """ State 4,6 """
        # talk:21060200:I...I've failed...
        assert t100210_x5(text5=21060200, flag18=1, mode12=1)
    """ State 1 """
    def WhilePaused():
        c1119(0)
...
def t100210_2000():
    """ State 0,3 """
    assert (t100210_x0(val6=7002100, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000,
            mode7=0, flag9=6000, val7=1000000, val8=1000000, val9=1000000, val10=1000000, val11=1000000))
    """ State 2 """
    c511(GetEventStatus(1502) == 1, 71000388, 1)
    """ State 1 """
    def WhilePaused():
        c1119(0)

def t100210_x0(val6=7002100, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000, mode7=0,
               flag9=6000, val7=1000000, val8=1000000, val9=1000000, val10=1000000, val11=1000000):
    """ State 0,3 """
    while Loop('mainloop'):
        call = t100210_x27(val6=val6, flag10=flag10, flag14=flag14, flag15=flag15, flag16=flag16, flag17=flag17,
...
def t100210_x3(text1=_, flag1=_, flag20=1, mode14=1):
    """ State 0,7 """
...
def t100210_x4(text6=21000000, z2=71000350, flag19=0, mode13=1):
    """ State 0,7 """
    assert t100210_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 5 """
    if not flag19:
...
def t100210_x5(text5=_, flag18=_, mode12=1):
    """ State 0,6 """
    assert t100210_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 4 """
    if not flag18:
...
def t100210_x6(flag5=1519, flag6=1515, flag7=1501, val1=5, val2=30, val3=40, val4=10, val5=12, flag8=6001,
               val6=7002100, flag9=6000, flag10=6001, flag11=6000, flag12=6000, mode1=1, val7=1000000,
               val8=1000000, val9=1000000, mode2=1, mode3=1, mode4=0, val10=1000000, val11=1000000, mode5=0,
               flag13=6000, mode6=0):
    """ State 0,1 """
    while True:
        RemoveMyAggro()
        call = t100210_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag8=flag8, val6=val6,
...
def t100210_x7(val1=5, val2=30, val3=40, val4=10, val5=12, flag8=6001, val6=7002100, flag9=6000, flag10=6001,
    ...
    """ State 0,4 """
    while True:
        call = t100210_x24(val6=val6, flag9=flag9, flag10=flag10, val7=val7, val8=val8, val9=val9, val10=val10,
                           val11=val11)
        if call.Done():
            """ State 1 """
            Label('L0')
...
def t100210_x16():
    """ State 0,1 """
    assert t100210_x18(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t100210_x17(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t100210_x18(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """ State 5 """
    return 0

def t100210_x18(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """ State 0,4 """
    if f118(z1) == 1:
        """ State 2 """
...
def t100210_x19():
    """ State 0,1 """
    call = t100210_x18(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert t100210_x1()
    elif call.Get() == 0:
...
def t100210_x20():
    """ State 0,2 """
    call = t100210_x18(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 1 """
        pass
    elif call.Done():
...
def t100210_x21():
    """ State 0,1 """
    assert t100210_x18(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t100210_x23():
    """ State 0,1 """
    assert t100210_x18(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t100210_x24(val6=7002100, flag9=6000, flag10=6001, val7=1000000, val8=1000000, val9=1000000, val10=1000000,
                val11=1000000):
    """ State 0,1 """
    call = t100210_x18(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert (t100210_x0(val6=val6, flag10=flag10, flag14=6000, flag15=6000, flag16=6000, flag17=6000,
...
def t100210_x26():
    """ State 0,1 """
    assert t100210_x18(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t100210_x27(val6=7002100, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000, mode7=0,
                flag9=6000):
    """ State 0,1 """
    while Loop('mainloop'):
...
def t100210_x28(text1=21030000, flag1=71000396, text2=21030010, flag2=71000397, text3=-1, flag3=71000398,
    ...
    if not text1 == -1 and not GetEventStatus(flag1):
        """ State 4 """
        assert t100210_x3(text1=text1, flag1=flag1, flag20=1, mode14=1)
    elif not text2 == -1 and not GetEventStatus(flag2):
        """ State 5 """
        assert t100210_x3(text1=text2, flag1=flag2, flag20=1, mode14=1)
    elif not text3 == -1 and not GetEventStatus(flag3):
        """ State 6 """
        assert t100210_x3(text1=text3, flag1=flag3, flag20=1, mode14=1)
    else:
        """ State 7 """
        assert t100210_x3(text1=text4, flag1=flag4, flag20=1, mode14=1)
    """ State 8 """
    return 0
