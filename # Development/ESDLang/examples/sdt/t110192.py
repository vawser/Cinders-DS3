...
def t110192_1():
    ...
    t110192_x4(flag1=70009029, flag2=70009025, flag3=70009026, val1=5, val2=10, val3=12, val4=10, val5=12,
               flag4=6001, val6=7001902, flag5=6000, flag6=6001, flag7=6000, flag8=6000, z1=1, val7=1000000,
...
def t110192_x0(val6=7001902, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, mode6=0,
               flag5=6000):
    """ State 0,1 """
    while Loop('mainloop'):
...
def t110192_x4(flag1=70009029, flag2=70009025, flag3=70009026, val1=5, val2=10, val3=12, val4=10, val5=12,
    ...
    while True:
        RemoveMyAggro()
        call = t110192_x5(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, val6=val6,
...
def t110192_x5(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, val6=7001902, flag5=6000, flag6=6001,
               flag7=6000, flag8=6000, z1=1, val7=1000000, val8=1000000, val9=1000000):
    """ State 0,4 """
    while True:
        call = t110192_x22(val6=val6, flag5=flag5, flag6=flag6, val7=val7, val8=val8, val9=val9)
        if call.Done():
            """ State 1 """
            Label('L0')
...
def t110192_x22(val6=7001902, flag5=6000, flag6=6001, val7=1000000, val8=1000000, val9=1000000):
    """ State 0,3 """
    call = t110192_x16(z2=2000, mode1=0, mode2=0, mode3=0, mode4=0)
    if call.Get() == 1:
        """ State 4 """
        while Loop('mainloop'):
            call = t110192_x0(val6=val6, flag6=flag6, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
                              mode6=0, flag5=flag5)
            if call.Done():
                break
