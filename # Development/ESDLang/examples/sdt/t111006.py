...
def t111006_x2(z3=17, z4=9019, flag3=6067):
    """ State 0,1 """
...
def t111006_x3(z2=_, flag1=6001, flag2=6000):
    """ State 0,1 """
    while True:
...
def t111006_x5(action1=10010713):
    """ State 0,1 """
...
def t111006_x7():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """ State 17 """
        Label('L1')
        assert t111006_x3(z2=6101, flag1=6001, flag2=6000)
        """ State 13 """
        ...
        """ State 3,18 """
        call = t111006_x3(z2=6100, flag1=6001, flag2=6000)
        if call.Done():
            """ State 5 """
            ClearPlayerDamageInfo()
            """ State 6 """
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            if GetEventStatus(2030) == 1:
                ...
                """ State 16,31 """
                # action:10010713:Installation of this game is currently incomplete, \nso you are unable to progress further.
                assert t111006_x5(action1=10010713)
            ...
            assert t111006_x13(z1=3000, goods1=4400, val1=30)
...
def t111006_x13(z1=3000, goods1=4400, val1=30):
    """ State 0,1 """
    if f109(0) + f109(1) < val1:
        ...
        if ComparePlayerInventoryNumber(3, goods1, 4, 1, 0) == 1:
            """ State 4,10 """
            call = t111006_x0(action3=13030001)
            if call.Done() and GetGenericDialogButtonResult() == 1:
                ...
                c1108(f109(0) + 1, 0)
                """ State 12 """
                assert t111006_x4(action2=15100160)
            elif call.Done():
                """ State 7 """
                pass
        else:
            """ State 5,11 """
            assert t111006_x4(action2=13030000)
    else:
        """ State 3,13 """
        assert t111006_x4(action2=13030002)
    """ State 14 """
    return 0
