...
def t111601_1():
    """ State 0,1 """
    # talk:60002700:You're saying we don't have enough salt?
    t111601_x7(val1=7009102, z1=71118005, text1=60002700)

def t111601_x0(val1=7009102, flag1=6001, flag2=6001, flag3=6001, flag4=6001, flag5=6001, mode1=0, flag6=6000,
               val2=-1, val3=-1, val4=-1, val5=-1, val6=-1):
    """ State 0,3 """
    while Loop('mainloop'):
        call = t111601_x10(val1=val1, flag1=flag1, flag2=flag2, flag3=flag3, flag4=flag4, flag5=flag5,
...
def t111601_x3(text1=60002700, z1=71118005, flag7=0, mode2=1):
    """ State 0,7 """
    assert t111601_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 5 """
    if not flag7:
        """ State 1 """
        # talk:60002700:You're saying we don't have enough salt?
...
def t111601_x5(val1=7009102, z1=71118005, text1=60002700):
    """ State 0,1 """
    while True:
        call = t111601_x6(val1=val1, z1=z1, text1=text1)
        assert not f114(2)
        """ State 2 """
        assert t111601_x8() and f114(2) == 1

def t111601_x6(val1=7009102, z1=71118005, text1=60002700):
    """ State 0,1 """
    while True:
        """ State 3 """
        assert (t111601_x0(val1=val1, flag1=6001, flag2=6001, flag3=6001, flag4=6001, flag5=6001, mode1=0,
                flag6=6000, val2=-1, val3=-1, val4=-1, val5=-1, val6=-1))
        """ State 2 """
        ClearPlayerDamageInfo()
        """ State 4 """
        call = t111601_x9(text1=text1, z1=z1)
        def WhilePaused():
            c1117(10, 10000)
        if call.Done():
            pass
...
def t111601_x7(val1=7009102, z1=71118005, text1=60002700):
    """ State 0,3 """
    while True:
        assert t111601_x8() and (f113() < 0.5 and f116(-1) == 1000000)
        """ State 1 """
        if GetCurrentStateElapsedTime() > 1:
            """ State 2 """
            call = t111601_x5(val1=val1, z1=z1, text1=text1)
            def WhilePaused():
                c1116()
...
def t111601_x9(text1=60002700, z1=71118005):
    """ State 0,1 """
    if f116(10000) == 10:
        """ State 3 """
        call = t111601_x3(text1=text1, z1=z1, flag7=0, mode2=1)
        if call.Done():
            pass
...
def t111601_x10(val1=7009102, flag1=6001, flag2=6001, flag3=6001, flag4=6001, flag5=6001, mode1=0, flag6=6000):
    """ State 0,1 """
    while Loop('mainloop'):
