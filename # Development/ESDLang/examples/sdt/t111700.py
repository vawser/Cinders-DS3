...
def t111700_1():
    ...
    t111700_x4(flag1=70009099, flag2=70009095, flag3=70009096, val1=5, val2=10, val3=12, val4=10, val5=12,
               flag4=6001, val6=7007110, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val7=1000000,
               val8=1000000, val9=1000000, mode2=1, mode3=1, mode4=0, val10=1000000, val11=1000000, mode5=0,
               flag9=71119000, mode6=0)
...
def t111700_1000():
    ...
    def WhilePaused():
        c1117(1101001, -1)
    def ExitPause():
        c511(not f116(-1) == 1101002, 71119000, 0)
    assert t111700_x3(text1=70060000, flag14=0, mode12=1)
    """ State 1 """
    def WhilePaused():
        c1119(0)

def t111700_x0(val6=7007110, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, mode7=0,
               flag5=6000, val7=1000000, val8=1000000, val9=1000000, val10=1000000, val11=1000000):
    """ State 0,3 """
    while Loop('mainloop'):
        call = t111700_x25(val6=val6, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12, flag13=flag13,
...
def t111700_x3(text1=70060000, flag14=0, mode12=1):
    """ State 0,6 """
...
def t111700_x4(flag1=70009099, flag2=70009095, flag3=70009096, val1=5, val2=10, val3=12, val4=10, val5=12,
    ...
    while True:
        RemoveMyAggro()
        call = t111700_x5(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, val6=val6,
...
def t111700_x5(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, val6=7007110, flag5=6000, flag6=6001,
    ...
    """ State 0,4 """
    while True:
        call = t111700_x22(val6=val6, flag5=flag5, flag6=flag6, val7=val7, val8=val8, val9=val9, val10=val10,
                           val11=val11)
        if call.Done():
            """ State 1 """
            Label('L0')
...
def t111700_x14():
    """ State 0,1 """
    assert t111700_x16(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t111700_x15(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t111700_x16(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """ State 5 """
    return 0

def t111700_x16(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """ State 0,4 """
    if f118(z1) == 1:
        """ State 2 """
...
def t111700_x17():
    """ State 0,1 """
    call = t111700_x16(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert t111700_x1()
    elif call.Get() == 0:
...
def t111700_x18():
    """ State 0,2 """
    call = t111700_x16(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 1 """
        pass
    elif call.Done():
...
def t111700_x19():
    """ State 0,1 """
    assert t111700_x16(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t111700_x21():
    """ State 0,1 """
    assert t111700_x16(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t111700_x22(val6=7007110, flag5=6000, flag6=6001, val7=1000000, val8=1000000, val9=1000000, val10=1000000,
                val11=1000000):
    """ State 0,1 """
    call = t111700_x16(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert (t111700_x0(val6=val6, flag6=flag6, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t111700_x24():
    """ State 0,1 """
    assert t111700_x16(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t111700_x25(val6=7007110, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, mode7=0,
                flag5=6000):
    """ State 0,1 """
    while Loop('mainloop'):
