...
def t112330_1001():
    ...
    assert t112330_x4(text1=33065200, flag14=1, mode12=1)
    """ State 1 """
    def WhilePaused():
        c1119(0)
...
def t112330_1102():
    ...
    while True:
        if f120() - f121() == 1 and not GetEventStatus(71120255):
            ...
            call = t112330_x3(text2=33060000, z2=71120250, flag15=1, mode13=1)
            if call.Done():
                continue
        ...
        assert t112330_x3(text2=33060200, z2=71120255, flag15=1, mode13=1)

def t112330_2000():
    """ State 0,2 """

def t112330_x0(val6=-1, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, mode7=0, flag5=6000,
               val7=1000000, val8=1000000, val9=1000000, val10=1000000, val11=1000000):
    """ State 0,3 """
    while Loop('mainloop'):
        call = t112330_x26(val6=val6, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12, flag13=flag13,
...
def t112330_x3(text2=_, z2=_, flag15=1, mode13=1):
    """ State 0,7 """
...
def t112330_x4(text1=33065200, flag14=1, mode12=1):
    """ State 0,6 """
    assert t112330_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 4 """
    if not flag14:
...
def t112330_x5(flag1=9300, flag2=11125810, flag3=6000, val1=5, val2=60, val3=65, val4=60, val5=65, flag4=6001,
    ...
    while True:
        RemoveMyAggro()
        call = t112330_x6(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, val6=val6,
...
def t112330_x6(val1=5, val2=60, val3=65, val4=60, val5=65, flag4=6001, val6=-1, flag5=6000, flag6=6001,
    ...
    """ State 0,4 """
    while True:
        call = t112330_x23(val6=val6, flag5=flag5, flag6=flag6, val7=val7, val8=val8, val9=val9, val10=val10,
                           val11=val11)
        if call.Done():
            """ State 1 """
            Label('L0')
...
def t112330_x15():
    """ State 0,1 """
    assert t112330_x17(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t112330_x16(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t112330_x17(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """ State 5 """
    return 0

def t112330_x17(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """ State 0,4 """
    if f118(z1) == 1:
        """ State 2 """
...
def t112330_x18():
    """ State 0,1 """
    call = t112330_x17(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert t112330_x1()
    elif call.Get() == 0:
...
def t112330_x19():
    """ State 0,2 """
    call = t112330_x17(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 1 """
        pass
    elif call.Done():
...
def t112330_x20():
    """ State 0,1 """
    assert t112330_x17(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t112330_x22():
    """ State 0,1 """
    assert t112330_x17(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t112330_x23(val6=-1, flag5=6000, flag6=6001, val7=1000000, val8=1000000, val9=1000000, val10=1000000,
                val11=1000000):
    """ State 0,1 """
    call = t112330_x17(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert (t112330_x0(val6=val6, flag6=flag6, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t112330_x25():
    """ State 0,1 """
    assert t112330_x17(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t112330_x26(val6=-1, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, mode7=0, flag5=6000):
    """ State 0,1 """
    while Loop('mainloop'):
