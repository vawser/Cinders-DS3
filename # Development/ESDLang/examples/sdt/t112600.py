...
def t112600_1():
    """ State 0,1 """
    # talk:60000200:The moonlight shines strongly on the Moon-view Tower tonight...
    t112600_x7(val1=7009150, z1=71128000, text1=60000200)

def t112600_x0(val1=7009150, flag1=6001, flag2=6001, flag3=6001, flag4=6001, flag5=6001, mode1=0, flag6=6000,
               val2=-1, val3=-1, val4=-1, val5=-1, val6=-1):
    """ State 0,3 """
    while Loop('mainloop'):
        call = t112600_x10(val1=val1, flag1=flag1, flag2=flag2, flag3=flag3, flag4=flag4, flag5=flag5,
...
def t112600_x3(text1=60000200, z1=71128000, flag7=0, mode2=1):
    """ State 0,7 """
    assert t112600_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 5 """
    if not flag7:
        """ State 1 """
        # talk:60000200:The moonlight shines strongly on the Moon-view Tower tonight...
...
def t112600_x5(val1=7009150, z1=71128000, text1=60000200):
    """ State 0,1 """
    while True:
        call = t112600_x6(val1=val1, z1=z1, text1=text1)
        assert not f114(2)
        """ State 2 """
        assert t112600_x8() and f114(2) == 1

def t112600_x6(val1=7009150, z1=71128000, text1=60000200):
    """ State 0,1 """
    while True:
        """ State 3 """
        assert (t112600_x0(val1=val1, flag1=6001, flag2=6001, flag3=6001, flag4=6001, flag5=6001, mode1=0,
                flag6=6000, val2=-1, val3=-1, val4=-1, val5=-1, val6=-1))
        """ State 2 """
        ClearPlayerDamageInfo()
        """ State 4 """
        call = t112600_x9(text1=text1, z1=z1)
        def WhilePaused():
            c1117(10, 10000)
        if call.Done():
            pass
...
def t112600_x7(val1=7009150, z1=71128000, text1=60000200):
    """ State 0,3 """
    while True:
        assert t112600_x8() and (f113() < 0.5 and f116(-1) == 1000000)
        """ State 1 """
        if GetCurrentStateElapsedTime() > 1:
            """ State 2 """
            call = t112600_x5(val1=val1, z1=z1, text1=text1)
            def WhilePaused():
                c1116()
...
def t112600_x9(text1=60000200, z1=71128000):
    """ State 0,1 """
    if f116(10000) == 10:
        """ State 3 """
        call = t112600_x3(text1=text1, z1=z1, flag7=0, mode2=1)
        if call.Done():
            pass
...
def t112600_x10(val1=7009150, flag1=6001, flag2=6001, flag3=6001, flag4=6001, flag5=6001, mode1=0, flag6=6000):
    """ State 0,1 """
    while Loop('mainloop'):
