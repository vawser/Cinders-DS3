...
def t130260_1():
    """ State 0,1 """
    t130260_x5(flag1=1459, flag2=1455, flag3=1456, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
...
def t130260_1000():
    """ State 0,1,2,4 """
    # talk:26200000:(groan)
    assert t130260_x4(text1=26200000, flag14=0, mode12=1)
    """ State 3 """
    c1119(0)

def t130260_1001():
    """ State 0,2 """
    # talk:26031200:Oooh.... You said they'd be here...!
    assert t130260_x4(text1=26031200, flag14=1, mode12=1)
    """ State 1 """
    def WhilePaused():
        c1119(0)
...
def t130260_1101():
    """ State 0,2 """
    # talk:26200100:(Groan... groan...)
    assert t130260_x4(text1=26200100, flag14=1, mode12=1)
    """ State 1 """
    def WhilePaused():
        c1119(0)
...
def t130260_1102():
    ...
    while True:
        ...
        assert t130260_x3(text2=26031000, z2=72009044, flag15=1, mode13=1)

def t130260_1103():
    """ State 0,2 """
    if GetEventStatus(1444) == 1:
        """ State 3 """
        # talk:26030900:Gyaaah...
        assert t130260_x4(text1=26030900, flag14=1, mode12=1)
    else:
        pass
    """ State 1 """
    def WhilePaused():
...
def t130260_x3(text2=26031000, z2=72009044, flag15=1, mode13=1):
    """ State 0,7 """
    assert t130260_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 2 """
    SetEventState(z2, 1)
    """ State 6 """
    if not flag15:
...
def t130260_x4(text1=_, flag14=_, mode12=1):
    """ State 0,6 """
    assert t130260_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 4 """
    if not flag14:
...
def t130260_x5(flag1=1459, flag2=1455, flag3=1456, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               val6=7002620, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val7=1000000, val8=1000000,
               val9=1000000, mode2=1, mode3=1, mode4=1, val10=1000000, val11=1000000, mode5=0, flag9=6000,
               mode6=0):
    """ State 0,1 """
    while True:
        ...
        if (CheckSelfDeath() == 1 or GetEventStatus(flag1) == 1) and not GetEventStatus(flag9):
            ...
            """ State 3 """
            call = t130260_x21(val2=val2, val3=val3)
            if CheckSelfDeath() == 1 or GetEventStatus(flag1) == 1 or DoesSelfHaveSpEffect(30100) == 1:
                ...
                continue
        """ State 2 """
        call = t130260_x7(flag1=flag1, val2=val2, val3=val3)
...
def t130260_x6(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, val6=7002620, flag5=6000, flag6=6001,
    ...
    while True:
        ...
        if call.Done():
            """ State 1 """
            Label('L0')
            call = t130260_x8(val1=val1, mode1=mode1, mode2=mode2, mode3=mode3, mode4=mode4, mode5=mode5)
            def WhilePaused():
                GiveSpEffectToPlayer(30700)
            if call.Done():
                continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t130260_x10(val2=val2, val3=val3)

def t130260_x7(flag1=1459, val2=10, val3=12):
    """ State 0,1 """
...
def t130260_x8(val1=5, mode1=1, mode2=1, mode3=1, mode4=1, mode5=0):
    """ State 0,2 """
    ClearPlayerDamageInfo()
    TurnCharacterToFaceEntity(-1, 10000, -1)
    call = t130260_x16(mode2=mode2, mode4=mode4)
    def WhilePaused():
        c1117(mode1, 10000)
        c1117(1000000, -1)
        SetTalkTime(0.01)
...
def t130260_x10(val2=10, val3=12):
    """ State 0,4 """
    assert t130260_x1() and GetCurrentStateElapsedFrames() > 2
    """ State 1 """
...
def t130260_x11(val2=10, val3=12):
    """ State 0,1 """
...
def t130260_x15():
    """ State 0,1 """
    assert t130260_x17(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t130260_x16(mode2=1, mode4=1):
    """ State 0,2 """
    if f116(10000) == 1:
        """ State 1 """
        ...
        assert t130260_x17(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """ State 5 """
    return 0

def t130260_x17(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """ State 0,4 """
    if f118(z1) == 1:
        """ State 2 """
...
def t130260_x18():
    """ State 0,1 """
    call = t130260_x17(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert t130260_x1()
    elif call.Get() == 0:
...
def t130260_x19():
    """ State 0,2 """
    call = t130260_x17(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 1 """
        pass
    elif call.Done():
...
def t130260_x20():
    """ State 0,1 """
    assert t130260_x17(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t130260_x21(val2=10, val3=12):
    ...
    while True:
        ...
        if f122() == 1:
            ...
            """ State 3 """
            call = t130260_x24(val2=val2, val3=val3)
            assert not IsPlayerDead()
    """ State 2 """
    t130260_x11(val2=val2, val3=val3)

def t130260_x22():
    """ State 0,1 """
    assert t130260_x17(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t130260_x23(val6=7002620, flag5=6000, flag6=6001, val7=1000000, val8=1000000, val9=1000000, val10=1000000,
                val11=1000000):
    """ State 0,1 """
    call = t130260_x17(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert (t130260_x0(val6=val6, flag6=flag6, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t130260_x24(val2=10, val3=12):
    """ State 0,1 """
    assert GetDistanceToPlayer() < val2
    """ State 3 """
    call = t130260_x25()
...
def t130260_x25():
    """ State 0,1 """
    assert t130260_x17(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
