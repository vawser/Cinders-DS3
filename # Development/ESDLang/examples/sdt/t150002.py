...
def t150002_x2(z3=17, z4=9019, flag3=6067):
    """ State 0,1 """
...
def t150002_x3(z2=_, flag1=6001, flag2=6000):
    """ State 0,1 """
    while True:
...
def t150002_x7():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """ State 17 """
        Label('L1')
        assert t150002_x3(z2=6101, flag1=6001, flag2=6000)
        """ State 13 """
        ...
        """ State 3,18 """
        call = t150002_x3(z2=6100, flag1=6001, flag2=6000)
        if call.Done():
            """ State 5 """
            ClearPlayerDamageInfo()
            """ State 6 """
