...
def t170290_1():
    """ State 0,1 """
    t170290_x16(flag5=1379, flag6=1375, flag7=1376, val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6000,
...
def t170290_x1():
    ...
    assert (t170290_x35(text10=29030000, flag18=71110140, text11=29030100, flag19=71110141, text12=29030200,
...
def t170290_x2():
    """ State 0,1 """
    # talk:29030400:    
    assert t170290_x14(text1=29030400, flag23=1, mode14=1)
    """ State 2 """
    return 0
...
def t170290_x3():
    ...
    call = t170290_x39(text1=29900000, text2=29900100, text3=29900150, text4=29910003, text5=29900700,
...
def t170290_x4():
    ...
    if call.Get() == 1:
        ...
        """ State 15 """
        call = t170290_x7(mode12=1)
        if call.Get() == 1:
            """ State 13 """
            # goods:3080:Rice
            call = t170290_x5(mode13=1, goods2=3080, flag21=72000132, flag22=72000133)
            if call.Get() == 0:
                pass
            elif call.Done():
                """ State 1 """
                if DoesSelfHaveSpEffect(32900) == 1:
                    """ State 2 """
                    if not GetEventStatus(71700000):
                        """ State 4,8 """
                        # talk:29000500:Ah, fruits of the serpent, yes... There are two kinds.
                        assert t170290_x14(text1=29000500, flag23=0, mode14=1)
                    else:
                        """ State 5,12 """
                        # talk:29010206:"If it's dried fruit you're after... become a trainer of monkeys..."
                        assert t170290_x14(text1=29010206, flag23=0, mode14=1)
                        Goto('L0')
                else:
                    """ State 3 """
                    if not GetEventStatus(71700000):
                        """ State 6,9 """
                        # talk:29000600:Ah, fruits of the serpent, yes... There are two kinds.
                        assert t170290_x14(text1=29000600, flag23=0, mode14=1)
                    else:
                        """ State 7,14 """
                        # talk:29010206:"If it's dried fruit you're after... become a trainer of monkeys..."
                        assert t170290_x14(text1=29010206, flag23=0, mode14=1)
                ...
                """ State 11 """
                # goods:3080:Rice
                call = t170290_x5(mode13=0, goods2=3080, flag21=72000132, flag22=72000133)
                if call.Done():
                    pass
                elif call.Done():
                    pass
...
def t170290_x5(mode13=_, goods2=3080, flag21=72000132, flag22=72000133):
    """ State 0,5 """
    if not mode13:
        """ State 7,1 """
        c1110()
        ...
        if GetTalkListEntryResult() == 1:
            ...
            """ State 15 """
            # talk:29010200:...here's some rice.
            assert t170290_x13(text14=29010200, z6=71700000, flag24=0, mode15=1)
            """ State 12 """
            Label('L1')
            SetEventState(flag21, 0)
            SetEventState(flag22, 0)
            SetEventState(71700001, 1)
            ...
            """ State 16 """
            # talk:29010100:.........
            assert t170290_x14(text1=29010100, flag23=0, mode14=1)
            Goto('L1')
...
def t170290_x6():
    ...
    if f116(10000) == 1:
        ...
        assert t170290_x7(mode12=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """ State 5 """
    return 0

def t170290_x7(mode12=_):
    """ State 0,11 """
    if mode12 == 1:
        """ State 13 """
        if GetEventStatus(71110136) == 1:
            ...
            if not GetEventStatus(50006290):
                ...
                assert t170290_x14(text1=29001100, flag23=0, mode14=1)
                """ State 26 """
                assert t170290_x15(lot1=62900)
                """ State 6 """
                if not GetEventStatus(50006291) and GetEventStatus(71110137) == 1:
                    ...
                    assert t170290_x14(text1=29001201, flag23=0, mode14=1)
                    """ State 25 """
                    Label('L2')
                    assert t170290_x15(lot1=62910)
                    """ State 9 """
                    if not GetEventStatus(50006292) and GetEventStatus(71110138) == 1:
                        ...
                        assert t170290_x14(text1=29001301, flag23=0, mode14=1)
                        """ State 24 """
                        Label('L4')
                        assert t170290_x15(lot1=62920)
                        """ State 20 """
                        Label('L5')
                        # talk:29001350:If only someone like you could stand with the Divine Child...
                        assert t170290_x14(text1=29001350, flag23=0, mode14=1)
                        Goto('L9')
                    else:
                        Goto('L9')
                else:
            ...
            if not GetEventStatus(50006291):
                ...
                assert t170290_x14(text1=29001200, flag23=0, mode14=1)
                Goto('L2')
            elif GetEventStatus(71110138) == 1 and not GetEventStatus(50006292):
                Goto('L3')
            elif GetEventStatus(71110138) == 1 and GetEventStatus(50006292) == 1:
            ...
            if not GetEventStatus(50006292):
                ...
                assert t170290_x14(text1=29001300, flag23=0, mode14=1)
                Goto('L4')
            else:
                Goto('L5')
            ...
            assert t170290_x14(text1=29001400, flag23=0, mode14=1)
            Goto('L9')
        else:
            pass
        """ State 18 """
...
def t170290_x9(val6=7002900, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000, mode7=0,
               flag9=6000, val7=1000000, val8=1000000, val9=1000000, val10=1000000, val11=1000000):
    """ State 0,3 """
    while Loop('mainloop'):
        call = t170290_x38(val6=val6, flag10=flag10, flag14=flag14, flag15=flag15, flag16=flag16, flag17=flag17,
...
def t170290_x12(text10=_, flag18=_, flag25=1, mode16=1):
    """ State 0,7 """
    assert t170290_x11() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 2 """
...
def t170290_x13(text14=29010200, z6=71700000, flag24=0, mode15=1):
    """ State 0,7 """
    assert t170290_x11() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 5 """
    if not flag24:
...
def t170290_x14(text1=_, flag23=_, mode14=1):
    """ State 0,6 """
    assert t170290_x11() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 4 """
    if not flag23:
...
def t170290_x16(flag5=1379, flag6=1375, flag7=1376, val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6000,
                val6=7002900, flag9=6000, flag10=6001, flag11=71110119, flag12=6000, mode1=1, val7=1000000,
                val8=1000000, val9=1000000, mode2=1, mode3=1, mode4=0, val10=1000000, val11=1000000,
                mode5=0, flag13=6000, mode6=0):
    """ State 0,1 """
    while True:
        RemoveMyAggro()
        call = t170290_x17(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag8=flag8, val6=val6,
        ...
        if (CheckSelfDeath() == 1 or GetEventStatus(flag5) == 1) and not GetEventStatus(flag13):
            ...
            """ State 3 """
            call = t170290_x32(val2=val2, val3=val3)
            if CheckSelfDeath() == 1 or GetEventStatus(flag5) == 1 or DoesSelfHaveSpEffect(30100) == 1:
                ...
                continue
        """ State 2 """
        call = t170290_x18(flag5=flag5, val2=val2, val3=val3)
        assert not CheckSelfDeath() and not GetEventStatus(flag5) and not DoesSelfHaveSpEffect(30100)

def t170290_x17(val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6000, val6=7002900, flag9=6000, flag10=6001,
    ...
    """ State 0,4 """
    while True:
        call = t170290_x34(val6=val6, flag9=flag9, flag10=flag10, val7=val7, val8=val8, val9=val9, val10=val10,
                           val11=val11)
        if call.Done():
            """ State 1 """
            Label('L0')
            call = t170290_x19(val1=val1, mode1=mode1, mode2=mode2, mode3=mode3, mode4=mode4, mode5=mode5)
            def WhilePaused():
                GiveSpEffectToPlayer(30700)
            if call.Done():
                continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t170290_x21(val2=val2, val3=val3)

def t170290_x18(flag5=1379, val2=10, val3=12):
    """ State 0,1 """
...
def t170290_x19(val1=5, mode1=1, mode2=1, mode3=1, mode4=0, mode5=0):
    """ State 0,2 """
    ClearPlayerDamageInfo()
    TurnCharacterToFaceEntity(-1, 10000, -1)
    call = t170290_x27(mode2=mode2, mode4=mode4)
    def WhilePaused():
        c1117(mode1, 10000)
        c1117(1000000, -1)
        SetTalkTime(0.01)
...
def t170290_x21(val2=10, val3=12):
    """ State 0,4 """
    assert t170290_x10() and GetCurrentStateElapsedFrames() > 2
    """ State 1 """
...
def t170290_x22(val2=10, val3=12):
    """ State 0,1 """
...
def t170290_x25(val2=10, val3=12):
    """ State 0,2,1 """
    while True:
        assert GetDistanceToPlayer() < val2
        """ State 3 """
...
def t170290_x26():
    """ State 0,1 """
    assert t170290_x28(z5=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t170290_x27(mode2=1, mode4=0):
    """ State 0,2 """
    if f116(10000) == 1:
        """ State 1 """
        assert GetCurrentStateElapsedFrames() > 5
        ...
        assert t170290_x28(z5=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """ State 5 """
    return 0

def t170290_x28(z5=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """ State 0,4 """
    if f118(z5) == 1:
        """ State 2 """
...
def t170290_x29():
    """ State 0,1 """
    call = t170290_x28(z5=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert t170290_x10()
    elif call.Get() == 0:
...
def t170290_x30():
    """ State 0,2 """
    call = t170290_x28(z5=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 1 """
        pass
    elif call.Done():
...
def t170290_x31():
    """ State 0,1 """
    assert t170290_x28(z5=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t170290_x32(val2=10, val3=12):
    """ State 0,1 """
    while True:
        call = t170290_x25(val2=val2, val3=val3)
        if f122() == 1:
            break
        elif not f122():
            """ State 3 """
            call = t170290_x36(val2=val2, val3=val3)
            assert not IsPlayerDead()
    """ State 2 """
    t170290_x22(val2=val2, val3=val3)

def t170290_x33():
    """ State 0,1 """
    assert t170290_x28(z5=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t170290_x34(val6=7002900, flag9=6000, flag10=6001, val7=1000000, val8=1000000, val9=1000000, val10=1000000,
                val11=1000000):
    """ State 0,1 """
    call = t170290_x28(z5=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert (t170290_x9(val6=val6, flag10=flag10, flag14=6000, flag15=6000, flag16=6000, flag17=6000,
...
def t170290_x35(text10=29030000, flag18=71110140, text11=29030100, flag19=71110141, text12=29030200,
                flag20=71110142, text13=29030300):
    """ State 0,1 """
    if not text10 == -1 and not GetEventStatus(flag18):
        """ State 3 """
        assert t170290_x12(text10=text10, flag18=flag18, flag25=1, mode16=1)
    elif not text11 == -1 and not GetEventStatus(flag19):
        """ State 4 """
        assert t170290_x12(text10=text11, flag18=flag19, flag25=1, mode16=1)
    elif not text12 == -1 and not GetEventStatus(flag20):
        """ State 5 """
        assert t170290_x12(text10=text12, flag18=flag20, flag25=1, mode16=1)
    else:
        """ State 2 """
        ...
        """ State 6 """
        assert t170290_x14(text1=text13, flag23=1, mode14=1)
    """ State 7 """
    return 0

def t170290_x36(val2=10, val3=12):
    """ State 0,1 """
    assert GetDistanceToPlayer() < val2
    """ State 3 """
    call = t170290_x37()
...
def t170290_x37():
    """ State 0,1 """
    assert t170290_x28(z5=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t170290_x38(val6=7002900, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000, mode7=0,
                flag9=6000):
    """ State 0,1 """
    while Loop('mainloop'):
...
def t170290_x39(text1=29900000, text2=29900100, text3=29900150, text4=29910003, text5=29900700, text6=29900750,
    ...
    if GetEventStatus(flag3) == 1:
        ...
        if not GetEventStatus(50006990):
            ...
            Label('L0')
            """ State 57 """
            assert t170290_x14(text1=text5, flag23=0, mode14=1)
            """ State 48 """
            SetEventState(flag4, 1)
            """ State 58 """
            assert t170290_x15(lot1=69900)
            """ State 25 """
            Label('L1')
            """ State 63 """
            assert t170290_x14(text1=text6, flag23=0, mode14=1)
            """ State 23 """
                ...
                if GetEventStatus(flag1) == 1:
                    ...
                    if not GetEventStatus(flag2):
                        ...
                        if not GetEventStatus(70004000):
                            """ State 3,55 """
                            assert t170290_x14(text1=text1, flag23=0, mode14=1)
                        else:
                            """ State 4,56 """
                            assert t170290_x14(text1=text2, flag23=0, mode14=1)
                    else:
                        """ State 52,64 """
                        assert t170290_x14(text1=text3, flag23=0, mode14=1)
                    """ State 51 """
