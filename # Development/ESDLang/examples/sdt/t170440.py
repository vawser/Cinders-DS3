...
def t170440_1000():
    """ State 0,2 """
    def WhilePaused():
        c5117(GetEventStatus(70002065) == 1, 1112000, -1)
    assert t170440_x40()
    """ State 1 """
    def WhilePaused():
        c1119(0)
...
def t170440_1103():
    ...
    assert t170440_x6(text5=44030400, flag24=1, mode14=1)
    """ State 1 """
    def WhilePaused():
        c1119(0)
...
def t170440_x1(val6=7008000, flag16=6001, flag20=6000, flag21=6000, flag22=6000, flag23=6000, mode9=0,
               flag15=6000, val7=1000000, val8=1000000, val9=1000000, val10=1000000, val11=1000000):
    """ State 0,3 """
    while Loop('mainloop'):
        call = t170440_x30(val6=val6, flag16=flag16, flag20=flag20, flag21=flag21, flag22=flag22, flag23=flag23,
...
def t170440_x4(text1=_, flag1=_, flag26=1, mode16=1):
    """ State 0,7 """
...
def t170440_x5(text15=_, z10=_, flag25=0, mode15=1):
    """ State 0,7 """
    assert t170440_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 5 """
    if not flag25:
...
def t170440_x6(text5=_, flag24=_, mode14=1):
    """ State 0,6 """
    assert t170440_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 4 """
    if not flag24:
...
def t170440_x8(flag11=6000, flag12=6000, flag13=6000, val1=12, val2=10, val3=12, val4=10, val5=12, flag14=6001,
    ...
    while True:
        RemoveMyAggro()
        call = t170440_x9(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag14=flag14, val6=val6,
...
def t170440_x9(val1=12, val2=10, val3=12, val4=10, val5=12, flag14=6001, val6=7008000, flag15=6000, flag16=6001,
    ...
    """ State 0,4 """
    while True:
        call = t170440_x26(val6=val6, flag15=flag15, flag16=flag16, val7=val7, val8=val8, val9=val9,
...
def t170440_x18():
    """ State 0,1 """
    assert t170440_x20(z9=1101, mode10=0, mode11=0, mode12=0, mode13=0)
    """ State 2 """
    return 0
...
def t170440_x19(mode4=1, mode6=0):
    ...
    if f116(10000) == 1:
        ...
        assert t170440_x20(z9=1000, mode10=0, mode11=0, mode12=0, mode13=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """ State 5 """
    return 0

def t170440_x20(z9=_, mode10=0, mode11=0, mode12=0, mode13=0):
    """ State 0,4 """
    if f118(z9) == 1:
        """ State 2 """
...
def t170440_x21():
    """ State 0,1 """
    call = t170440_x20(z9=1103, mode10=0, mode11=0, mode12=0, mode13=0)
    if call.Get() == 1:
        """ State 2 """
        assert t170440_x2()
    elif call.Get() == 0:
...
def t170440_x22():
    """ State 0,2 """
    call = t170440_x20(z9=1102, mode10=0, mode11=0, mode12=0, mode13=0)
    if call.Get() == 1:
        """ State 1 """
        pass
    elif call.Done():
...
def t170440_x23():
    """ State 0,1 """
    assert t170440_x20(z9=1001, mode10=0, mode11=0, mode12=0, mode13=0)
    """ State 2 """
    return 0
...
def t170440_x25():
    """ State 0,1 """
    assert t170440_x20(z9=1100, mode10=0, mode11=0, mode12=0, mode13=0)
    """ State 2 """
    return 0

def t170440_x26(val6=7008000, flag15=6000, flag16=6001, val7=1000000, val8=1000000, val9=1000000, val10=1000000,
                val11=1000000):
    """ State 0,1 """
    call = t170440_x20(z9=2000, mode10=0, mode11=0, mode12=0, mode13=0)
    if call.Get() == 1:
        """ State 2 """
        assert (t170440_x1(val6=val6, flag16=flag16, flag20=6000, flag21=6000, flag22=6000, flag23=6000,
...
def t170440_x28():
    """ State 0,1 """
    assert t170440_x20(z9=1002, mode10=0, mode11=0, mode12=0, mode13=0)
    """ State 2 """
    return 0
...
def t170440_x30(val6=7008000, flag16=6001, flag20=6000, flag21=6000, flag22=6000, flag23=6000, mode9=0,
                flag15=6000):
    """ State 0,1 """
    while Loop('mainloop'):
...
def t170440_x31(text10=44900000, text11=44900010, text12=44900050, text13=44900150, text14=44900500,
    ...
    if not GetEventStatus(flag10):
        ...
        if not GetEventStatus(70004000):
            """ State 3,13 """
            assert t170440_x6(text5=text10, flag24=0, mode14=1)
        else:
            """ State 4,14 """
            assert t170440_x6(text5=text11, flag24=0, mode14=1)
    else:
        """ State 11,5,17 """
        assert t170440_x6(text5=text12, flag24=0, mode14=1)
    """ State 12 """
...
def t170440_x33(text8=44900400, text9=44900410, flag6=71700132, mode2=_):
    ...
    if mode2 == 1:
        ...
        """ State 2,7 """
        assert t170440_x6(text5=text8, flag24=0, mode14=1)
        """ State 4 """
        SetEventState(flag6, 1)
        """ State 8 """
        assert t170440_x7(lot1=69900)
    """ State 5,9 """
    assert t170440_x6(text5=text9, flag24=0, mode14=1)
    """ State 6 """
...
def t170440_x34(text6=44900200, text7=44900100, z1=71700131, z2=71700130, z3=71700133, mode1=_, z4=9523):
    ...
    if ComparePlayerInventoryNumber(3, 9550, 0, 0, 0) == 1:
        ...
        if call.Get() == 0:
            ...
            SetEventState(z2, 1)
            """ State 4,15 """
            assert t170440_x6(text5=text7, flag24=0, mode14=1)
            """ State 10 """
            SetEventState(z2, 0)
        elif call.Done():
            """ State 11 """
            SetEventState(z1, 1)
            """ State 12,16 """
            assert t170440_x6(text5=text6, flag24=0, mode14=1)
            """ State 13 """
            SetEventState(z1, 0)
    """ State 17 """
    return 0
...
def t170440_x35(text5=44900300, flag5=70002065):
    ...
    if GetEventStatus(flag5) == 1:
        """ State 3,4 """
        assert t170440_x6(text5=text5, flag24=0, mode14=1)
        """ State 5 """
        return 0
    else:
        """ State 2,6 """
...
def t170440_x36(text1=44030000, flag1=71700145, text2=44030100, flag2=71700146, text3=44030200, flag3=71700147,
    ...
    if not text1 == -1 and not GetEventStatus(flag1):
        """ State 4 """
        assert t170440_x4(text1=text1, flag1=flag1, flag26=1, mode16=1)
    elif not text2 == -1 and not GetEventStatus(flag2):
        """ State 5 """
        assert t170440_x4(text1=text2, flag1=flag2, flag26=1, mode16=1)
    elif not text3 == -1 and not GetEventStatus(flag3):
        """ State 6 """
        assert t170440_x4(text1=text3, flag1=flag3, flag26=1, mode16=1)
    else:
        """ State 7 """
        assert t170440_x4(text1=text4, flag1=flag4, flag26=1, mode16=1)
    """ State 8 """
    return 0
...
def t170440_x37():
    ...
    if not GetEventStatus(71700101):
        ...
        if not GetEventStatus(71100750):
            ...
            assert t170440_x5(text15=44000000, z10=71100750, flag25=0, mode15=1)
            """ State 5 """
            RequestUnlockTrophy(18)
        else:
            """ State 4,8 """
            # talk:44000100:Care to purchase an offering?
            assert t170440_x6(text5=44000100, flag24=0, mode14=1)
        """ State 6 """
        SetEventState(71700101, 1)
    else:
        """ State 7,10 """
        # talk:44000200:Care to purchase an offering?
        assert t170440_x6(text5=44000200, flag24=0, mode14=1)
    """ State 11 """
    return 0
...
def t170440_x38():
    ...
    if not GetEventStatus(71700102):
        ...
        assert t170440_x5(text15=44020000, z10=71700102, flag25=0, mode15=1)
    else:
        """ State 3,5 """
        # talk:44020100:May the departed rest in peace...
        assert t170440_x6(text5=44020100, flag24=0, mode14=1)
    """ State 6 """
    return 0
...
def t170440_x39():
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            assert t170440_x6(text5=44010000, flag24=0, mode14=1)
