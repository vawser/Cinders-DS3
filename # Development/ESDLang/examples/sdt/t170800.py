...
def t170800_1():
    """ State 0,1 """
    t170800_x7(flag1=6000, flag2=6000, flag3=6000, val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001,
...
def t170800_1000():
    """ State 0,2 """
    assert (t170800_x26(shop1=1700000, shop2=1700099, flag13=-1, flag14=-1, text1=-1, flag15=-1, flag16=-1,
            text2=-1, flag17=-1, text3=-1, z1=-1, text4=-1, flag18=-1, goods1=-1, flag19=-1, mode7=0))
    """ State 1 """
    def WhilePaused():
        c1119(0)

def t170800_x0(action1=12095010):
    """ State 0,1 """
...
def t170800_x1(val6=7008000, flag6=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000, mode6=0,
               flag5=6000, val7=1000000, val8=1000000, val9=1000000, val10=1000000, val11=1000000):
    """ State 0,3 """
    while Loop('mainloop'):
        call = t170800_x31(val6=val6, flag6=flag6, flag9=flag9, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t170800_x4(text4=-1, flag18=-1, flag21=0, mode14=1):
    """ State 0,7 """
    assert t170800_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 5 """
    if not flag21:
        """ State 1 """
...
def t170800_x5(text1=-1, flag20=0, mode13=1):
    """ State 0,6 """
    assert t170800_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 4 """
    if not flag20:
...
def t170800_x7(flag1=6000, flag2=6000, flag3=6000, val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               val6=7008000, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val7=1000000, val8=1000000,
               val9=1000000, mode2=1, mode3=1, mode4=0, val10=1000000, val11=1000000, mode5=0):
    """ State 0,1 """
    while True:
        RemoveMyAggro()
        call = t170800_x8(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, val6=val6,
        ...
        if CheckSelfDeath() == 1 or GetEventStatus(flag1) == 1:
            ...
            """ State 3 """
            call = t170800_x23(val2=val2, val3=val3)
            if CheckSelfDeath() == 1 or GetEventStatus(flag1) == 1 or DoesSelfHaveSpEffect(30100) == 1:
                ...
                continue
        """ State 2 """
        call = t170800_x9(flag1=flag1, val2=val2, val3=val3)
        assert not CheckSelfDeath() and not GetEventStatus(flag1) and not DoesSelfHaveSpEffect(30100)

def t170800_x8(val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001, val6=7008000, flag5=6000, flag6=6001,
    ...
    """ State 0,4 """
    while True:
        call = t170800_x25(val6=val6, flag5=flag5, flag6=flag6, val7=val7, val8=val8, val9=val9, val10=val10,
                           val11=val11)
        if call.Done():
            """ State 1 """
            Label('L0')
            call = t170800_x10(val1=val1, mode1=mode1, mode2=mode2, mode3=mode3, mode4=mode4, mode5=mode5)
            def WhilePaused():
                GiveSpEffectToPlayer(30700)
            if call.Done():
                continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t170800_x12(val2=val2, val3=val3)

def t170800_x9(flag1=6000, val2=10, val3=12):
    """ State 0,1 """
...
def t170800_x10(val1=12, mode1=1, mode2=1, mode3=1, mode4=0, mode5=0):
    """ State 0,2 """
    ClearPlayerDamageInfo()
    TurnCharacterToFaceEntity(-1, 10000, -1)
    call = t170800_x18(mode2=mode2, mode4=mode4)
    def WhilePaused():
        c1117(mode1, 10000)
        c1117(1000000, -1)
        SetTalkTime(0.01)
...
def t170800_x12(val2=10, val3=12):
    """ State 0 """
...
def t170800_x13(val2=10, val3=12):
    """ State 0,1 """
...
def t170800_x16(val2=10, val3=12):
    """ State 0,2,1 """
    while True:
        assert GetDistanceToPlayer() < val2
        """ State 3 """
...
def t170800_x17():
    """ State 0,1 """
    assert t170800_x19(z2=1101, mode9=0, mode10=0, mode11=0, mode12=0)
    """ State 2 """
    return 0

def t170800_x18(mode2=1, mode4=0):
    """ State 0,2 """
    assert f116(10000) == 1
    """ State 1 """
    ...
    assert t170800_x19(z2=1000, mode9=0, mode10=0, mode11=0, mode12=0)
    """ State 5 """
    return 0

def t170800_x19(z2=_, mode9=0, mode10=0, mode11=0, mode12=0):
    """ State 0,4 """
    if f118(z2) == 1:
        """ State 2 """
        assert GetCurrentStateElapsedFrames() > 1
...
def t170800_x20():
    """ State 0,1 """
    call = t170800_x19(z2=1103, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """ State 2 """
        assert t170800_x2()
    elif call.Get() == 0:
...
def t170800_x21():
    """ State 0,2 """
    call = t170800_x19(z2=1102, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """ State 1 """
        pass
    elif call.Done():
...
def t170800_x22():
    """ State 0,1 """
    assert t170800_x19(z2=1001, mode9=0, mode10=0, mode11=0, mode12=0)
    """ State 2 """
    return 0

def t170800_x23(val2=10, val3=12):
    """ State 0,1 """
    while True:
        call = t170800_x16(val2=val2, val3=val3)
        if f122() == 1:
            break
        elif not f122():
            """ State 3 """
            call = t170800_x27(val2=val2, val3=val3)
            assert not IsPlayerDead()
    """ State 2 """
    t170800_x13(val2=val2, val3=val3)

def t170800_x24():
    """ State 0,1 """
    assert t170800_x19(z2=1100, mode9=0, mode10=0, mode11=0, mode12=0)
    """ State 2 """
    return 0

def t170800_x25(val6=7008000, flag5=6000, flag6=6001, val7=1000000, val8=1000000, val9=1000000, val10=1000000,
                val11=1000000):
    """ State 0,1 """
    call = t170800_x19(z2=2000, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """ State 2 """
        assert (t170800_x1(val6=val6, flag6=flag6, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
...
def t170800_x26(shop1=1700000, shop2=1700099, flag13=-1, flag14=-1, text1=-1, flag15=-1, flag16=-1, text2=-1,
    ...
    if GetEventStatus(flag15) == 1 and not GetEventStatus(flag18) and mode7 == 1:
        """ State 18,26 """
        assert t170800_x29(text1=text1, text4=text4, lot1=69900, flag15=flag15, flag18=flag18, mode8=1)
        """ State 1 """
        Label('L0')
        while True:
            ClearTalkListData()
            ...
            if GetTalkListEntryResult() == 1:
                """ State 27 """
                assert (t170800_x30(shop1=shop1, shop2=shop2) and not (CheckSpecificPersonMenuIsOpen(5,
                ...
                """ State 11,25 """
                assert (t170800_x29(text1=text1, text4=text4, lot1=69900, flag15=flag15, flag18=flag18,
                        mode8=0))
            elif GetTalkListEntryResult() == 4:
                """ State 12,22 """
                # action:12095010:Give Dragonrot Pellet?
                assert t170800_x0(action1=12095010)
                """ State 13 """
                if GetGenericDialogButtonResult() == 1:
                    """ State 14,16 """
                    ...
                    """ State 15,24 """
                    assert t170800_x5(text1=text3, flag20=0, mode13=1)
        ...
        Goto('L0')
    """ State 20,23 """
    assert t170800_x4(text4=text2, flag18=flag17, flag21=0, mode14=1)
    Goto('L0')

def t170800_x27(val2=10, val3=12):
    """ State 0,1 """
    assert GetDistanceToPlayer() < val2
    """ State 3 """
    call = t170800_x28()
...
def t170800_x28():
    """ State 0,1 """
    assert t170800_x19(z2=1002, mode9=0, mode10=0, mode11=0, mode12=0)
    """ State 2 """
    return 0

def t170800_x29(text1=-1, text4=-1, lot1=69900, flag15=-1, flag18=-1, mode8=_):
    """ State 0,3 """
    if not mode8:
        """ State 4,8 """
        assert t170800_x5(text1=text1, flag20=0, mode13=1)
        """ State 2 """
        SetEventState(flag15, 1)
        """ State 10 """
        assert t170800_x6(lot1=lot1)
    else:
        """ State 5 """
        if GetEventStatus(flag15) == 1 and not GetEventStatus(flag18):
            ...
            return 1
    """ State 1,9 """
    assert t170800_x4(text4=text4, flag18=flag18, flag21=0, mode14=1)
    """ State 11 """
    return 0

def t170800_x30(shop1=1700000, shop2=1700099):
    """ State 0,1 """
...
def t170800_x31(val6=7008000, flag6=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000, mode6=0,
                flag5=6000):
    """ State 0,1 """
    while Loop('mainloop'):
