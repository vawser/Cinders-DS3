...
def t250380_1():
    """ State 0,1 """
    t250380_x6(flag1=1759, flag2=1755, flag3=1756, val1=5, val2=10, val3=12, val4=16, val5=16.5, flag4=6000,
...
def t250380_1000():
    ...
    """ State 2,3 """
    if not GetEventStatus(72500100):
        """ State 5 """
        # talk:38000000:Young man, please be careful.
        assert t250380_x4(text2=38000000, z2=72500100, flag15=0, mode13=1)
    elif GetEventStatus(72500100) == 1 and not GetEventStatus(72500101):
        """ State 6 """
        # talk:38000100:Why are you telling me this?
        assert t250380_x4(text2=38000100, z2=72500101, flag15=0, mode13=1)
    else:
        """ State 7 """
        # talk:38000200:The courtyard is an accursed place.  \nIf you must forge ahead, you'd best go around it.
        assert t250380_x5(text1=38000200, flag14=0, mode12=1)
    """ State 1 """
    def WhilePaused():
        c1119(0)
...
def t250380_1100():
    """ State 0,2 """
    SetEventState(72500110, 0)
    """ State 4 """
    call = t250380_x28()
    if call.Done():
        pass
    elif GetDistanceToPlayer() < 3 or not GetEventStatus(72500111):
        """ State 3 """
        assert t250380_x1()
    """ State 1 """
    def WhilePaused():
...
def t250380_2000():
    """ State 0,3 """
    assert (t250380_x0(val6=7003800, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
            mode7=0, flag5=6000, val7=1000000, val8=1000000, val9=1000000, val10=1000000, val11=1000000))
    """ State 2 """
    SetEventState(72500120, 1)
    """ State 1 """
    def WhilePaused():
        c1119(0)
...
def t250380_x3(text3=_, z3=_, flag16=1, mode14=1):
    """ State 0,7 """
    assert t250380_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 2 """
    SetEventState(z3, 1)
    """ State 6 """
    if not flag16:
...
def t250380_x4(text2=_, z2=_, flag15=0, mode13=1):
    """ State 0,7 """
    assert t250380_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 5 """
    if not flag15:
...
def t250380_x5(text1=38000200, flag14=0, mode12=1):
    """ State 0,6 """
    assert t250380_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 4 """
    if not flag14:
...
def t250380_x6(flag1=1759, flag2=1755, flag3=1756, val1=5, val2=10, val3=12, val4=16, val5=16.5, flag4=6000,
               val6=7003800, flag5=6000, flag6=6001, flag7=72500110, flag8=6000, mode1=1, val7=1000000,
               val8=1000000, val9=1000000, mode2=1, mode3=1, mode4=0, val10=1000000, val11=1000000, mode5=0,
               flag9=6000, mode6=0):
    """ State 0,1 """
    while True:
        ...
        if (CheckSelfDeath() == 1 or GetEventStatus(flag1) == 1) and not GetEventStatus(flag9):
            ...
            """ State 3 """
            call = t250380_x22(val2=val2, val3=val3)
            if CheckSelfDeath() == 1 or GetEventStatus(flag1) == 1 or DoesSelfHaveSpEffect(30100) == 1:
                ...
                continue
        """ State 2 """
        call = t250380_x8(flag1=flag1, val2=val2, val3=val3)
...
def t250380_x7(val1=5, val2=10, val3=12, val4=16, val5=16.5, flag4=6000, val6=7003800, flag5=6000, flag6=6001,
    ...
    while True:
        ...
        if call.Done():
            """ State 1 """
            Label('L0')
            call = t250380_x9(val1=val1, mode1=mode1, mode2=mode2, mode3=mode3, mode4=mode4, mode5=mode5)
            def WhilePaused():
                GiveSpEffectToPlayer(30700)
            if call.Done():
                continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t250380_x11(val2=val2, val3=val3)

def t250380_x8(flag1=1759, val2=10, val3=12):
    """ State 0,1 """
...
def t250380_x9(val1=5, mode1=1, mode2=1, mode3=1, mode4=0, mode5=0):
    """ State 0,2 """
    ClearPlayerDamageInfo()
    TurnCharacterToFaceEntity(-1, 10000, -1)
    call = t250380_x17(mode2=mode2, mode4=mode4)
    def WhilePaused():
        c1117(mode1, 10000)
        c1117(1000000, -1)
        SetTalkTime(0.01)
...
def t250380_x11(val2=10, val3=12):
    """ State 0,4 """
    assert t250380_x1() and GetCurrentStateElapsedFrames() > 2
    """ State 1 """
...
def t250380_x12(val2=10, val3=12):
    """ State 0,1 """
...
def t250380_x16():
    """ State 0,1 """
    assert t250380_x18(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t250380_x17(mode2=1, mode4=0):
    """ State 0,2 """
    if f116(10000) == 1:
        """ State 1 """
        ...
        assert t250380_x18(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """ State 5 """
    return 0

def t250380_x18(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """ State 0,4 """
    if f118(z1) == 1:
        """ State 2 """
...
def t250380_x19():
    """ State 0,1 """
    call = t250380_x18(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert t250380_x1()
    elif call.Get() == 0:
...
def t250380_x20():
    """ State 0,2 """
    call = t250380_x18(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 1 """
        pass
    elif call.Done():
...
def t250380_x21():
    """ State 0,1 """
    assert t250380_x18(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t250380_x22(val2=10, val3=12):
    ...
    while True:
        ...
        if f122() == 1:
            ...
            """ State 3 """
            call = t250380_x25(val2=val2, val3=val3)
            assert not IsPlayerDead()
    """ State 2 """
    t250380_x12(val2=val2, val3=val3)

def t250380_x23():
    """ State 0,1 """
    assert t250380_x18(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t250380_x24(val6=7003800, flag5=6000, flag6=6001, val7=1000000, val8=1000000, val9=1000000, val10=1000000,
                val11=1000000):
    """ State 0,1 """
    call = t250380_x18(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert (t250380_x0(val6=val6, flag6=flag6, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t250380_x25(val2=10, val3=12):
    """ State 0,1 """
    assert GetDistanceToPlayer() < val2
    """ State 3 """
    call = t250380_x26()
...
def t250380_x26():
    """ State 0,1 """
    assert t250380_x18(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t250380_x28():
    """ State 0,1 """
    if not GetEventStatus(72500102):
        """ State 2 """
        # talk:38060000:Excuse me, young man...
        assert t250380_x3(text3=38060000, z3=72500102, flag16=1, mode14=1)
    else:
        """ State 3 """
        # talk:38060010:Young man, excuse me...
        assert t250380_x3(text3=38060010, z3=72500104, flag16=1, mode14=1)
    """ State 4 """
    return 0
