...
def t250390_1():
    ...
    t250390_x6(flag1=1779, flag2=1775, flag3=1776, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6000,
               val6=7003900, flag5=1775, flag6=6001, flag7=72500160, flag8=6000, mode1=1, val7=1000000,
...
def t250390_1000():
    ...
    if not GetEventStatus(72500150):
        ...
        assert t250390_x4(text2=39000000, z2=72500150, flag15=0, mode13=1)
    elif GetEventStatus(72500150) == 1 and not GetEventStatus(72500151):
        """ State 6 """
        # talk:39000100:Why are you helping me..?
        assert t250390_x4(text2=39000100, z2=72500151, flag15=0, mode13=1)
    else:
        """ State 7 """
        ...
        assert t250390_x5(text1=39000200, flag14=0, mode12=1)
    """ State 1 """
    def WhilePaused():
        c1119(0)
...
def t250390_2000():
    """ State 0,3 """
    assert (t250390_x0(val6=7003900, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t250390_x0(val6=7003900, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, mode7=0,
               flag5=_, val7=1000000, val8=1000000, val9=1000000, val10=1000000, val11=1000000):
    """ State 0,3 """
    while Loop('mainloop'):
        call = t250390_x27(val6=val6, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12, flag13=flag13,
...
def t250390_x3(text3=_, z3=_, flag16=1, mode14=1):
    """ State 0,7 """
...
def t250390_x4(text2=_, z2=_, flag15=0, mode13=1):
    """ State 0,7 """
    assert t250390_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 5 """
    if not flag15:
...
def t250390_x5(text1=39000200, flag14=0, mode12=1):
    """ State 0,6 """
    assert t250390_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 4 """
    if not flag14:
...
def t250390_x6(flag1=1779, flag2=1775, flag3=1776, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6000,
    ...
    while True:
        RemoveMyAggro()
        call = t250390_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, val6=val6,
...
def t250390_x7(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6000, val6=7003900, flag5=1775, flag6=6001,
               flag7=72500160, flag8=6000, mode1=1, val7=1000000, val8=1000000, val9=1000000, mode2=1,
               mode3=1, mode4=0, val10=1000000, val11=1000000, mode5=0, mode6=0):
    """ State 0,4 """
    while True:
        call = t250390_x24(val6=val6, flag5=flag5, flag6=flag6, val7=val7, val8=val8, val9=val9, val10=val10,
                           val11=val11)
        if call.Done():
            """ State 1 """
            Label('L0')
...
def t250390_x16():
    """ State 0,1 """
    assert t250390_x18(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t250390_x17(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t250390_x18(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """ State 5 """
    return 0

def t250390_x18(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """ State 0,4 """
    if f118(z1) == 1:
        """ State 2 """
...
def t250390_x19():
    """ State 0,1 """
    call = t250390_x18(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert t250390_x1()
    elif call.Get() == 0:
...
def t250390_x20():
    """ State 0,2 """
    call = t250390_x18(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 1 """
        pass
    elif call.Done():
...
def t250390_x21():
    """ State 0,1 """
    assert t250390_x18(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0
...
def t250390_x23():
    """ State 0,1 """
    assert t250390_x18(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t250390_x24(val6=7003900, flag5=1775, flag6=6001, val7=1000000, val8=1000000, val9=1000000, val10=1000000,
                val11=1000000):
    """ State 0,1 """
    call = t250390_x18(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """ State 2 """
        assert (t250390_x0(val6=val6, flag6=flag6, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t250390_x26():
    """ State 0,1 """
    assert t250390_x18(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """ State 2 """
    return 0

def t250390_x27(val6=7003900, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, mode7=0,
                flag5=_):
    """ State 0,1 """
    while Loop('mainloop'):
...
def t250390_x28():
    ...
    if not GetEventStatus(72500152):
        ...
        assert t250390_x3(text3=39060000, z3=72500152, flag16=1, mode14=1)
    else:
        """ State 3 """
        # talk:39060010:Young man, excuse me...
        assert t250390_x3(text3=39060010, z3=72500154, flag16=1, mode14=1)
    """ State 4 """
    return 0
