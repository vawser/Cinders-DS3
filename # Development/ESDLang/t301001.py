...
def t301001_x1(z2=17, z3=9019, flag3=6067):
    """ State 0,1 """
...
def t301001_x2(z1=_, flag1=6001, flag2=6000):
    """ State 0,1 """
    while True:
...
def t301001_x5():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """ State 3,15 """
        call = t301001_x2(z1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """ State 7 """
            ...
            pass
    """ State 14 """
    assert t301001_x2(z1=6101, flag1=6001, flag2=6000)
    """ State 5 """
...
def t301001_x9():
    ...
    """ State 21 """
    assert t301001_x1(z2=17, z3=9019, flag3=6067)
