...
def t310020_x50():
    ...
    while True:
        ...
        # Form Covenant
        AddTalkListDataIf(IsEquipmentIDObtained(2, 10050) == 0 and 
        IsEquipmentIDObtained(2, 10051) == 0 and 
        IsEquipmentIDObtained(2, 10052) == 0 and 
        IsEquipmentIDObtained(2, 10053) == 0 and 
        IsEquipmentIDObtained(2, 10054) == 0, 1, 15003019, -1)
        ...
        AddTalkListDataIf(IsEquipmentIDEquipped(2, 10050) == 0 and 
        IsEquipmentIDEquipped(2, 10051) == 0 and 
        IsEquipmentIDEquipped(2, 10052) == 0 and 
        IsEquipmentIDEquipped(2, 10053) == 0 and 
        IsEquipmentIDEquipped(2, 10054) == 0, 7, 99062001, -1)
