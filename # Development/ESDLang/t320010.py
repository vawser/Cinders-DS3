...
def t320010_x9():
    ...
    while True:
        ...
        # Learn Gesture
            ...
            assert t320010_x10(z2=29, z3=9030, flag1=25000302)
            return 0
...
#----------------------------------------------------
# Acquire Gesture
def t320010_x10(z2=_, z3=_, flag1=_):
    """ State 0,1 """
...
def t320010_x50():
    ...
    while True:
        ...
        # Strengthen Bond - None
            ...
            assert t320010_x52(action1=99062005)
            ReportConversationEndToHavokBehavior()
            return 0
        # Leave
...
def t320010_x61():
    ...
    if call.Get() == 0:
        if ComparePlayerInventoryNumber(3, 4015, 3, 19, 0) == 1:
            assert t320010_x52(action1=99062221)
        else:
...
def t320010_x62():
    ...
    if call.Get() == 0:
        if ComparePlayerInventoryNumber(3, 4015, 3, 29, 0) == 1:
            assert t320010_x52(action1=99062222)
        else:
...
def t320010_x63():
    ...
    if call.Get() == 0:
        if ComparePlayerInventoryNumber(3, 4015, 3, 49, 0) == 1:
            assert t320010_x52(action1=99062223)
        else:
