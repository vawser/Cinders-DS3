...
def t320500_1():
    ...
    """ State 2 """
    while True:
        call = t320500_x0() # Host Player
        assert IsClientPlayer() == 1
        """ State 3 """
        call = t320500_x1() # Client Player
...
def t320500_x1():
    """ State 0,1 """
    assert t320500_x2() # Clear Talk State
    """ State 2 """
    return 0
...
def t320500_x4():
    """ State 0,5 """
    while True:
        call = t320500_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000) # Interaction State
        if call.Done():
            """ State 3 """
            call = t320500_x8() # Menu Pre-loop
            if call.Done():
                pass
            elif IsAttackedBySomeone() == 1:
                """ State 1 """
                Label('L0')
                call = t320500_x6() # Attack Check
                def ExitPause():
                    RemoveMyAggro()
                if call.Done():
                    pass
                ...
                """ State 4 """
                call = t320500_x7() # Distance Check
            ...
            break
    """ State 2 """
    t320500_x2() # Clear Talk State
    
# Interaction State
def t320500_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """ State 0,1 """
    while True:
...
def t320500_x9():
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            assert t320500_x52(99002615, 80, 1)
            return 0
...
# Revive
def t320500_x52(text1=_, base_cost=_, derived_stat=_):
    """ State 0,1 """
    SetAquittalCostMessageTag(base_cost, derived_stat)
    """ State 14 """
    call = t320500_x50(action1=text1)
    
    if call.Get() == 0:
        """ State 7 """
        if ComparePlayerAcquittalPrice(base_cost, derived_stat, 2) == 1:
            """ State 4,13 """
            assert t320500_x50(action1=13000050) # Lack souls
        else:
            """ State 5 """
