...
def t330503_x1(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """ State 0,1 """
    while True:
...
def t330503_x4(text3=12002600, z3=74000115, flag3=0, mode3=1):
    """ State 0,5 """
    assert t330503_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 2 """
    SetEventState(z3, 1)
    """ State 1 """
    # talk:12002600: 
...
def t330503_x5(text2=_, z2=_, flag2=0, mode2=0):
    """ State 0,5 """
    assert t330503_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t330503_x6(text1=_, flag1=0, mode1=_):
    """ State 0,4 """
    assert t330503_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
    ...
    if GetEventStatus(1018) == 1:
        ...
        if GetDistanceToPlayer() < 10:
            ...
            if GetEventStatus(50006020) == 1:
                """ State 6,9 """
                # talk:12002900: 
                call = t330503_x6(text1=12002900, flag1=0, mode1=1)
                if call.Done():
                    Goto('L0')
                elif GetDistanceToPlayer() > 12:
                    pass
                ...
                """ State 7,10 """
                # talk:12002950: 
                call = t330503_x6(text1=12002950, flag1=0, mode1=1)
                if call.Done():
                    Goto('L0')
                elif GetDistanceToPlayer() > 12:
                    pass
...
def t330503_x18():
    ...
    if not GetEventStatus(74000115):
        """ State 2,5 """
        # talk:12002600: 
        assert t330503_x4(text3=12002600, z3=74000115, flag3=0, mode3=1)
    else:
        """ State 3,6 """
        # talk:12002700: 
        assert t330503_x6(text1=12002700, flag1=0, mode1=1)
        """ State 4 """
...
def t330503_x26():
    """ State 0,5 """
    while True:
        call = t330503_x1(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000)
        if call.Done():
            """ State 3 """
