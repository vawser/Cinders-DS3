...
def t380001_x1(z2=17, z3=9019, flag3=6067):
    """ State 0,1 """
...
def t380001_x2(z1=_, flag1=6001, flag2=6000):
    """ State 0,1 """
    while True:
...
def t380001_x5():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """ State 3,15 """
        call = t380001_x2(z1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """ State 7 """
            ...
            pass
    """ State 14 """
    assert t380001_x2(z1=6101, flag1=6001, flag2=6000)
    """ State 5 """
...
def t380001_x9():
    ...
    """ State 21 """
    assert t380001_x1(z2=17, z3=9019, flag3=6067)
    """ State 17 """
    c1110()
    """ State 1 """
    while True:
