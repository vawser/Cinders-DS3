...
def t380500_1():
    ...
    """ State 2 """
    while True:
        call = t380500_x0() # Host Player
        assert IsClientPlayer() == 1
        """ State 3 """
        call = t380500_x1() # Client Player
...
def t380500_x1():
    """ State 0,1 """
    assert t380500_x2() # Clear Talk State
    """ State 2 """
    return 0
...
def t380500_x4():
    """ State 0,5 """
    while True:
        call = t380500_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000) # Interaction State
        if call.Done():
            """ State 3 """
            call = t380500_x8() # Menu Pre-loop
            if call.Done():
                pass
            elif IsAttackedBySomeone() == 1:
                """ State 1 """
                Label('L0')
                call = t380500_x6() # Attack Check
                def ExitPause():
                    RemoveMyAggro()
                if call.Done():
                    pass
                ...
                """ State 4 """
                call = t380500_x7() # Distance Check
            ...
            break
    """ State 2 """
    t380500_x2() # Clear Talk State
    
# Interaction State
def t380500_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """ State 0,1 """
    while True:
...
def t380500_x8():
    """ State 0,1 """
    SetEventState(73809000, 0)
    SetEventState(73809001, 0)
    SetEventState(73809002, 0)
    SetEventState(73809003, 0)
    assert t380500_x9()
    """ State 24 """
    return 0
...
def t380500_x9():
    ...
    while True:
        ...
        # Form Betrothal
        AddTalkListDataIf(GetEventStatus(25008090) == 0 and ComparePlayerInventoryNumber(3, 2000, 2, 0, 0) == 1, 10, 15015040, -1)
        # Flirt
        AddTalkListDataIf(GetEventStatus(25008090) == 1, 11, 15015041, -1)
        # Divorce
        AddTalkListDataIf(GetEventStatus(25008090) == 1, 12, 15015042, -1)
...
#----------------------------------------------------
# Acquire Gesture
def t380500_x50(z2=_, z3=_, flag1=_):
    """ State 0,1 """
