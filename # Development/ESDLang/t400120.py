...
def t400120_x8(goods1=2138, goods2=390, goods3=2002, goods5=2000, goods6=2016):
    ...
    while True:
        ...
        # Form Betrothal
        AddTalkListDataIf(GetEventStatus(25008020) == 0 and ComparePlayerInventoryNumber(3, goods5, 2, 0, 0) == 1, 30, 15015040, -1)
        # Flirt
