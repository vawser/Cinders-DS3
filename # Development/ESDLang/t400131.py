...
def t400131_x1(z5=_, flag4=1035, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """ State 0,1 """
    while True:
...
def t400131_x4(text3=_, z4=_, flag3=0, mode3=1):
    """ State 0,5 """
    assert t400131_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 2 """
    SetEventState(z4, 1)
    """ State 1 """
...
def t400131_x5(text2=_, z3=_, flag2=0, mode2=1):
    """ State 0,5 """
    assert t400131_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t400131_x6(text1=_, flag1=0, mode1=1):
    """ State 0,4 """
    assert t400131_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t400131_x8(action1=13003000):
    """ State 0,1 """
...
def t400131_x10(goods1=2135, z1=390, weapon1=6260000, weapon2=6280000):
    """ State 0,9 """
    c1110()
    """ State 1 """
    while True:
        ...
        """ State 15 """
        assert t400131_x28(weapon1=weapon1, weapon2=weapon2)
        """ State 2 """
        ...
        # Transpose brothers' blades
            ...
            """ State 10,14 """
            assert t400131_x25(weapon1=weapon1, weapon2=weapon2)
        # alk
        elif GetTalkListEntryResult() == 5:
            """ State 8,11 """
            assert t400131_x21(weapon1=weapon1, weapon2=weapon2)
        # Form Betrothal
        elif GetTalkListEntryResult() == 10:
            SetEventState(25008100, 1)
            PlayerEquipmentQuantityChange(3, 2000, -1)
            assert t400131_x6(text1=10108030, flag1=0, mode1=0)
            continue
        # Flirt
        elif GetTalkListEntryResult() == 11:
            # Good
            if GetEventStatus(25008900):
                assert t400131_x6(text1=10108000, flag1=0, mode1=0)
                GetItemFromItemLot(90090)
            # Neutral
            elif GetEventStatus(25008901):
                assert t400131_x6(text1=10108010, flag1=0, mode1=0)
            # Bad
            elif GetEventStatus(25008902):
                assert t400131_x6(text1=10108020, flag1=0, mode1=0)
            continue
        # Divorce
        ...
        # Masteries
            ...
            """ State 7,13 """
            assert t400131_x24(z1=z1)
            """ State 16 """
            return 0

def t400131_x11(goods1=2135, z1=390, goods2=2138):
    """ State 0,1,2 """
    if not GetEventStatus(74000150):
        """ State 3,21 """
        # talk:13000000:Oh, thou'rt unkindled, and a seeker of Lords.
        assert t400131_x4(text3=13000000, z4=74000150, flag3=0, mode3=1)
    else:
        """ State 4 """
        if GetEventStatus(74000170) == 1:
            ...
            # goods:2138:Eyes of a Fire Keeper
                ...
                assert t400131_x5(text2=13001720, z3=74000151, flag2=0, mode2=1)
            else:
                """ State 14 """
                if not GetEventStatus(74000171):
                    """ State 11,26 """
                    # talk:13000100:Fret not, fret not, my feet are here firmly planted.
                    assert t400131_x6(text1=13000100, flag1=0, mode1=1)
                else:
                    """ State 12,27 """
                    # talk:13000300:Ah-hah, thou'rt returned. And a fine day it is.
                    assert t400131_x6(text1=13000300, flag1=0, mode1=1)
    """ State 24 """
    # weapon:6260000:Lorian's Greatsword, weapon:6280000:Lothric's Holy Sword
    assert t400131_x10(goods1=goods1, z1=z1, weapon1=6260000, weapon2=6280000)
    """ State 34 """
    return 0
...
def t400131_x12():
    ...
    if GetDistanceToPlayer() < 10:
        ...
        if not GetEventStatus(74000165):
            """ State 3,9 """
            # talk:13001300: 
            call = t400131_x4(text3=13001300, z4=74000165, flag3=0, mode3=1)
            if call.Done():
                pass
            ...
            """ State 12 """
            # talk:13001400: 
            call = t400131_x4(text3=13001400, z4=74000166, flag3=0, mode3=1)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 12:
                """ State 13 """
...
def t400131_x15(z1=390):
    """ State 0,1 """
    if (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonMenuIsOpen(12, 0) and not
        CheckSpecificPersonGenericDialogIsOpen(0)):
        """ State 2,5 """
        call = t400131_x24(z1=z1)
        if call.Done():
            pass
        elif GetDistanceToPlayer() > 12:
            """ State 4 """
...
def t400131_x16():
    ...
    if not GetEventStatus(9308):
        ...
        assert t400131_x4(text3=13001200, z4=74000160, flag3=0, mode3=1)
    else:
        """ State 2,4 """
        # talk:13001100:See ye not? I am a Lord...
        assert t400131_x4(text3=13001100, z4=74000160, flag3=0, mode3=1)
    """ State 6 """
    return 0
...
def t400131_x17():
    ...
    while True:
        ...
        call = t400131_x19(goods1=2135, z1=390, goods2=2138)
...
def t400131_x19(goods1=2135, z1=390, goods2=2138):
    """ State 0,1 """
    call = t400131_x26(goods1=goods1, z1=z1, goods2=goods2)
...
def t400131_x21(weapon1=6260000, weapon2=6280000):
    """ State 0,15 """
    assert t400131_x28(weapon1=weapon1, weapon2=weapon2)
    """ State 7 """
    if GetEventStatus(74000171) == 1 and not GetEventStatus(74000153) and GetEventStatus(74000182) == 1:
        ...
        assert t400131_x5(text2=13002500, z3=74000153, flag2=0, mode2=1)
    else:
        """ State 8,6 """
        if not GetEventStatus(54000280):
            ...
            if not GetEventStatus(9307):
                ...
                if GetEventStatus(132) == 1 and not GetEventStatus(74000171):
                    ...
                    assert t400131_x6(text1=13000800, flag1=0, mode1=1)
                else:
                    """ State 5,11 """
                    # talk:13000700:Knowest thou of our purpose?
                    assert t400131_x5(text2=13000700, z3=74000155, flag2=0, mode2=1)
            else:
                """ State 3,12 """
                # talk:13000900:Ahh, most illustrious Lordseeker. Or should I say, Lord-slayer?
                assert t400131_x6(text1=13000900, flag1=0, mode1=1)
        else:
            """ State 13 """
            # talk:13002400:The eyes shew a world destitute of fire, a barren plane of endless darkness.
            assert t400131_x6(text1=13002400, flag1=0, mode1=1)
    """ State 16 """
    return 0

def t400131_x22(goods1=2135):
    """ State 0,5 """
    # action:12003000:Give <?gdsparam@2135?>?
    call = t400131_x0(action2=12003000)
    if call.Get() == 0:
        """ State 1,4 """
        ...
        assert t400131_x6(text1=13001000, flag1=0, mode1=1)
    elif call.Get() == 1:
        """ State 2 """
        pass
    """ State 7 """
...
def t400131_x23():
    ...
    if GetEventStatus(74000181) == 1:
        """ State 2,4 """
        Label('L0')
        call = t400131_x1(z5=6130, flag4=1035, flag5=6000, flag6=6000, flag7=6000, flag8=6000)
        if call.Done():
            pass
        elif not GetEventStatus(74000181):
            """ State 5 """
            Label('L1')
            call = t400131_x1(z5=6131, flag4=1035, flag5=6000, flag6=6000, flag7=6000, flag8=6000)
            if call.Done():
                pass
...
def t400131_x24(z1=390):
    ...
    if GetEventStatus(74000173) == 1:
        ...
        if not GetEventStatus(50006020):
            ...
            assert t400131_x6(text1=13002200, flag1=0, mode1=1)
        else:
            """ State 8,10 """
            call = t400131_x9(z2=5)
            if call.Done() and CompareRNGValue(1, 4) == 1:
                """ State 2,9 """
                # talk:13000600:Now, now, do not be away overlong.
                assert t400131_x6(text1=13000600, flag1=0, mode1=1)
            elif call.Done():
                """ State 5,11 """
                # talk:13002100:Treat the Fire Keeper not with discourtesy.
                assert t400131_x6(text1=13002100, flag1=0, mode1=1)
    """ State 14 """
    return 0

def t400131_x25(weapon1=6260000, weapon2=6280000):
    """ State 0,3 """
    # action:12003001:Transpose <?weaponNameId@6260000?> \nand <?weaponNameId@6280000?> into a single weapon?
    call = t400131_x0(action2=12003001)
    if call.Get() == 0:
        """ State 1,5 """
        assert t400131_x31(weapon1=weapon1, weapon2=weapon2)
        """ State 4 """
        # action:13003000:The brothers' blades were made one
        assert t400131_x8(action1=13003000)
    elif call.Done():
        """ State 2 """
        pass
    """ State 6 """
...
def t400131_x26(goods1=2135, z1=390, goods2=2138):
    """ State 0,6 """
    while True:
        call = t400131_x23()
        if call.Done():
            """ State 3 """
            call = t400131_x11(goods1=goods1, z1=z1, goods2=goods2)
            if call.Done():
                pass
...
def t400131_x27():
    ...
    if GetEventStatus(1038) == 1:
        ...
        if GetDistanceToPlayer() < 10:
            """ State 4,7 """
            # talk:13001600: 
            call = t400131_x6(text1=13001600, flag1=0, mode1=1)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 12:
                """ State 6 """
...
def t400131_x28(weapon1=6260000, weapon2=6280000):
    """ State 0,1 """
...
def t400131_x29(weapon1=_):
    """ State 0,2 """
    # weapon:6260000:Lorian's Greatsword, weapon:6280000:Lothric's Holy Sword
    call = t400131_x30(weapon1=weapon1, weapon3=0)
    if call.Get() == 0:
        """ State 3 """
        call = t400131_x30(weapon1=weapon1, weapon3=1)
        if call.Get() == 0:
            """ State 4 """
            call = t400131_x30(weapon1=weapon1, weapon3=2)
            if call.Get() == 0:
                """ State 5 """
                call = t400131_x30(weapon1=weapon1, weapon3=3)
                if call.Get() == 0:
                    """ State 6 """
                    call = t400131_x30(weapon1=weapon1, weapon3=4)
                    if call.Get() == 0:
                        """ State 7 """
                        call = t400131_x30(weapon1=weapon1, weapon3=5)
                        if call.Get() == 0:
                            """ State 1 """
                            Quit()
                        elif call.Done():
...
def t400131_x30(weapon1=_, weapon3=_):
    """ State 0,2 """
...
def t400131_x31(weapon1=6260000, weapon2=6280000):
    """ State 0,1 """
    assert t400131_x29(weapon1=weapon1)
    """ State 2 """
    assert t400131_x29(weapon1=weapon2)
    """ State 3 """
    # lot:60310:Twin Princes' Greatsword
    assert t400131_x7(lot1=60310)
    """ State 4 """
    return 0

def t400131_x32(action2=_):
    """ State 0,1 """
    OpenGenericDialog(8, action2, 3, 4, 2)
    assert not CheckSpecificPersonGenericDialogIsOpen(0)
    """ State 2 """
