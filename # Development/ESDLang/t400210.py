...
def t400210_x15(goods1=2107, goods2=2108, goods3=2109, goods4=2110, goods5=2111, goods6=2112, goods7=2113,
    ...
    while True:
        ...
        if (ComparePlayerInventoryNumber(3, goods1, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods2, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods3, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods4, 2, 0, 0) == 1):
            """ State 16 """
            Label('L0')
            # Give umbral ash
            ...
            """ State 15 """
            if (ComparePlayerInventoryNumber(3, goods11, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods12, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods13, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods15, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods17, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(3, goods18, 2, 0, 0) == 1):
                Goto('L0')
            else:
                pass
