...
def t400240_x16(goods1=2127, goods2=2128, goods3=2129, goods4=2130, goods5=2131, goods6=2173):
    ...
    while True:
        ...
        # Offerings
        AddTalkListData(6, 15003009, -1)
        
        # Form Covenant
        AddTalkListDataIf(GetEventStatus(25000201) == 0, 7, 15003019, -1)
        ...
        # Form Betrothal
            ...
            OpenGenericDialog(1, 99012145, 0, 0, 0)
            return 0
        # Flirt
        elif GetTalkListEntryResult() == 31:
            # Good
            if GetEventStatus(25008900):
                OpenGenericDialog(1, 99012140, 0, 0, 0)
                GetItemFromItemLot(90140)
            # Neutral
            elif GetEventStatus(25008901):
                OpenGenericDialog(1, 99012141, 0, 0, 0)
            # Bad
            elif GetEventStatus(25008902):
                OpenGenericDialog(1, 99012142, 0, 0, 0)
            continue
        # Divorce
