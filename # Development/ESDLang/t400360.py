...
def t400360_x3(text1=_, flag1=0, mode1=1):
    """ State 0,4 """
    assert t400360_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t400360_x5():
    """ State 0,1,2,3,4 """
    # talk:36000000: 
    assert t400360_x3(text1=36000000, flag1=0, mode1=1)
    """ State 5 """
    # lot:62600:Blue Sentinels
    assert t400360_x4(lot1=62600)
    """ State 6 """
    return 0
...
def t400360_x10():
    ...
    while True:
        call = t400360_x12()
        assert not GetEventStatus(1482)
        """ State 2 """
        call = t400360_x13()
...
def t400360_x14():
    """ State 0,1,2,3 """
    # talk:36000200: 
    assert t400360_x3(text1=36000200, flag1=0, mode1=1)
    """ State 4 """
    return 0
