...
def t400505_x4():
    """ State 0,5 """
    while True:
        call = t400505_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000) # Interaction State
        if call.Done():
            """ State 3 """
...
# Interaction State
def t400505_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """ State 0,1 """
    while True:
...
def t400505_x9():
    ...
    while True:
        ...
        # Odds and Ends
        AddTalkListData(5, 15003064, -1)
        
        # Insignias and Emblems
        AddTalkListData(1, 15003060, -1)
        
        # Elixirs
        AddTalkListData(2, 15003061, -1)
        
        # Writs
        AddTalkListData(3, 15003062, -1)
        
        # Oils
        AddTalkListData(4, 15003063, -1)
...
#----------------------------------------------------
# Acquire Gesture
def t400505_x50(z2=_, z3=_, flag1=_):
    """ State 0,1 """
