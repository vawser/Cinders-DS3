...
def t400507_x4():
    """ State 0,5 """
    while True:
        call = t400507_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000) # Interaction State
        if call.Done():
            """ State 3 """
...
# Interaction State
def t400507_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """ State 0,1 """
    while True:
...
def t400507_x41():
    ...
    while True:
        ...
        # Life Ring
        if GetTalkListEntryResult() == 1:
            assert t400507_x50(20000, 20001, 1, -2)
            return 0
        # Chloranthy Ring
        elif GetTalkListEntryResult() == 2:
            assert t400507_x50(20010, 20011, 1, -2)
            return 0
        # Havel's Ring
        elif GetTalkListEntryResult() == 3:
            assert t400507_x50(20020, 20021, 1, -2)
            return 0
        # Ring of Favor
        elif GetTalkListEntryResult() == 4:
            assert t400507_x50(20030, 20031, 1, -2)
            return 0
        # Ring of Steel Protection
        elif GetTalkListEntryResult() == 5:
            assert t400507_x50(20040, 20041, 1, -2)
            return 0
        # Flame Stoneplate Ring
        elif GetTalkListEntryResult() == 6:
            assert t400507_x50(20050, 20051, 1, -2)
            return 0
        # Thunder Stoneplate Ring
        elif GetTalkListEntryResult() == 7:
            assert t400507_x50(20060, 20061, 1, -2)
            return 0
        # Magic Stoneplate Ring
        elif GetTalkListEntryResult() == 8:
            assert t400507_x50(20070, 20071, 1, -2)
            return 0
        # Dark Stoneplate Ring
        elif GetTalkListEntryResult() == 9:
            assert t400507_x50(20080, 20081, 1, -2)
            return 0
        # Speckled Stoneplate Ring
        elif GetTalkListEntryResult() == 10:
            assert t400507_x50(20090, 20091, 1, -2)
            return 0
        # Bloodbite Ring
        elif GetTalkListEntryResult() == 11:
            assert t400507_x50(20100, 20101, 1, -2)
            return 0
        # Poisonbite Ring
        elif GetTalkListEntryResult() == 12:
            assert t400507_x50(20110, 20111, 1, -2)
            return 0
        # Cursebite Ring
        elif GetTalkListEntryResult() == 13:
            assert t400507_x50(20120, 20121, 1, -2)
            return 0
        # Fleshbite Ring
        elif GetTalkListEntryResult() == 14:
            assert t400507_x50(20130, 20131, 1, -2)
            return 0
        # Wood Grain Ring
        elif GetTalkListEntryResult() == 15:
            assert t400507_x50(20140, 20141, 1, -2)
            return 0
        # Scholar Ring
        elif GetTalkListEntryResult() == 16:
            assert t400507_x50(20150, 20151, 1, -2)
            return 0
        # Priestess Ring
        elif GetTalkListEntryResult() == 17:
            assert t400507_x50(20160, 20161, 1, -2)
            return 0
        # Red Tearstone Ring
        elif GetTalkListEntryResult() == 18:
            assert t400507_x50(20170, 20171, 1, -2)
            return 0
        # Blue Tearstone Ring
        elif GetTalkListEntryResult() == 19:
            assert t400507_x50(20180, 20181, 1, -2)
            return 0
        # Wolf Ring
        elif GetTalkListEntryResult() == 20:
            assert t400507_x50(20190, 20191, 1, -2)
            return 0
        # Lingering Dragoncrest Ring
        elif GetTalkListEntryResult() == 21:
            assert t400507_x50(20270, 20271, 1, -2)
            return 0
        # Sage Ring
        elif GetTalkListEntryResult() == 22:
            assert t400507_x50(20280, 20281, 1, -2)
            return 0
        # Dusk Crown Ring
        elif GetTalkListEntryResult() == 23:
            assert t400507_x50(20300, 20301, 1, -2)
            return 0
        # Darkmoon Ring
        elif GetTalkListEntryResult() == 24:
            assert t400507_x50(20330, 20331, 1, -2)
            return 0
        # Bellowing Dragoncrest Ring
        elif GetTalkListEntryResult() == 25:
            assert t400507_x50(20340, 20341, 1, -2)
            return 0
        # Witch's Ring
        elif GetTalkListEntryResult() == 26:
            assert t400507_x50(20350, 20351, 1, -2)
            return 0
        # Ring of the Sun's First Born
        elif GetTalkListEntryResult() == 27:
            assert t400507_x50(20360, 20361, 1, -2)
            return 0
        # Hawk Ring
        elif GetTalkListEntryResult() == 28:
            assert t400507_x50(20370, 20371, 1, -2)
            return 0
        # Covetous Gold Serpent Ring
        elif GetTalkListEntryResult() == 29:
            assert t400507_x50(20390, 20391, 1, -2)
            return 0
        # Covetous Silver Serpent Ring
        elif GetTalkListEntryResult() == 30:
            assert t400507_x50(20400, 20401, 1, -2)
            return 0
        # Sun Princess Ring
        elif GetTalkListEntryResult() == 31:
            assert t400507_x50(20410, 20411, 1, -2)
            return 0  
        # Skull Ring
        elif GetTalkListEntryResult() == 32:
            assert t400507_x50(20430, 20431, 1, -2)
            return 0
        # Knight's Ring
        elif GetTalkListEntryResult() == 33:
            assert t400507_x50(20460, 20461, 1, -2)
            return 0
        # Hunter's Ring
        elif GetTalkListEntryResult() == 34:
            assert t400507_x50(20470, 20471, 1, -2)
            return 0
        # Knight Slayer's Ring
        elif GetTalkListEntryResult() == 35:
            assert t400507_x50(20480, 20481, 1, -2)
            return 0
        # Magic Clutch Ring
        elif GetTalkListEntryResult() == 36:
            assert t400507_x50(20490, 20491, 1, -2)
            return 0
        # Lightning Clutch Ring
        elif GetTalkListEntryResult() == 37:
            assert t400507_x50(20500, 20501, 1, -2)
            return 0
        # Fire Clutch Ring
        elif GetTalkListEntryResult() == 38:
            assert t400507_x50(20510, 20511, 1, -2)
            return 0
        # Dark Clutch Ring
        elif GetTalkListEntryResult() == 39:
            assert t400507_x50(20520, 20521, 1, -2)
            return 0
        # Flynn's Ring
        elif GetTalkListEntryResult() == 40:
            assert t400507_x50(20540, 20541, 1, -2)
            return 0
        # Prisoner's Chain
        elif GetTalkListEntryResult() == 41:
            assert t400507_x50(20550, 20551, 1, -2)
            return 0
        # Ring of the Evil Eye
        elif GetTalkListEntryResult() == 42:
            assert t400507_x50(20590, 20591, 1, -2)
            return 0
        # Ring of Calamity
        elif GetTalkListEntryResult() == 43:
            assert t400507_x50(20600, 20601, 1, -2)
            return 0
        # Farron Ring
        elif GetTalkListEntryResult() == 44:
            assert t400507_x50(20610, 20611, 1, -2)
            return 0
        # Lloyd's Sword Ring
        elif GetTalkListEntryResult() == 45:
            assert t400507_x50(20660, 20661, 1, -2)
            return 0
        # Lloyd's Shield Ring
        elif GetTalkListEntryResult() == 46:
            assert t400507_x50(20670, 20671, 1, -2)
            return 0
        # Estus Ring
        elif GetTalkListEntryResult() == 47:
            assert t400507_x50(20700, 20701, 1, -2)
            return 0
        # Focusing Ring
        elif GetTalkListEntryResult() == 48:
            assert t400507_x50(20710, 20711, 1, -2)
            return 0
        # Horsehoof Ring
        elif GetTalkListEntryResult() == 49:
            assert t400507_x50(20720, 20721, 1, -2)
            return 0
        # Pontiff's Right Eye
        elif GetTalkListEntryResult() == 50:
            assert t400507_x50(20750, 20751, 1, -2)
            return 0
        # Pontiff's Left Eye
        elif GetTalkListEntryResult() == 51:
            assert t400507_x50(20790, 20791, 1, -2)
            return 0
        # Dragonscale Ring
        elif GetTalkListEntryResult() == 52:
            assert t400507_x50(20830, 20831, 1, -2)
            return 0
        # Chillbite Ring
        elif GetTalkListEntryResult() == 53:
            assert t400507_x50(21000, 21001, 1, -2)
            return 0
        # Spirit Amethyst
        elif GetTalkListEntryResult() == 54:
            assert t400507_x50(30010, 30011, 1, -2)
            return 0
        # Unholy Remains
        elif GetTalkListEntryResult() == 55:
            assert t400507_x50(30020, 30021, 1, -2)
            return 0
        # Symbol of the Penitent
        elif GetTalkListEntryResult() == 56:
            assert t400507_x50(30050, 30051, 1, -2)
            return 0
        # Tome of Sunlight
        elif GetTalkListEntryResult() == 57:
            assert t400507_x50(30080, 30081, 1, -2)
            return 0
        # Demonsbane Ring
        elif GetTalkListEntryResult() == 58:
            assert t400507_x50(30170, 30171, 1, -2)
            return 0
        # Crypt Ring
        elif GetTalkListEntryResult() == 59:
            assert t400507_x50(30180, 30181, 1, -2)
            return 0
        # Blight Ring
        elif GetTalkListEntryResult() == 60:
            assert t400507_x50(30190, 30191, 1, -2)
            return 0
        # Hallowed Ring
        elif GetTalkListEntryResult() == 61:
            assert t400507_x50(30200, 30201, 1, -2)
            return 0
        # Ring of Wisdom
        elif GetTalkListEntryResult() == 62:
            assert t400507_x50(30210, 30211, 1, -2)
            return 0
        # Ring of Retaliation
        elif GetTalkListEntryResult() == 63:
            assert t400507_x50(30330, 30331, 1, -2)
            return 0
        # Ring of Reprisal
        elif GetTalkListEntryResult() == 64:
            assert t400507_x50(30340, 30341, 1, -2)
            return 0
        # Ring of Spite
        elif GetTalkListEntryResult() == 65:
            assert t400507_x50(30350, 30351, 1, -2)
            return 0
        # Ring of Retribution
        elif GetTalkListEntryResult() == 66:
            assert t400507_x50(30360, 30361, 1, -2)
            return 0
        # Ring of Vengeance
        elif GetTalkListEntryResult() == 67:
            assert t400507_x50(30370, 30371, 1, -2)
            return 0
        # Mercenary Ring
        elif GetTalkListEntryResult() == 68:
            assert t400507_x50(30390, 30391, 1, -2)
            return 0
        # Heretic Ring
        elif GetTalkListEntryResult() == 69:
            assert t400507_x50(30400, 30401, 1, -2)
            return 0
        # Merchant Ring
        elif GetTalkListEntryResult() == 70:
            assert t400507_x50(30410, 30411, 1, -2)
            return 0
        # Physician Ring
        elif GetTalkListEntryResult() == 71:
            assert t400507_x50(30420, 30421, 1, -2)
            return 0
        # Jester Ring
        elif GetTalkListEntryResult() == 72:
            assert t400507_x50(30430, 30431, 1, -2)
            return 0
        # Londor Tincture
        elif GetTalkListEntryResult() == 73:
            assert t400507_x50(30450, 30451, 1, -2)
            return 0
        # Old Pygmy Brooch
        elif GetTalkListEntryResult() == 74:
            assert t400507_x50(30500, 30501, 1, -2)
            return 0
        # Bestial Band
        elif GetTalkListEntryResult() == 75:
            assert t400507_x50(30650, 30651, 1, -2)
            return 0
        # Band of Stone
        elif GetTalkListEntryResult() == 76:
            assert t400507_x50(30660, 30661, 1, -2)
            return 0
        # Band of Magic
        elif GetTalkListEntryResult() == 77:
            assert t400507_x50(30670, 30671, 1, -2)
            return 0
        # Band of Flame
        elif GetTalkListEntryResult() == 78:
            assert t400507_x50(30680, 30681, 1, -2)
            return 0
        # Band of Sparks
        elif GetTalkListEntryResult() == 79:
            assert t400507_x50(30690, 30691, 1, -2)
            return 0
        # Band of Darkness
        elif GetTalkListEntryResult() == 80:
            assert t400507_x50(30700, 30701, 1, -2)
            return 0
        # Elden Ring
        elif GetTalkListEntryResult() == 81:
            assert t400507_x50(30800, 30801, 1, -2)
            return 0
        # Ring of Punishment
        elif GetTalkListEntryResult() == 82:
            assert t400507_x50(30890, 30891, 1, -2)
            return 0
        # Relic of Power
        elif GetTalkListEntryResult() == 83:
            assert t400507_x50(30910, 30911, 1, -2)
            return 0
        # Relic of Insanity
        elif GetTalkListEntryResult() == 84:
            assert t400507_x50(30920, 30921, 1, -2)
            return 0
        # Tainted Chalice
        elif GetTalkListEntryResult() == 85:
            assert t400507_x50(30930, 30931, 1, -2)
            return 0
        # Accursed Sigil
        elif GetTalkListEntryResult() == 86:
            assert t400507_x50(30940, 30941, 1, -2)
            return 0
        # Frostflower Ring
...
def t400507_x42():
    ...
    while True:
        ...
        # Life Ring
        if GetTalkListEntryResult() == 1:
            assert t400507_x50(20001, 20002, 3, -4)
            return 0
        # Chloranthy Ring
        elif GetTalkListEntryResult() == 2:
            assert t400507_x50(20011, 20012, 3, -4)
            return 0
        # Havel's Ring
        elif GetTalkListEntryResult() == 3:
            assert t400507_x50(20021, 20022, 3, -4)
            return 0
        # Ring of Favor
        elif GetTalkListEntryResult() == 4:
            assert t400507_x50(20031, 20032, 3, -4)
            return 0
        # Ring of Steel Protection
        elif GetTalkListEntryResult() == 5:
            assert t400507_x50(20041, 20042, 3, -4)
            return 0
        # Flame Stoneplate Ring
        elif GetTalkListEntryResult() == 6:
            assert t400507_x50(20051, 20052, 3, -4)
            return 0
        # Thunder Stoneplate Ring
        elif GetTalkListEntryResult() == 7:
            assert t400507_x50(20061, 20062, 3, -4)
            return 0
        # Magic Stoneplate Ring
        elif GetTalkListEntryResult() == 8:
            assert t400507_x50(20071, 20072, 3, -4)
            return 0
        # Dark Stoneplate Ring
        elif GetTalkListEntryResult() == 9:
            assert t400507_x50(20081, 20082, 3, -4)
            return 0
        # Speckled Stoneplate Ring
        elif GetTalkListEntryResult() == 10:
            assert t400507_x50(20091, 20092, 3, -4)
            return 0
        # Bloodbite Ring
        elif GetTalkListEntryResult() == 11:
            assert t400507_x50(20101, 20102, 3, -4)
            return 0
        # Poisonbite Ring
        elif GetTalkListEntryResult() == 12:
            assert t400507_x50(20111, 20112, 3, -4)
            return 0
        # Cursebite Ring
        elif GetTalkListEntryResult() == 13:
            assert t400507_x50(20121, 20122, 3, -4)
            return 0
        # Fleshbite Ring
        elif GetTalkListEntryResult() == 14:
            assert t400507_x50(20131, 20132, 3, -4)
            return 0
        # Wood Grain Ring
        elif GetTalkListEntryResult() == 15:
            assert t400507_x50(20141, 20142, 3, -4)
            return 0
        # Scholar Ring
        elif GetTalkListEntryResult() == 16:
            assert t400507_x50(20151, 20152, 3, -4)
            return 0
        # Priestess Ring
        elif GetTalkListEntryResult() == 17:
            assert t400507_x50(20161, 20162, 3, -4)
            return 0
        # Red Tearstone Ring
        elif GetTalkListEntryResult() == 18:
            assert t400507_x50(20171, 20172, 3, -4)
            return 0
        # Blue Tearstone Ring
        elif GetTalkListEntryResult() == 19:
            assert t400507_x50(20181, 20182, 3, -4)
            return 0
        # Wolf Ring
        elif GetTalkListEntryResult() == 20:
            assert t400507_x50(20191, 20192, 3, -4)
            return 0
        # Lingering Dragoncrest Ring
        elif GetTalkListEntryResult() == 21:
            assert t400507_x50(20271, 20272, 3, -4)
            return 0
        # Sage Ring
        elif GetTalkListEntryResult() == 22:
            assert t400507_x50(20281, 20282, 3, -4)
            return 0
        # Dusk Crown Ring
        elif GetTalkListEntryResult() == 23:
            assert t400507_x50(20301, 20302, 3, -4)
            return 0
        # Darkmoon Ring
        elif GetTalkListEntryResult() == 24:
            assert t400507_x50(20331, 20332, 3, -4)
            return 0
        # Bellowing Dragoncrest Ring
        elif GetTalkListEntryResult() == 25:
            assert t400507_x50(20341, 20342, 3, -4)
            return 0
        # Witch's Ring
        elif GetTalkListEntryResult() == 26:
            assert t400507_x50(20351, 20352, 3, -4)
            return 0
        # Ring of the Sun's First Born
        elif GetTalkListEntryResult() == 27:
            assert t400507_x50(20361, 20362, 3, -4)
            return 0
        # Hawk Ring
        elif GetTalkListEntryResult() == 28:
            assert t400507_x50(20371, 20372, 3, -4)
            return 0
        # Covetous Gold Serpent Ring
        elif GetTalkListEntryResult() == 29:
            assert t400507_x50(20391, 20392, 3, -4)
            return 0
        # Covetous Silver Serpent Ring
        elif GetTalkListEntryResult() == 30:
            assert t400507_x50(20401, 20402, 3, -4)
            return 0
        # Sun Princess Ring
        elif GetTalkListEntryResult() == 31:
            assert t400507_x50(20411, 20412, 3, -4)
            return 0  
        # Skull Ring
        elif GetTalkListEntryResult() == 32:
            assert t400507_x50(20431, 20432, 3, -4)
            return 0
        # Knight's Ring
        elif GetTalkListEntryResult() == 33:
            assert t400507_x50(20461, 20462, 3, -4)
            return 0
        # Hunter's Ring
        elif GetTalkListEntryResult() == 34:
            assert t400507_x50(20471, 20472, 3, -4)
            return 0
        # Knight Slayer's Ring
        elif GetTalkListEntryResult() == 35:
            assert t400507_x50(20481, 20482, 3, -4)
            return 0
        # Magic Clutch Ring
        elif GetTalkListEntryResult() == 36:
            assert t400507_x50(20491, 20492, 3, -4)
            return 0
        # Lightning Clutch Ring
        elif GetTalkListEntryResult() == 37:
            assert t400507_x50(20501, 20502, 3, -4)
            return 0
        # Fire Clutch Ring
        elif GetTalkListEntryResult() == 38:
            assert t400507_x50(20511, 20512, 3, -4)
            return 0
        # Dark Clutch Ring
        elif GetTalkListEntryResult() == 39:
            assert t400507_x50(20521, 20522, 3, -4)
            return 0
        # Flynn's Ring
        elif GetTalkListEntryResult() == 40:
            assert t400507_x50(20541, 20542, 3, -4)
            return 0
        # Prisoner's Chain
        elif GetTalkListEntryResult() == 41:
            assert t400507_x50(20551, 20552, 3, -4)
            return 0
        # Ring of the Evil Eye
        elif GetTalkListEntryResult() == 42:
            assert t400507_x50(20591, 20592, 3, -4)
            return 0
        # Ring of Calamity
        elif GetTalkListEntryResult() == 43:
            assert t400507_x50(20601, 20602, 3, -4)
            return 0
        # Farron Ring
        elif GetTalkListEntryResult() == 44:
            assert t400507_x50(20611, 20612, 3, -4)
            return 0
        # Lloyd's Sword Ring
        elif GetTalkListEntryResult() == 45:
            assert t400507_x50(20661, 20662, 3, -4)
            return 0
        # Lloyd's Shield Ring
        elif GetTalkListEntryResult() == 46:
            assert t400507_x50(20671, 20672, 3, -4)
            return 0
        # Estus Ring
        elif GetTalkListEntryResult() == 47:
            assert t400507_x50(20701, 20702, 3, -4)
            return 0
        # Focusing Ring
        elif GetTalkListEntryResult() == 48:
            assert t400507_x50(20711, 20712, 3, -4)
            return 0
        # Horsehoof Ring
        elif GetTalkListEntryResult() == 49:
            assert t400507_x50(20721, 20722, 3, -4)
            return 0
        # Pontiff's Right Eye
        elif GetTalkListEntryResult() == 50:
            assert t400507_x50(20751, 20752, 3, -4)
            return 0
        # Pontiff's Left Eye
        elif GetTalkListEntryResult() == 51:
            assert t400507_x50(20791, 20792, 3, -4)
            return 0
        # Dragonscale Ring
        elif GetTalkListEntryResult() == 52:
            assert t400507_x50(20831, 20832, 3, -4)
            return 0
        # Chillbite Ring
        elif GetTalkListEntryResult() == 53:
            assert t400507_x50(21001, 21002, 3, -4)
            return 0
        # Spirit Amethyst
        elif GetTalkListEntryResult() == 54:
            assert t400507_x50(30011, 30012, 3, -4)
            return 0
        # Unholy Remains
        elif GetTalkListEntryResult() == 55:
            assert t400507_x50(30021, 30022, 3, -4)
            return 0
        # Symbol of the Penitent
        elif GetTalkListEntryResult() == 56:
            assert t400507_x50(30051, 30052, 3, -4)
            return 0
        # Tome of Sunlight
        elif GetTalkListEntryResult() == 57:
            assert t400507_x50(30081, 30082, 3, -4)
            return 0
        # Demonsbane Ring
        elif GetTalkListEntryResult() == 58:
            assert t400507_x50(30171, 30172, 3, -4)
            return 0
        # Crypt Ring
        elif GetTalkListEntryResult() == 59:
            assert t400507_x50(30181, 30182, 3, -4)
            return 0
        # Blight Ring
        elif GetTalkListEntryResult() == 60:
            assert t400507_x50(30191, 30192, 3, -4)
            return 0
        # Hallowed Ring
        elif GetTalkListEntryResult() == 61:
            assert t400507_x50(30201, 30202, 3, -4)
            return 0
        # Ring of Wisdom
        elif GetTalkListEntryResult() == 62:
            assert t400507_x50(30211, 30212, 3, -4)
            return 0
        # Ring of Retaliation
        elif GetTalkListEntryResult() == 63:
            assert t400507_x50(30331, 30332, 3, -4)
            return 0
        # Ring of Reprisal
        elif GetTalkListEntryResult() == 64:
            assert t400507_x50(30341, 30342, 3, -4)
            return 0
        # Ring of Spite
        elif GetTalkListEntryResult() == 65:
            assert t400507_x50(30351, 30352, 3, -4)
            return 0
        # Ring of Retribution
        elif GetTalkListEntryResult() == 66:
            assert t400507_x50(30361, 30362, 3, -4)
            return 0
        # Ring of Vengeance
        elif GetTalkListEntryResult() == 67:
            assert t400507_x50(30371, 30372, 3, -4)
            return 0
        # Mercenary Ring
        elif GetTalkListEntryResult() == 68:
            assert t400507_x50(30391, 30392, 3, -4)
            return 0
        # Heretic Ring
        elif GetTalkListEntryResult() == 69:
            assert t400507_x50(30401, 30402, 3, -4)
            return 0
        # Merchant Ring
        elif GetTalkListEntryResult() == 70:
            assert t400507_x50(30411, 30412, 3, -4)
            return 0
        # Physician Ring
        elif GetTalkListEntryResult() == 71:
            assert t400507_x50(30421, 30422, 3, -4)
            return 0
        # Jester Ring
        elif GetTalkListEntryResult() == 72:
            assert t400507_x50(30431, 30432, 3, -4)
            return 0
        # Londor Tincture
        elif GetTalkListEntryResult() == 73:
            assert t400507_x50(30451, 30452, 3, -4)
            return 0
        # Old Pygmy Brooch
        elif GetTalkListEntryResult() == 74:
            assert t400507_x50(30501, 30502, 3, -4)
            return 0
        # Bestial Band
        elif GetTalkListEntryResult() == 75:
            assert t400507_x50(30651, 30652, 3, -4)
            return 0
        # Band of Stone
        elif GetTalkListEntryResult() == 76:
            assert t400507_x50(30661, 30662, 3, -4)
            return 0
        # Band of Magic
        elif GetTalkListEntryResult() == 77:
            assert t400507_x50(30671, 30672, 3, -4)
            return 0
        # Band of Flame
        elif GetTalkListEntryResult() == 78:
            assert t400507_x50(30681, 30682, 3, -4)
            return 0
        # Band of Sparks
        elif GetTalkListEntryResult() == 79:
            assert t400507_x50(30691, 30692, 3, -4)
            return 0
        # Band of Darkness
        elif GetTalkListEntryResult() == 80:
            assert t400507_x50(30701, 30702, 3, -4)
            return 0
        # Elden Ring
        elif GetTalkListEntryResult() == 81:
            assert t400507_x50(30801, 30802, 3, -4)
            return 0
        # Ring of Punishment
        elif GetTalkListEntryResult() == 82:
            assert t400507_x50(30891, 30892, 3, -4)
            return 0
        # Relic of Power
        elif GetTalkListEntryResult() == 83:
            assert t400507_x50(30911, 30912, 3, -4)
            return 0
        # Relic of Insanity
        elif GetTalkListEntryResult() == 84:
            assert t400507_x50(30921, 30922, 3, -4)
            return 0
        # Tainted Chalice
        elif GetTalkListEntryResult() == 85:
            assert t400507_x50(30931, 30932, 3, -4)
            return 0
        # Accursed Sigil
        elif GetTalkListEntryResult() == 86:
            assert t400507_x50(30941, 30942, 3, -4)
            return 0
        # Frostflower Ring
        elif GetTalkListEntryResult() == 87:
...
def t400507_x43():
    ...
    while True:
        ...
        # Life Ring
        if GetTalkListEntryResult() == 1:
            assert t400507_x50(20002, 20003, 5, -6)
            return 0
        # Chloranthy Ring
        elif GetTalkListEntryResult() == 2:
            assert t400507_x50(20012, 20013, 5, -6)
            return 0
        # Havel's Ring
        elif GetTalkListEntryResult() == 3:
            assert t400507_x50(20022, 20023, 5, -6)
            return 0
        # Ring of Favor
        elif GetTalkListEntryResult() == 4:
            assert t400507_x50(20032, 20033, 5, -6)
            return 0
        # Ring of Steel Protection
        elif GetTalkListEntryResult() == 5:
            assert t400507_x50(20042, 20043, 5, -6)
            return 0
        # Flame Stoneplate Ring
        elif GetTalkListEntryResult() == 6:
            assert t400507_x50(20052, 20053, 5, -6)
            return 0
        # Thunder Stoneplate Ring
        elif GetTalkListEntryResult() == 7:
            assert t400507_x50(20062, 20063, 5, -6)
            return 0
        # Magic Stoneplate Ring
        elif GetTalkListEntryResult() == 8:
            assert t400507_x50(20072, 20073, 5, -6)
            return 0
        # Dark Stoneplate Ring
        elif GetTalkListEntryResult() == 9:
            assert t400507_x50(20082, 20083, 5, -6)
            return 0
        # Speckled Stoneplate Ring
        elif GetTalkListEntryResult() == 10:
            assert t400507_x50(20092, 20093, 5, -6)
            return 0
        # Bloodbite Ring
        elif GetTalkListEntryResult() == 11:
            assert t400507_x50(20102, 20103, 5, -6)
            return 0
        # Poisonbite Ring
        elif GetTalkListEntryResult() == 12:
            assert t400507_x50(20112, 20113, 5, -6)
            return 0
        # Cursebite Ring
        elif GetTalkListEntryResult() == 13:
            assert t400507_x50(20122, 20123, 5, -6)
            return 0
        # Fleshbite Ring
        elif GetTalkListEntryResult() == 14:
            assert t400507_x50(20132, 20133, 5, -6)
            return 0
        # Wood Grain Ring
        elif GetTalkListEntryResult() == 15:
            assert t400507_x50(20142, 20143, 5, -6)
            return 0
        # Scholar Ring
        elif GetTalkListEntryResult() == 16:
            assert t400507_x50(20152, 20153, 5, -6)
            return 0
        # Priestess Ring
        elif GetTalkListEntryResult() == 17:
            assert t400507_x50(20162, 20163, 5, -6)
            return 0
        # Red Tearstone Ring
        elif GetTalkListEntryResult() == 18:
            assert t400507_x50(20172, 20173, 5, -6)
            return 0
        # Blue Tearstone Ring
        elif GetTalkListEntryResult() == 19:
            assert t400507_x50(20182, 20183, 5, -6)
            return 0
        # Wolf Ring
        elif GetTalkListEntryResult() == 20:
            assert t400507_x50(20192, 20193, 5, -6)
            return 0
        # Lingering Dragoncrest Ring
        elif GetTalkListEntryResult() == 21:
            assert t400507_x50(20272, 20273, 5, -6)
            return 0
        # Sage Ring
        elif GetTalkListEntryResult() == 22:
            assert t400507_x50(20282, 20283, 5, -6)
            return 0
        # Dusk Crown Ring
        elif GetTalkListEntryResult() == 23:
            assert t400507_x50(20302, 20303, 5, -6)
            return 0
        # Darkmoon Ring
        elif GetTalkListEntryResult() == 24:
            assert t400507_x50(20332, 20333, 5, -6)
            return 0
        # Bellowing Dragoncrest Ring
        elif GetTalkListEntryResult() == 25:
            assert t400507_x50(20342, 20343, 5, -6)
            return 0
        # Witch's Ring
        elif GetTalkListEntryResult() == 26:
            assert t400507_x50(20352, 20353, 5, -6)
            return 0
        # Ring of the Sun's First Born
        elif GetTalkListEntryResult() == 27:
            assert t400507_x50(20362, 20363, 5, -6)
            return 0
        # Hawk Ring
        elif GetTalkListEntryResult() == 28:
            assert t400507_x50(20372, 20373, 5, -6)
            return 0
        # Covetous Gold Serpent Ring
        elif GetTalkListEntryResult() == 29:
            assert t400507_x50(20392, 20393, 5, -6)
            return 0
        # Covetous Silver Serpent Ring
        elif GetTalkListEntryResult() == 30:
            assert t400507_x50(20402, 20403, 5, -6)
            return 0
        # Sun Princess Ring
        elif GetTalkListEntryResult() == 31:
            assert t400507_x50(20412, 20413, 5, -6)
            return 0  
        # Skull Ring
        elif GetTalkListEntryResult() == 32:
            assert t400507_x50(20432, 20433, 5, -6)
            return 0
        # Knight's Ring
        elif GetTalkListEntryResult() == 33:
            assert t400507_x50(20462, 20463, 5, -6)
            return 0
        # Hunter's Ring
        elif GetTalkListEntryResult() == 34:
            assert t400507_x50(20472, 20473, 5, -6)
            return 0
        # Knight Slayer's Ring
        elif GetTalkListEntryResult() == 35:
            assert t400507_x50(20482, 20483, 5, -6)
            return 0
        # Magic Clutch Ring
        elif GetTalkListEntryResult() == 36:
            assert t400507_x50(20492, 20493, 5, -6)
            return 0
        # Lightning Clutch Ring
        elif GetTalkListEntryResult() == 37:
            assert t400507_x50(20502, 20503, 5, -6)
            return 0
        # Fire Clutch Ring
        elif GetTalkListEntryResult() == 38:
            assert t400507_x50(20512, 20513, 5, -6)
            return 0
        # Dark Clutch Ring
        elif GetTalkListEntryResult() == 39:
            assert t400507_x50(20522, 20523, 5, -6)
            return 0
        # Flynn's Ring
        elif GetTalkListEntryResult() == 40:
            assert t400507_x50(20542, 20543, 5, -6)
            return 0
        # Prisoner's Chain
        elif GetTalkListEntryResult() == 41:
            assert t400507_x50(20552, 20553, 5, -6)
            return 0
        # Ring of the Evil Eye
        elif GetTalkListEntryResult() == 42:
            assert t400507_x50(20592, 20593, 5, -6)
            return 0
        # Ring of Calamity
        elif GetTalkListEntryResult() == 43:
            assert t400507_x50(20602, 20603, 5, -6)
            return 0
        # Farron Ring
        elif GetTalkListEntryResult() == 44:
            assert t400507_x50(20612, 20613, 5, -6)
            return 0
        # Lloyd's Sword Ring
        elif GetTalkListEntryResult() == 45:
            assert t400507_x50(20662, 20663, 5, -6)
            return 0
        # Lloyd's Shield Ring
        elif GetTalkListEntryResult() == 46:
            assert t400507_x50(20672, 20673, 5, -6)
            return 0
        # Estus Ring
        elif GetTalkListEntryResult() == 47:
            assert t400507_x50(20702, 20703, 5, -6)
            return 0
        # Focusing Ring
        elif GetTalkListEntryResult() == 48:
            assert t400507_x50(20712, 20713, 5, -6)
            return 0
        # Horsehoof Ring
        elif GetTalkListEntryResult() == 49:
            assert t400507_x50(20722, 20723, 5, -6)
            return 0
        # Pontiff's Right Eye
        elif GetTalkListEntryResult() == 50:
            assert t400507_x50(20752, 20753, 5, -6)
            return 0
        # Pontiff's Left Eye
        elif GetTalkListEntryResult() == 51:
            assert t400507_x50(20792, 20793, 5, -6)
            return 0
        # Dragonscale Ring
        elif GetTalkListEntryResult() == 52:
            assert t400507_x50(20832, 20833, 5, -6)
            return 0
        # Chillbite Ring
        elif GetTalkListEntryResult() == 53:
            assert t400507_x50(21002, 21003, 5, -6)
            return 0
        # Spirit Amethyst
        elif GetTalkListEntryResult() == 54:
            assert t400507_x50(30012, 30013, 5, -6)
            return 0
        # Unholy Remains
        elif GetTalkListEntryResult() == 55:
            assert t400507_x50(30022, 30023, 5, -6)
            return 0
        # Symbol of the Penitent
        elif GetTalkListEntryResult() == 56:
            assert t400507_x50(30052, 30053, 5, -6)
            return 0
        # Tome of Sunlight
        elif GetTalkListEntryResult() == 57:
            assert t400507_x50(30082, 30083, 5, -6)
            return 0
        # Demonsbane Ring
        elif GetTalkListEntryResult() == 58:
            assert t400507_x50(30172, 30173, 5, -6)
            return 0
        # Crypt Ring
        elif GetTalkListEntryResult() == 59:
            assert t400507_x50(30182, 30183, 5, -6)
            return 0
        # Blight Ring
        elif GetTalkListEntryResult() == 60:
            assert t400507_x50(30192, 30193, 5, -6)
            return 0
        # Hallowed Ring
        elif GetTalkListEntryResult() == 61:
            assert t400507_x50(30202, 30203, 5, -6)
            return 0
        # Ring of Wisdom
        elif GetTalkListEntryResult() == 62:
            assert t400507_x50(30212, 30213, 5, -6)
            return 0
        # Ring of Retaliation
        elif GetTalkListEntryResult() == 63:
            assert t400507_x50(30332, 30333, 5, -6)
            return 0
        # Ring of Reprisal
        elif GetTalkListEntryResult() == 64:
            assert t400507_x50(30342, 30343, 5, -6)
            return 0
        # Ring of Spite
        elif GetTalkListEntryResult() == 65:
            assert t400507_x50(30352, 30353, 5, -6)
            return 0
        # Ring of Retribution
        elif GetTalkListEntryResult() == 66:
            assert t400507_x50(30362, 30363, 5, -6)
            return 0
        # Ring of Vengeance
        elif GetTalkListEntryResult() == 67:
            assert t400507_x50(30372, 30373, 5, -6)
            return 0
        # Mercenary Ring
        elif GetTalkListEntryResult() == 68:
            assert t400507_x50(30392, 30393, 5, -6)
            return 0
        # Heretic Ring
        elif GetTalkListEntryResult() == 69:
            assert t400507_x50(30402, 30403, 5, -6)
            return 0
        # Merchant Ring
        elif GetTalkListEntryResult() == 70:
            assert t400507_x50(30412, 30413, 5, -6)
            return 0
        # Physician Ring
        elif GetTalkListEntryResult() == 71:
            assert t400507_x50(30422, 30423, 5, -6)
            return 0
        # Jester Ring
        elif GetTalkListEntryResult() == 72:
            assert t400507_x50(30432, 30433, 5, -6)
            return 0
        # Londor Tincture
        elif GetTalkListEntryResult() == 73:
            assert t400507_x50(30452, 30453, 5, -6)
            return 0
        # Old Pygmy Brooch
        elif GetTalkListEntryResult() == 74:
            assert t400507_x50(30502, 30503, 5, -6)
            return 0
        # Bestial Band
        elif GetTalkListEntryResult() == 75:
            assert t400507_x50(30652, 30653, 5, -6)
            return 0
        # Band of Stone
        elif GetTalkListEntryResult() == 76:
            assert t400507_x50(30662, 30663, 5, -6)
            return 0
        # Band of Magic
        elif GetTalkListEntryResult() == 77:
            assert t400507_x50(30672, 30673, 5, -6)
            return 0
        # Band of Flame
        elif GetTalkListEntryResult() == 78:
            assert t400507_x50(30682, 30683, 5, -6)
            return 0
        # Band of Sparks
        elif GetTalkListEntryResult() == 79:
            assert t400507_x50(30692, 30693, 5, -6)
            return 0
        # Band of Darkness
        elif GetTalkListEntryResult() == 80:
            assert t400507_x50(30702, 30703, 5, -6)
            return 0
        # Elden Ring
        elif GetTalkListEntryResult() == 81:
            assert t400507_x50(30802, 30803, 5, -6)
            return 0
        # Ring of Punishment
        elif GetTalkListEntryResult() == 82:
            assert t400507_x50(30892, 30893, 5, -6)
            return 0
        # Relic of Power
        elif GetTalkListEntryResult() == 83:
            assert t400507_x50(30912, 30913, 5, -6)
            return 0
        # Relic of Insanity
        elif GetTalkListEntryResult() == 84:
            assert t400507_x50(30922, 30923, 5, -6)
            return 0
        # Tainted Chalice
        elif GetTalkListEntryResult() == 85:
            assert t400507_x50(30932, 30933, 5, -6)
            return 0
        # Accursed Sigil
        elif GetTalkListEntryResult() == 86:
            assert t400507_x50(30942, 30943, 5, -6)
            return 0
        # Frostflower Ring
        elif GetTalkListEntryResult() == 87:
...
def t400507_x44():
    ...
    while True:
        ...
        # Life Ring
        if GetTalkListEntryResult() == 1:
            assert t400507_x50(20003, 20004, 7, -8)
            return 0
        # Chloranthy Ring
        elif GetTalkListEntryResult() == 2:
            assert t400507_x50(20013, 20014, 7, -8)
            return 0
        # Havel's Ring
        elif GetTalkListEntryResult() == 3:
            assert t400507_x50(20023, 20024, 7, -8)
            return 0
        # Ring of Favor
        elif GetTalkListEntryResult() == 4:
            assert t400507_x50(20033, 20034, 7, -8)
            return 0
        # Ring of Steel Protection
        elif GetTalkListEntryResult() == 5:
            assert t400507_x50(20043, 20044, 7, -8)
            return 0
        # Flame Stoneplate Ring
        elif GetTalkListEntryResult() == 6:
            assert t400507_x50(20053, 20054, 7, -8)
            return 0
        # Thunder Stoneplate Ring
        elif GetTalkListEntryResult() == 7:
            assert t400507_x50(20063, 20064, 7, -8)
            return 0
        # Magic Stoneplate Ring
        elif GetTalkListEntryResult() == 8:
            assert t400507_x50(20073, 20074, 7, -8)
            return 0
        # Dark Stoneplate Ring
        elif GetTalkListEntryResult() == 9:
            assert t400507_x50(20083, 20084, 7, -8)
            return 0
        # Speckled Stoneplate Ring
        elif GetTalkListEntryResult() == 10:
            assert t400507_x50(20093, 20094, 7, -8)
            return 0
        # Bloodbite Ring
        elif GetTalkListEntryResult() == 11:
            assert t400507_x50(20103, 20104, 7, -8)
            return 0
        # Poisonbite Ring
        elif GetTalkListEntryResult() == 12:
            assert t400507_x50(20113, 20114, 7, -8)
            return 0
        # Cursebite Ring
        elif GetTalkListEntryResult() == 13:
            assert t400507_x50(20123, 20124, 7, -8)
            return 0
        # Fleshbite Ring
        elif GetTalkListEntryResult() == 14:
            assert t400507_x50(20133, 20134, 7, -8)
            return 0
        # Wood Grain Ring
        elif GetTalkListEntryResult() == 15:
            assert t400507_x50(20143, 20144, 7, -8)
            return 0
        # Scholar Ring
        elif GetTalkListEntryResult() == 16:
            assert t400507_x50(20153, 20154, 7, -8)
            return 0
        # Priestess Ring
        elif GetTalkListEntryResult() == 17:
            assert t400507_x50(20163, 20164, 7, -8)
            return 0
        # Red Tearstone Ring
        elif GetTalkListEntryResult() == 18:
            assert t400507_x50(20173, 20174, 7, -8)
            return 0
        # Blue Tearstone Ring
        elif GetTalkListEntryResult() == 19:
            assert t400507_x50(20183, 20184, 7, -8)
            return 0
        # Wolf Ring
        elif GetTalkListEntryResult() == 20:
            assert t400507_x50(20193, 20194, 7, -8)
            return 0
        # Lingering Dragoncrest Ring
        elif GetTalkListEntryResult() == 21:
            assert t400507_x50(20273, 20274, 7, -8)
            return 0
        # Sage Ring
        elif GetTalkListEntryResult() == 22:
            assert t400507_x50(20283, 20284, 7, -8)
            return 0
        # Dusk Crown Ring
        elif GetTalkListEntryResult() == 23:
            assert t400507_x50(20303, 20304, 7, -8)
            return 0
        # Darkmoon Ring
        elif GetTalkListEntryResult() == 24:
            assert t400507_x50(20333, 20334, 7, -8)
            return 0
        # Bellowing Dragoncrest Ring
        elif GetTalkListEntryResult() == 25:
            assert t400507_x50(20343, 20344, 7, -8)
            return 0
        # Witch's Ring
        elif GetTalkListEntryResult() == 26:
            assert t400507_x50(20353, 20354, 7, -8)
            return 0
        # Ring of the Sun's First Born
        elif GetTalkListEntryResult() == 27:
            assert t400507_x50(20363, 20364, 7, -8)
            return 0
        # Hawk Ring
        elif GetTalkListEntryResult() == 28:
            assert t400507_x50(20373, 20374, 7, -8)
            return 0
        # Covetous Gold Serpent Ring
        elif GetTalkListEntryResult() == 29:
            assert t400507_x50(20393, 20394, 7, -8)
            return 0
        # Covetous Silver Serpent Ring
        elif GetTalkListEntryResult() == 30:
            assert t400507_x50(20403, 20404, 7, -8)
            return 0
        # Sun Princess Ring
        elif GetTalkListEntryResult() == 31:
            assert t400507_x50(20413, 20414, 7, -8)
            return 0  
        # Skull Ring
        elif GetTalkListEntryResult() == 32:
            assert t400507_x50(20433, 20434, 7, -8)
            return 0
        # Knight's Ring
        elif GetTalkListEntryResult() == 33:
            assert t400507_x50(20463, 20464, 7, -8)
            return 0
        # Hunter's Ring
        elif GetTalkListEntryResult() == 34:
            assert t400507_x50(20473, 20474, 7, -8)
            return 0
        # Knight Slayer's Ring
        elif GetTalkListEntryResult() == 35:
            assert t400507_x50(20483, 20484, 7, -8)
            return 0
        # Magic Clutch Ring
        elif GetTalkListEntryResult() == 36:
            assert t400507_x50(20493, 20494, 7, -8)
            return 0
        # Lightning Clutch Ring
        elif GetTalkListEntryResult() == 37:
            assert t400507_x50(20503, 20504, 7, -8)
            return 0
        # Fire Clutch Ring
        elif GetTalkListEntryResult() == 38:
            assert t400507_x50(20513, 20514, 7, -8)
            return 0
        # Dark Clutch Ring
        elif GetTalkListEntryResult() == 39:
            assert t400507_x50(20523, 20524, 7, -8)
            return 0
        # Flynn's Ring
        elif GetTalkListEntryResult() == 40:
            assert t400507_x50(20543, 20544, 7, -8)
            return 0
        # Prisoner's Chain
        elif GetTalkListEntryResult() == 41:
            assert t400507_x50(20553, 20554, 7, -8)
            return 0
        # Ring of the Evil Eye
        elif GetTalkListEntryResult() == 42:
            assert t400507_x50(20593, 20594, 7, -8)
            return 0
        # Ring of Calamity
        elif GetTalkListEntryResult() == 43:
            assert t400507_x50(20603, 20604, 7, -8)
            return 0
        # Farron Ring
        elif GetTalkListEntryResult() == 44:
            assert t400507_x50(20613, 20614, 7, -8)
            return 0
        # Lloyd's Sword Ring
        elif GetTalkListEntryResult() == 45:
            assert t400507_x50(20663, 20664, 7, -8)
            return 0
        # Lloyd's Shield Ring
        elif GetTalkListEntryResult() == 46:
            assert t400507_x50(20673, 20674, 7, -8)
            return 0
        # Estus Ring
        elif GetTalkListEntryResult() == 47:
            assert t400507_x50(20703, 20704, 7, -8)
            return 0
        # Focusing Ring
        elif GetTalkListEntryResult() == 48:
            assert t400507_x50(20713, 20714, 7, -8)
            return 0
        # Horsehoof Ring
        elif GetTalkListEntryResult() == 49:
            assert t400507_x50(20723, 20724, 7, -8)
            return 0
        # Pontiff's Right Eye
        elif GetTalkListEntryResult() == 50:
            assert t400507_x50(20753, 20754, 7, -8)
            return 0
        # Pontiff's Left Eye
        elif GetTalkListEntryResult() == 51:
            assert t400507_x50(20793, 20794, 7, -8)
            return 0
        # Dragonscale Ring
        elif GetTalkListEntryResult() == 52:
            assert t400507_x50(20833, 20834, 7, -8)
            return 0
        # Chillbite Ring
        elif GetTalkListEntryResult() == 53:
            assert t400507_x50(21003, 21004, 7, -8)
            return 0
        # Spirit Amethyst
        elif GetTalkListEntryResult() == 54:
            assert t400507_x50(30013, 30014, 7, -8)
            return 0
        # Unholy Remains
        elif GetTalkListEntryResult() == 55:
            assert t400507_x50(30023, 30024, 7, -8)
            return 0
        # Symbol of the Penitent
        elif GetTalkListEntryResult() == 56:
            assert t400507_x50(30053, 30054, 7, -8)
            return 0
        # Tome of Sunlight
        elif GetTalkListEntryResult() == 57:
            assert t400507_x50(30083, 30084, 7, -8)
            return 0
        # Demonsbane Ring
        elif GetTalkListEntryResult() == 58:
            assert t400507_x50(30173, 30174, 7, -8)
            return 0
        # Crypt Ring
        elif GetTalkListEntryResult() == 59:
            assert t400507_x50(30183, 30184, 7, -8)
            return 0
        # Blight Ring
        elif GetTalkListEntryResult() == 60:
            assert t400507_x50(30193, 30194, 7, -8)
            return 0
        # Hallowed Ring
        elif GetTalkListEntryResult() == 61:
            assert t400507_x50(30203, 30204, 7, -8)
            return 0
        # Ring of Wisdom
        elif GetTalkListEntryResult() == 62:
            assert t400507_x50(30213, 30214, 7, -8)
            return 0
        # Ring of Retaliation
        elif GetTalkListEntryResult() == 63:
            assert t400507_x50(30333, 30334, 7, -8)
            return 0
        # Ring of Reprisal
        elif GetTalkListEntryResult() == 64:
            assert t400507_x50(30343, 30344, 7, -8)
            return 0
        # Ring of Spite
        elif GetTalkListEntryResult() == 65:
            assert t400507_x50(30353, 30354, 7, -8)
            return 0
        # Ring of Retribution
        elif GetTalkListEntryResult() == 66:
            assert t400507_x50(30363, 30364, 7, -8)
            return 0
        # Ring of Vengeance
        elif GetTalkListEntryResult() == 67:
            assert t400507_x50(30373, 30374, 7, -8)
            return 0
        # Mercenary Ring
        elif GetTalkListEntryResult() == 68:
            assert t400507_x50(30393, 30394, 7, -8)
            return 0
        # Heretic Ring
        elif GetTalkListEntryResult() == 69:
            assert t400507_x50(30403, 30404, 7, -8)
            return 0
        # Merchant Ring
        elif GetTalkListEntryResult() == 70:
            assert t400507_x50(30413, 30414, 7, -8)
            return 0
        # Physician Ring
        elif GetTalkListEntryResult() == 71:
            assert t400507_x50(30423, 30424, 7, -8)
            return 0
        # Jester Ring
        elif GetTalkListEntryResult() == 72:
            assert t400507_x50(30433, 30434, 7, -8)
            return 0
        # Londor Tincture
        elif GetTalkListEntryResult() == 73:
            assert t400507_x50(30453, 30454, 7, -8)
            return 0
        # Old Pygmy Brooch
        elif GetTalkListEntryResult() == 74:
            assert t400507_x50(30503, 30504, 7, -8)
            return 0
        # Bestial Band
        elif GetTalkListEntryResult() == 75:
            assert t400507_x50(30653, 30654, 7, -8)
            return 0
        # Band of Stone
        elif GetTalkListEntryResult() == 76:
            assert t400507_x50(30663, 30664, 7, -8)
            return 0
        # Band of Magic
        elif GetTalkListEntryResult() == 77:
            assert t400507_x50(30673, 30674, 7, -8)
            return 0
        # Band of Flame
        elif GetTalkListEntryResult() == 78:
            assert t400507_x50(30683, 30684, 7, -8)
            return 0
        # Band of Sparks
        elif GetTalkListEntryResult() == 79:
            assert t400507_x50(30693, 30694, 7, -8)
            return 0
        # Band of Darkness
        elif GetTalkListEntryResult() == 80:
            assert t400507_x50(30703, 30704, 7, -8)
            return 0
        # Elden Ring
        elif GetTalkListEntryResult() == 81:
            assert t400507_x50(30803, 30804, 7, -8)
            return 0
        # Ring of Punishment
        elif GetTalkListEntryResult() == 82:
            assert t400507_x50(30893, 30894, 7, -8)
            return 0
        # Relic of Power
        elif GetTalkListEntryResult() == 83:
            assert t400507_x50(30913, 30914, 7, -8)
            return 0
        # Relic of Insanity
        elif GetTalkListEntryResult() == 84:
            assert t400507_x50(30923, 30924, 7, -8)
            return 0
        # Tainted Chalice
        elif GetTalkListEntryResult() == 85:
            assert t400507_x50(30933, 30934, 7, -8)
            return 0
        # Accursed Sigil
        elif GetTalkListEntryResult() == 86:
            assert t400507_x50(30943, 30944, 7, -8)
            return 0
        # Frostflower Ring
        elif GetTalkListEntryResult() == 87:
...
def t400507_x45():
    ...
    while True:
        ...
        # Life Ring
        if GetTalkListEntryResult() == 1:
            assert t400507_x50(20004, 20005, 9, -10)
            return 0
        # Chloranthy Ring
        elif GetTalkListEntryResult() == 2:
            assert t400507_x50(20014, 20015, 9, -10)
            return 0
        # Havel's Ring
        elif GetTalkListEntryResult() == 3:
            assert t400507_x50(20024, 20025, 9, -10)
            return 0
        # Ring of Favor
        elif GetTalkListEntryResult() == 4:
            assert t400507_x50(20034, 20035, 9, -10)
            return 0
        # Ring of Steel Protection
        elif GetTalkListEntryResult() == 5:
            assert t400507_x50(20044, 20045, 9, -10)
            return 0
        # Flame Stoneplate Ring
        elif GetTalkListEntryResult() == 6:
            assert t400507_x50(20054, 20055, 9, -10)
            return 0
        # Thunder Stoneplate Ring
        elif GetTalkListEntryResult() == 7:
            assert t400507_x50(20064, 20065, 9, -10)
            return 0
        # Magic Stoneplate Ring
        elif GetTalkListEntryResult() == 8:
            assert t400507_x50(20074, 20075, 9, -10)
            return 0
        # Dark Stoneplate Ring
        elif GetTalkListEntryResult() == 9:
            assert t400507_x50(20084, 20085, 9, -10)
            return 0
        # Speckled Stoneplate Ring
        elif GetTalkListEntryResult() == 10:
            assert t400507_x50(20094, 20095, 9, -10)
            return 0
        # Bloodbite Ring
        elif GetTalkListEntryResult() == 11:
            assert t400507_x50(20104, 20105, 9, -10)
            return 0
        # Poisonbite Ring
        elif GetTalkListEntryResult() == 12:
            assert t400507_x50(20114, 20115, 9, -10)
            return 0
        # Cursebite Ring
        elif GetTalkListEntryResult() == 13:
            assert t400507_x50(20124, 20125, 9, -10)
            return 0
        # Fleshbite Ring
        elif GetTalkListEntryResult() == 14:
            assert t400507_x50(20134, 20135, 9, -10)
            return 0
        # Wood Grain Ring
        elif GetTalkListEntryResult() == 15:
            assert t400507_x50(20144, 20145, 9, -10)
            return 0
        # Scholar Ring
        elif GetTalkListEntryResult() == 16:
            assert t400507_x50(20154, 20155, 9, -10)
            return 0
        # Priestess Ring
        elif GetTalkListEntryResult() == 17:
            assert t400507_x50(20164, 20165, 9, -10)
            return 0
        # Red Tearstone Ring
        elif GetTalkListEntryResult() == 18:
            assert t400507_x50(20174, 20175, 9, -10)
            return 0
        # Blue Tearstone Ring
        elif GetTalkListEntryResult() == 19:
            assert t400507_x50(20184, 20185, 9, -10)
            return 0
        # Wolf Ring
        elif GetTalkListEntryResult() == 20:
            assert t400507_x50(20194, 20195, 9, -10)
            return 0
        # Lingering Dragoncrest Ring
        elif GetTalkListEntryResult() == 21:
            assert t400507_x50(20274, 20275, 9, -10)
            return 0
        # Sage Ring
        elif GetTalkListEntryResult() == 22:
            assert t400507_x50(20284, 20285, 9, -10)
            return 0
        # Dusk Crown Ring
        elif GetTalkListEntryResult() == 23:
            assert t400507_x50(20304, 20305, 9, -10)
            return 0
        # Darkmoon Ring
        elif GetTalkListEntryResult() == 24:
            assert t400507_x50(20334, 20335, 9, -10)
            return 0
        # Bellowing Dragoncrest Ring
        elif GetTalkListEntryResult() == 25:
            assert t400507_x50(20344, 20345, 9, -10)
            return 0
        # Witch's Ring
        elif GetTalkListEntryResult() == 26:
            assert t400507_x50(20354, 20355, 9, -10)
            return 0
        # Ring of the Sun's First Born
        elif GetTalkListEntryResult() == 27:
            assert t400507_x50(20364, 20365, 9, -10)
            return 0
        # Hawk Ring
        elif GetTalkListEntryResult() == 28:
            assert t400507_x50(20374, 20375, 9, -10)
            return 0
        # Covetous Gold Serpent Ring
        elif GetTalkListEntryResult() == 29:
            assert t400507_x50(20394, 20395, 9, -10)
            return 0
        # Covetous Silver Serpent Ring
        elif GetTalkListEntryResult() == 30:
            assert t400507_x50(20404, 20405, 9, -10)
            return 0
        # Sun Princess Ring
        elif GetTalkListEntryResult() == 31:
            assert t400507_x50(20414, 20415, 9, -10)
            return 0  
        # Skull Ring
        elif GetTalkListEntryResult() == 32:
            assert t400507_x50(20434, 20435, 9, -10)
            return 0
        # Knight's Ring
        elif GetTalkListEntryResult() == 33:
            assert t400507_x50(20464, 20465, 9, -10)
            return 0
        # Hunter's Ring
        elif GetTalkListEntryResult() == 34:
            assert t400507_x50(20474, 20475, 9, -10)
            return 0
        # Knight Slayer's Ring
        elif GetTalkListEntryResult() == 35:
            assert t400507_x50(20484, 20485, 9, -10)
            return 0
        # Magic Clutch Ring
        elif GetTalkListEntryResult() == 36:
            assert t400507_x50(20494, 20495, 9, -10)
            return 0
        # Lightning Clutch Ring
        elif GetTalkListEntryResult() == 37:
            assert t400507_x50(20504, 20505, 9, -10)
            return 0
        # Fire Clutch Ring
        elif GetTalkListEntryResult() == 38:
            assert t400507_x50(20514, 20515, 9, -10)
            return 0
        # Dark Clutch Ring
        elif GetTalkListEntryResult() == 39:
            assert t400507_x50(20524, 20525, 9, -10)
            return 0
        # Flynn's Ring
        elif GetTalkListEntryResult() == 40:
            assert t400507_x50(20544, 20545, 9, -10)
            return 0
        # Prisoner's Chain
        elif GetTalkListEntryResult() == 41:
            assert t400507_x50(20554, 20555, 9, -10)
            return 0
        # Ring of the Evil Eye
        elif GetTalkListEntryResult() == 42:
            assert t400507_x50(20594, 20595, 9, -10)
            return 0
        # Ring of Calamity
        elif GetTalkListEntryResult() == 43:
            assert t400507_x50(20604, 20605, 9, -10)
            return 0
        # Farron Ring
        elif GetTalkListEntryResult() == 44:
            assert t400507_x50(20614, 20615, 9, -10)
            return 0
        # Lloyd's Sword Ring
        elif GetTalkListEntryResult() == 45:
            assert t400507_x50(20664, 20665, 9, -10)
            return 0
        # Lloyd's Shield Ring
        elif GetTalkListEntryResult() == 46:
            assert t400507_x50(20674, 20675, 9, -10)
            return 0
        # Estus Ring
        elif GetTalkListEntryResult() == 47:
            assert t400507_x50(20704, 20705, 9, -10)
            return 0
        # Focusing Ring
        elif GetTalkListEntryResult() == 48:
            assert t400507_x50(20714, 20715, 9, -10)
            return 0
        # Horsehoof Ring
        elif GetTalkListEntryResult() == 49:
            assert t400507_x50(20724, 20725, 9, -10)
            return 0
        # Pontiff's Right Eye
        elif GetTalkListEntryResult() == 50:
            assert t400507_x50(20754, 20755, 9, -10)
            return 0
        # Pontiff's Left Eye
        elif GetTalkListEntryResult() == 51:
            assert t400507_x50(20794, 20795, 9, -10)
            return 0
        # Dragonscale Ring
        elif GetTalkListEntryResult() == 52:
            assert t400507_x50(20834, 20835, 9, -10)
            return 0
        # Chillbite Ring
        elif GetTalkListEntryResult() == 53:
            assert t400507_x50(21004, 21005, 9, -10)
            return 0
        # Spirit Amethyst
        elif GetTalkListEntryResult() == 54:
            assert t400507_x50(30014, 30015, 9, -10)
            return 0
        # Unholy Remains
        elif GetTalkListEntryResult() == 55:
            assert t400507_x50(30024, 30025, 9, -10)
            return 0
        # Symbol of the Penitent
        elif GetTalkListEntryResult() == 56:
            assert t400507_x50(30054, 30055, 9, -10)
            return 0
        # Tome of Sunlight
        elif GetTalkListEntryResult() == 57:
            assert t400507_x50(30084, 30085, 9, -10)
            return 0
        # Demonsbane Ring
        elif GetTalkListEntryResult() == 58:
            assert t400507_x50(30174, 30175, 9, -10)
            return 0
        # Crypt Ring
        elif GetTalkListEntryResult() == 59:
            assert t400507_x50(30184, 30185, 9, -10)
            return 0
        # Blight Ring
        elif GetTalkListEntryResult() == 60:
            assert t400507_x50(30194, 30195, 9, -10)
            return 0
        # Hallowed Ring
        elif GetTalkListEntryResult() == 61:
            assert t400507_x50(30204, 30205, 9, -10)
            return 0
        # Ring of Wisdom
        elif GetTalkListEntryResult() == 62:
            assert t400507_x50(30214, 30215, 9, -10)
            return 0
        # Ring of Retaliation
        elif GetTalkListEntryResult() == 63:
            assert t400507_x50(30334, 30335, 9, -10)
            return 0
        # Ring of Reprisal
        elif GetTalkListEntryResult() == 64:
            assert t400507_x50(30344, 30345, 9, -10)
            return 0
        # Ring of Spite
        elif GetTalkListEntryResult() == 65:
            assert t400507_x50(30354, 30355, 9, -10)
            return 0
        # Ring of Retribution
        elif GetTalkListEntryResult() == 66:
            assert t400507_x50(30364, 30365, 9, -10)
            return 0
        # Ring of Vengeance
        elif GetTalkListEntryResult() == 67:
            assert t400507_x50(30374, 30375, 9, -10)
            return 0
        # Mercenary Ring
        elif GetTalkListEntryResult() == 68:
            assert t400507_x50(30394, 30395, 9, -10)
            return 0
        # Heretic Ring
        elif GetTalkListEntryResult() == 69:
            assert t400507_x50(30404, 30405, 9, -10)
            return 0
        # Merchant Ring
        elif GetTalkListEntryResult() == 70:
            assert t400507_x50(30414, 30415, 9, -10)
            return 0
        # Physician Ring
        elif GetTalkListEntryResult() == 71:
            assert t400507_x50(30424, 30425, 9, -10)
            return 0
        # Jester Ring
        elif GetTalkListEntryResult() == 72:
            assert t400507_x50(30434, 30435, 9, -10)
            return 0
        # Londor Tincture
        elif GetTalkListEntryResult() == 73:
            assert t400507_x50(30454, 30455, 9, -10)
            return 0
        # Old Pygmy Brooch
        elif GetTalkListEntryResult() == 74:
            assert t400507_x50(30504, 30505, 9, -10)
            return 0
        # Bestial Band
        elif GetTalkListEntryResult() == 75:
            assert t400507_x50(30654, 30655, 9, -10)
            return 0
        # Band of Stone
        elif GetTalkListEntryResult() == 76:
            assert t400507_x50(30664, 30665, 9, -10)
            return 0
        # Band of Magic
        elif GetTalkListEntryResult() == 77:
            assert t400507_x50(30674, 30675, 9, -10)
            return 0
        # Band of Flame
        elif GetTalkListEntryResult() == 78:
            assert t400507_x50(30684, 30685, 9, -10)
            return 0
        # Band of Sparks
        elif GetTalkListEntryResult() == 79:
            assert t400507_x50(30694, 30695, 9, -10)
            return 0
        # Band of Darkness
        elif GetTalkListEntryResult() == 80:
            assert t400507_x50(30704, 30705, 9, -10)
            return 0
        # Elden Ring
        elif GetTalkListEntryResult() == 81:
            assert t400507_x50(30804, 30805, 9, -10)
            return 0
        # Ring of Punishment
        elif GetTalkListEntryResult() == 82:
            assert t400507_x50(30894, 30895, 9, -10)
            return 0
        # Relic of Power
        elif GetTalkListEntryResult() == 83:
            assert t400507_x50(30914, 30915, 9, -10)
            return 0
        # Relic of Insanity
        elif GetTalkListEntryResult() == 84:
            assert t400507_x50(30924, 30925, 9, -10)
            return 0
        # Tainted Chalice
        elif GetTalkListEntryResult() == 85:
            assert t400507_x50(30934, 30935, 9, -10)
            return 0
        # Accursed Sigil
        elif GetTalkListEntryResult() == 86:
            assert t400507_x50(30944, 30945, 9, -10)
            return 0
        # Frostflower Ring
        elif GetTalkListEntryResult() == 87:
...
#----------------------------------------------------------     
# Affix
def t400507_x50(old_item=_, new_item=_, cost=_, remove_cost=_):
    # Affix this ring? 
    call = t400507_x51(action2=99015010)
    
    if call.Get() == 0:
        if ComparePlayerInventoryNumber(3, 901, 3, cost, 0) == 1:
            # Insufficient Time-lost Essence
            assert t400507_x52(action1=99015012)
        else:
            ...
            # Ring affixed
            assert t400507_x52(action1=99015013)
    elif call.Get() == 1:
        pass
    return 0
    
def t400507_x51(action2=_):
    """ State 0,1 """
