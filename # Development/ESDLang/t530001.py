...
def t530001_1():
    ...
    """ State 2 """
    while True:
        call = t530001_x7() # Player Loop
        assert IsClientPlayer() == 1
        """ State 3 """
        call = t530001_x8() # Client Loop
...
def t530001_x2(text2=_, z1=_, flag2=0, mode2=1):
    """ State 0,5 """
    assert t530001_x1() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 2 """
    SetEventState(z1, 1)
    """ State 1 """
...
def t530001_x3(text1=_, flag1=0, mode1=1):
    """ State 0,4 """
    assert t530001_x1() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
# Trigger - Talk
def t530001_x13(text2=_):
    """ State 0,2,3 """
    if GetDistanceToPlayer() < 9999:
        """ State 4,7 """
        call = t530001_x3(text2, 0, 1)
        if call.Done():
            pass
