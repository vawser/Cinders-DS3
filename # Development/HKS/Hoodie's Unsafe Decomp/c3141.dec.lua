...
function Event20000_onUpdate()
    ...
    if TRUE == env(ESD_ENV_IsAnimEnd, 1) or TRUE == env(ESD_ENV_DS3IsMoveCancelPossible) then
        ...
        elseif TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 5405) then
            local random = env(ESD_ENV_GetRandomInt, 1, 100)
            if TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 11021) then
                Fire("W_Event20002")
                return 
            elseif TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 11022) then
                Fire("W_Event20003")
                return 
            elseif random > 95 then
                Fire("W_Event20000")
        ...
        elseif TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 5406) then
            local random = env(ESD_ENV_GetRandomInt, 1, 100)
            if TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 11031) then
                Fire("W_Event20002")
                return 
            elseif random > 95 then
                Fire("W_Event20000")
...
function Event20006_onUpdate()
    ...
    if TRUE == env(ESD_ENV_IsAnimEnd, 1) or TRUE == env(ESD_ENV_DS3IsMoveCancelPossible) then
        if TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 5405) then
            Fire("W_Event20002")
            return 
        else
            Fire("W_Idle")
...
function Event30000_onUpdate()
    ...
    if TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 11020) then
        if TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 5405) then
            local random = env(ESD_ENV_GetRandomInt, 1, 100)
            if TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 11021) then
                Fire("W_Event20002")
    ...
    if TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 11030) then
        if TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 5406) then
            local random = env(ESD_ENV_GetRandomInt, 1, 100)
            if TRUE == env(ESD_ENV_DS3GetSpecialEffectID, 11031) then
                Fire("W_Event20002")
                return 
