...
Enemy.New = function ()
    local f9265_local0 = {}
    SETFIELD_R1 0 0 -1
    f9265_local0.OrderAttackCancel = REG4294967295
    f9265_local0.OrderAttackCombo = REG4294967295
    f9265_local0.OrderStep = REG4294967295
    f9265_local0.OrderStepCancel = REG4294967295
    f9265_local0.ActionNumber = REG4294967289
    f9265_local0.MoveState = REG4294967295
    f9265_local0.DamageState = REG4294967295
    f9265_local0.DamageDirection = REG4294967295
    f9265_local0.DamageType = REG4294967295
    f9265_local0.IsThrowed = FALSE
    f9265_local0.IsFall = FALSE
    f9265_local0.IsAttack = FALSE
    f9265_local0.IsDamage = FALSE
    f9265_local0.Debug = REG4294967276
    local f9265_local1 = setmetatable
    local f9265_local2 = f9265_local0
    local f9265_local3 = {}
    f9265_local3.__index = Enemy
    f9265_local1(f9265_local2, f9265_local3)
    return f9265_local0
