...
Enemy.New = function ()
    local f1712_local0 = {}
    SETFIELD_R1 0 0 -1
    f1712_local0.OrderAttackCancel = REG4294967295
    f1712_local0.OrderAttackCombo = REG4294967295
    f1712_local0.OrderStep = REG4294967295
    f1712_local0.OrderStepCancel = REG4294967295
    f1712_local0.ActionNumber = REG4294967289
    f1712_local0.MoveState = REG4294967295
    f1712_local0.DamageState = REG4294967295
    f1712_local0.DamageDirection = REG4294967295
    f1712_local0.DamageType = REG4294967295
    f1712_local0.IsThrowed = FALSE
    f1712_local0.IsFall = FALSE
    f1712_local0.IsAttack = FALSE
    f1712_local0.IsDamage = FALSE
    f1712_local0.Debug = REG4294967276
    local f1712_local1 = setmetatable
    local f1712_local2 = f1712_local0
    local f1712_local3 = {}
    f1712_local3.__index = Enemy
    f1712_local1(f1712_local2, f1712_local3)
    return f1712_local0
