RegisterTableGoal(GOAL_NPC_KingSeekerB, "GOAL_NPC_KingSeekerB")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_KingSeekerB, true)
Goal.Initialize = function (arg0, arg1, arg2, arg3)
    return 
end

Goal.Activate = function (arg0, arg1, arg2)
    if arg1:GetNpcThinkParamID() == 25220 then
        arg1:SetStringIndexedNumber("NPC_PointFrontWall", 3502805)
        arg2:AddSubGoal(GOAL_NPC_WhiteGhost_Battle, 2)
    elseif arg1:GetNpcThinkParamID() == 25221 then
        arg1:SetStringIndexedNumber("NPC_PointFrontWall", 3302805)
        arg2:AddSubGoal(GOAL_NPC_WhiteGhost_Battle, 2)
    elseif arg1:GetNpcThinkParamID() == 25222 then
        arg1:SetStringIndexedNumber("NPC_PointFrontWall", 3012820)
        arg2:AddSubGoal(GOAL_NPC_WhiteGhost_Battle, 2)
    elseif arg1:GetNpcThinkParamID() == 25223 then
    ...
    local local6 = 1
    if 25240 <= arg1:GetNpcThinkParamID() then
        local6 = 0
    elseif arg1:GetNpcThinkParamID() == 25220 then
        local6 = 3
    elseif arg1:GetNpcThinkParamID() == 25221 then
        local6 = 3
    elseif arg1:GetNpcThinkParamID() == 25222 then
    ...
    elseif arg1:GetNpcThinkParamID() == 25223 then
        local6 = 4
    elseif arg1:GetNpcThinkParamID() == 25202 then
        local6 = 2
    elseif arg1:GetNpcThinkParamID() == 25201 then
        local6 = 2
    else
        local6 = 3
    end
    arg1:AddObserveSpecialEffectAttribute(TARGET_SELF, 103501009)
    if arg1:GetHpRate(TARGET_SELF) <= 0.6 and arg1:GetNumber(0) < local6 then
        if 7 <= local4 then
            local0[47] = 100
        else
            local0[1] = 20
    ...
    if not not arg1:HasSpecialEffectId(TARGET_SELF, 103591000) or arg1:HasSpecialEffectId(TARGET_SELF, 103560000) then
        local0[46] = 0
    end
    if not not arg1:HasSpecialEffectId(TARGET_SELF, 103591000) or arg1:HasSpecialEffectId(TARGET_SELF, 103560000) then
        local0[48] = 0
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act03)
    local1[4] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act04)
    local1[5] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act05)
    local1[19] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act19)
    local1[20] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act20)
    local1[21] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act21)
    local1[22] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act22)
    local1[23] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act23)
    local1[24] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act24)
    local1[25] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act25)
    local1[40] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act40)
    local1[41] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act41)
    local1[42] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act42)
    local1[43] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act43)
    local1[44] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act44)
    local1[45] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act45)
    local1[46] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act46)
    local1[47] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act47)
    local1[48] = REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_Act48)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, NPC_KingSeekerB_ActAfter_AdjustSpace), local2)
    return 
end

function NPC_KingSeekerB_Act19(arg0, arg1, arg2)
...
function NPC_KingSeekerB_Act01(arg0, arg1, arg2)
...
function NPC_KingSeekerB_Act02(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
...
function NPC_KingSeekerB_Act03(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetDist(TARGET_ENE_0)
    local local3 = 0.6
...
function NPC_KingSeekerB_Act04(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetDist(TARGET_ENE_0)
    local local3 = 3.5
...
function NPC_KingSeekerB_Act05(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetDist(TARGET_ENE_0)
    local local3 = 3
...
function NPC_KingSeekerB_Act20(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = 2.4
    local local3 = -1
...
function NPC_KingSeekerB_Act21(arg0, arg1, arg2)
...
function NPC_KingSeekerB_Act22(arg0, arg1, arg2)
...
function NPC_KingSeekerB_Act23(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function NPC_KingSeekerB_Act24(arg0, arg1, arg2)
...
function NPC_KingSeekerB_Act25(arg0, arg1, arg2)
...
function NPC_KingSeekerB_Act40(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
...
function NPC_KingSeekerB_Act41(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetSp(TARGET_SELF)
    local local2 = 20
    local local3 = 1.8
...
function NPC_KingSeekerB_Act42(arg0, arg1, arg2)
...
function NPC_KingSeekerB_Act47(arg0, arg1, arg2)
    if arg0:IsBothHandMode(TARGET_SELF) then
        arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, NPC_ATK_ButtonTriangle, TARGET_ENE_0, 999, 0, 0)
    end
    arg0:ChangeEquipMagic(1)
    local local0 = arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 1, NPC_ATK_L2, TARGET_ENE_0, 0, 0, 0)
...
function NPC_KingSeekerB_Act48(arg0, arg1, arg2)
    if arg0:IsBothHandMode(TARGET_SELF) then
        arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, NPC_ATK_ButtonTriangle, TARGET_ENE_0, 999, 0, 0)
    end
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    elseif arg1:IsInterupt(INTERUPT_FindAttack) then
        if local1 < 1.8 then
            if local2 <= 30 and 20 <= local0 then
                arg2:ClearSubGoal()
                NPC_KingSeekerB_Act24(arg1, arg2)
                return true
            end
        elseif local1 <= 3 and 20 <= local0 then
            if local2 <= 30 then
                arg2:ClearSubGoal()
                NPC_KingSeekerB_Act21(arg1, arg2, paramTbl)
                return true
            else
                arg2:ClearSubGoal()
                NPC_KingSeekerB_Act22(arg1, arg2, paramTbl)
                return true
            end
        end
    end
    if arg1:IsInterupt(INTERUPT_Shoot) and local2 <= 25 and 20 <= local0 then
        arg2:ClearSubGoal()
        NPC_KingSeekerB_Act23(arg1, arg2)
        return true
    elseif arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        if arg1:GetSpecialEffectActivateInterruptType(0) == 103501009 then
