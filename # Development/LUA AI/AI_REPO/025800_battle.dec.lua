RegisterTableGoal(GOAL_NPC_Kight_of_MiracleShop, "GOAL_NPC_Kight_of_MiracleShop")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_Kight_of_MiracleShop, true)
Goal.Initialize = function (arg0, arg1, arg2, arg3)
    return 
end

Goal.Activate = function (arg0, arg1, arg2)
    if arg1:GetNpcThinkParamID() == 25820 then
        arg1:SetStringIndexedNumber("NPC_PointFrontWall", 3302855)
        arg2:AddSubGoal(GOAL_NPC_WhiteGhost_Battle, 2)
    elseif arg1:GetNpcThinkParamID() == 25821 then
        arg1:SetStringIndexedNumber("NPC_PointFrontWall", 3012820)
        arg2:AddSubGoal(GOAL_NPC_WhiteGhost_Battle, 2)
    end
    ...
    if arg1:GetHpRate(TARGET_SELF) <= 0.5 and not arg1:HasSpecialEffectId(TARGET_SELF, 5110) and arg1:GetNpcThinkParamID() ~= 22340 then
        if 5 <= local4 then
            local0[42] = 100
        else
            local0[1] = 1
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act03)
    local1[4] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act04)
    local1[5] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act05)
    local1[19] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act19)
    local1[20] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act20)
    local1[21] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act21)
    local1[22] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act22)
    local1[23] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act23)
    local1[24] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act24)
    local1[25] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act25)
    local1[40] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act40)
    local1[41] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act41)
    local1[42] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act42)
    local1[43] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act43)
    local1[44] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act44)
    local1[45] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act45)
    local1[46] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act46)
    local1[47] = REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_Act47)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, NPC_Kight_of_MiracleShop_ActAfter_AdjustSpace), local2)
    return 
end

function NPC_Kight_of_MiracleShop_Act19(arg0, arg1, arg2)
    ...
    if arg0:IsBothHandMode(TARGET_SELF) then
        local3 = DBlackHoundsGreatHammer_BOTH_R1_DIST_MAX
        local4 = 0
    end
...
function NPC_Kight_of_MiracleShop_Act01(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
...
function NPC_Kight_of_MiracleShop_Act02(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetDist(TARGET_ENE_0)
...
function NPC_Kight_of_MiracleShop_Act03(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetDist(TARGET_ENE_0)
    local local3 = 1.4
...
function NPC_Kight_of_MiracleShop_Act04(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetDist(TARGET_ENE_0)
    local local3 = 4.8
...
function NPC_Kight_of_MiracleShop_Act05(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetDist(TARGET_ENE_0)
    local local3 = 2.4
    ...
    local5:TimingSetTimer(0, arg0:GetRandam_Int(10, 20), UPDATE_SUCCESS)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function NPC_Kight_of_MiracleShop_Act20(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = 3
    local local3 = 4
...
function NPC_Kight_of_MiracleShop_Act21(arg0, arg1, arg2)
...
function NPC_Kight_of_MiracleShop_Act22(arg0, arg1, arg2)
...
function NPC_Kight_of_MiracleShop_Act23(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function NPC_Kight_of_MiracleShop_Act24(arg0, arg1, arg2)
...
function NPC_Kight_of_MiracleShop_Act25(arg0, arg1, arg2)
...
function NPC_Kight_of_MiracleShop_Act40(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    ...
    local local4 = 0
    if arg0:IsBothHandMode(TARGET_SELF) then
        if local2 <= local1 and local0 <= 30 then
...
function NPC_Kight_of_MiracleShop_Act41(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetSp(TARGET_SELF)
    local local2 = 40
    local local3 = 1.8
...
function NPC_Kight_of_MiracleShop_Act42(arg0, arg1, arg2)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    local local3 = arg1:GetRandam_Int(1, 100)
    if arg1:IsInterupt(INTERUPT_GuardBreak) and local1 < 2.5 then
        arg2:ClearSubGoal()
    ...
    local local4 = 2.5
    local local5 = 4
    if local1 < local4 and 1 <= local0 and local2 <= 30 and arg1:IsBothHandMode(TARGET_SELF) and arg1:IsInterupt(INTERUPT_ParryTiming) and arg1:IsFinishTimer(0) then
        if SpaceCheck(arg1, arg2, 180, arg1:GetStringIndexedNumber("Dist_Rolling")) == true and SpaceCheck(arg1, arg2, 90, arg1:GetStringIndexedNumber("Dist_Rolling")) == true and SpaceCheck(arg1, arg2, 270, arg1:GetStringIndexedNumber("Dist_Rolling")) == true then
            if local3 <= 30 and SpaceCheck(arg1, arg2, 180, arg1:GetStringIndexedNumber("Dist_Rolling")) == true then
                arg2:ClearSubGoal()
                NPC_Kight_of_MiracleShop_Act24(arg1, arg2)
            elseif local3 <= 70 then
                arg2:ClearSubGoal()
                NPC_Kight_of_MiracleShop_Act23(arg1, arg2)
            else
                arg2:ClearSubGoal()
                NPC_Kight_of_MiracleShop_Act22(arg1, arg2)
            end
        ...
        arg1:SetTimer(0, 2)
        return true
    elseif local1 < local5 and local2 <= 40 and 26 <= local0 and arg1:IsBothHandMode(TARGET_SELF) and 0.3 <= hprate and arg1:IsInterupt(INTERUPT_FindAttack) and arg1:IsFinishTimer(0) then
        arg2:ClearSubGoal()
        arg2:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, NPC_ATK_L2, TARGET_ENE_0, 999, 0, 0)
        arg1:SetTimer(0, 2)
        return true
    elseif local1 < local5 and local4 < local1 and local2 <= 60 and arg1:IsInterupt(INTERUPT_FindAttack) and SpaceCheck(arg1, arg2, -180, arg1:GetStringIndexedNumber("Dist_BackStep")) == true and arg1:IsFinishTimer(0) then
        if 12 <= local0 then
            arg2:ClearSubGoal()
    ...
    if arg1:IsInterupt(INTERUPT_Shoot) then
        if arg1:IsBothHandMode(TARGET_SELF) then
            if local2 <= 33 then
                arg2:ClearSubGoal()
                arg2:AddSubGoal(GOAL_COMMON_SidewayMove, 1, TARGET_ENE_0, arg1:GetRandam_Int(0, 1), arg1:GetRandam_Int(75, 90), true, true, 0)
                return true
            end
        elseif local2 <= 33 then
            arg2:ClearSubGoal()
