RegisterTableGoal(GOAL_NPC_Forest_Keeper2, "GOAL_NPC_Forest_Keeper2")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_Forest_Keeper2, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    arg1:AddObserveSpecialEffectAttribute(TARGET_SELF, 103500009)
    if arg1:GetHpRate(TARGET_SELF) <= 0.5 and arg1:GetNumber(0) < 2 then
        if 5 <= local4 then
            local0[10] = 100
        else
            local0[1] = 1
    ...
    if arg1:HasSpecialEffectId(TARGET_SELF, 1080601) == true then
        local0[3] = 0
    end
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act03)
    local1[10] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act10)
    local1[15] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act15)
    local1[19] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act19)
    local1[20] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act20)
    local1[21] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act21)
    local1[22] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act22)
    local1[23] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act23)
    local1[24] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act24)
    local1[25] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act25)
    local1[26] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act26)
    local1[40] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act40)
    local1[41] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act41)
    local1[42] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act42)
    local1[43] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act43)
    local1[44] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act44)
    local1[45] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act45)
    local1[46] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act46)
    local1[47] = REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_Act47)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, NPC_Forest_Keeper2_ActAfter_AdjustSpace), local2)
    return 
end

function NPC_Forest_Keeper2_Act01(arg0, arg1, arg2)
    ...
    if local2 < local1 then
        NPC_Approach_Act_Flex(arg0, arg1, local2, local2 + 1, local2 + 1, 0, local4, 1.8, 2)
    end
    if arg0:GetRandam_Int(1, 100) <= 50 and 50 < local5 and local2 <= local1 and not arg0:IsBothHandMode(TARGET_SELF) then
...
function NPC_Forest_Keeper2_Act02(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    ...
    if local3 < local2 then
        NPC_Approach_Act_Flex(arg0, arg1, local3, local3 + 2, local3 + 2, 0, local5, 1.8, 2)
    end
    if local1 <= 50 and 50 < local6 and DistToR1 <= local2 and not arg0:IsBothHandMode(TARGET_SELF) then
        if arg0:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_L, 180) then
            arg1:AddSubGoal(GOAL_COMMON_SidewayMove, 0.3, TARGET_ENE_0, 0, arg0:GetRandam_Int(75, 90), true, true, NPC_ATK_L1Hold)
        else
            arg1:AddSubGoal(GOAL_COMMON_SidewayMove, 0.3, TARGET_ENE_0, 1, arg0:GetRandam_Int(75, 90), true, true, NPC_ATK_L1Hold)
    ...
    if 35 <= local6 and 60 < local0 then
        if local1 <= 50 then
...
function NPC_Forest_Keeper2_Act03(arg0, arg1, arg2)
    local local0 = 2.7
    local local1 = 4.4
...
function NPC_Forest_Keeper2_Act10(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetDist(TARGET_ENE_0)
...
function NPC_Forest_Keeper2_Act15(arg0, arg1, arg2)
...
function NPC_Forest_Keeper2_Act19(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetDist(TARGET_ENE_0)
    local local3 = 1.6
...
function NPC_Forest_Keeper2_Act20(arg0, arg1, arg2)
...
function NPC_Forest_Keeper2_Act21(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
...
function NPC_Forest_Keeper2_Act22(arg0, arg1, arg2)
...
function NPC_Forest_Keeper2_Act23(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function NPC_Forest_Keeper2_Act24(arg0, arg1, arg2)
...
function NPC_Forest_Keeper2_Act25(arg0, arg1, arg2)
...
function NPC_Forest_Keeper2_Act40(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetDist(TARGET_ENE_0)
    ...
    local local5 = 0
    if arg0:IsBothHandMode(TARGET_SELF) then
        if local3 <= local2 and local0 <= 10 then
    ...
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, arg0:GetRandam_Float(1, 5.5), TARGET_ENE_0, local6, arg0:GetRandam_Int(75, 90), false, true, local5)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function NPC_Forest_Keeper2_Act41(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetDist(TARGET_ENE_0)
    local local2 = arg0:GetSp(TARGET_SELF)
    local local3 = 20
    ...
    elseif local3 <= local2 and local0 <= 80 then
        local5 = NPC_ATK_L1Hold
    end
...
function NPC_Forest_Keeper2_Act42(arg0, arg1, arg2)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    if GuardBreak_Act(arg1, arg2, 3.5, 100) then
        ...
        return true
    elseif arg1:IsInterupt(INTERUPT_ParryTiming) and arg1:GetDist(TARGET_ENE_0) < 2.5 and arg1:GetRandam_Int(1, 100) <= 5 and 16 <= arg1:GetSp(TARGET_SELF) and not arg1:IsBothHandMode(TARGET_SELF) and arg1:GetEquipWeaponIndex(ARM_L) == WEP_Primary then
        arg2:ClearSubGoal()
    ...
    elseif arg1:IsInterupt(INTERUPT_SuccessParry) then
        arg2:ClearSubGoal()
        local local1 = arg2:AddSubGoal(GOAL_COMMON_ApproachTarget, 1, TARGET_ENE_0, -1, TARGET_SELF, false, 0)
        local1:SetLifeEndSuccess(true)
        arg2:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, NPC_ATK_R1, TARGET_ENE_0, 999, 0, -1)
        return true
    elseif arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        if arg1:GetSpecialEffectActivateInterruptType(0) == 103500009 then
