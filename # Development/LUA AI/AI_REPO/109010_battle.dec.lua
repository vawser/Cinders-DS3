RegisterTableGoal(GOAL_MoujaSoldier_Gunda_109010_Battle, "GOAL_MoujaSoldier_Gunda_109010_Battle")
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, MoujaSoldierGunda109010_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, MoujaSoldierGunda109010_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, MoujaSoldierGunda109010_Act03)
    local1[4] = REGIST_FUNC(arg1, arg2, MoujaSoldierGunda109010_Act04)
    local1[5] = REGIST_FUNC(arg1, arg2, MoujaSoldierGunda109010_Act05)
    local1[10] = REGIST_FUNC(arg1, arg2, MoujaSoldierGunda109010_Act10)
    local1[11] = REGIST_FUNC(arg1, arg2, MoujaSoldierGunda109010_Act11)
    local1[20] = REGIST_FUNC(arg1, arg2, MoujaSoldierGunda109010_Act20)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, MoujaSoldierGunda109010_ActAfter_AdjustSpace), local2)
    return 
end

function MoujaSoldierGunda109010_Act01(arg0, arg1, arg2)
    local local0 = 3000
    local local1 = 3003
    local local2 = 3004
...
function MoujaSoldierGunda109010_Act02(arg0, arg1, arg2)
    local local0 = 3001
    local local1 = 3005
...
function MoujaSoldierGunda109010_Act03(arg0, arg1, arg2)
    local local0 = 3002
...
function MoujaSoldierGunda109010_Act04(arg0, arg1, arg2)
    local local0 = 3006
    local local1 = 3005
    local local2 = 5.5 - arg0:GetMapHitRadius(TARGET_SELF) + 3.5
    local local3 = 6 - arg0:GetMapHitRadius(TARGET_SELF) + 3
...
function MoujaSoldierGunda109010_Act05(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3007, TARGET_ENE_0, 999, 0, 360, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function MoujaSoldierGunda109010_Act10(arg0, arg1, arg2)
    local local0 = 10
...
function MoujaSoldierGunda109010_Act11(arg0, arg1, arg2)
...
function MoujaSoldierGunda109010_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Turn, 2, TARGET_ENE_0, 30, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function MoujaSoldierGunda109010_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_MoujaSoldier_Gunda_109010_AfterAttackAct, 10)
    return 
end
...
RegisterTableGoal(GOAL_MoujaSoldier_Gunda_109010_AfterAttackAct, "GOAL_MoujaSoldier_Gunda_109010_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_MoujaSoldier_Gunda_109010_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)
