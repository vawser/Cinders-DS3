local local0 = false
RegisterTableGoal(GOAL_DarkKnight_Avatar_111050_Battle, "DarkKnight_Avatar_111050")
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    if UPVAL0 == true then
        arg1:SetStringIndexedNumber("ActRate05", arg1:GetStringIndexedNumber("ActRate05") * 10)
        arg1:SetStringIndexedNumber("ActRate06", arg1:GetStringIndexedNumber("ActRate06") * 10)
        arg1:SetStringIndexedNumber("ActRate12", 0)
        local5 = false
        SETUPVAL 8 0 0
    end
    ...
    local5 = nil
    if 16 < local0 then
        DarkKnight_Avatar_111050_Go_Home(arg0, arg1, arg2)
        print("ここ？")
    else
    ...
    if local5 ~= nil then
        ...
        print("ダークナイト「関数が選ばれてないよ（func == nil ）」")
...
function DarkKnight_Avatar_111050_Go_Home(arg0, arg1, arg2)
    arg2:AddSubGoal(GOAL_COMMON_ApproachTarget, 5, TARGET_ENEMY_AVATOR_HOME, 3, TARGET_SELF, false, -1)
    return 0
end

function DarkKnight_Avatar_111050_Attack_Home(arg0, arg1, arg2)
    arg2:AddSubGoal(GOAL_COMMON_ApproachTarget, 5, TARGET_ENEMY_AVATOR_HOME, 3, TARGET_SELF, false, -1)
    arg2:AddSubGoal(GOAL_COMMON_Attack, 5, 3000, TARGET_ENEMY_AVATOR_HOME, 9999)
    return 0
end
...
Goal.Act11 = function (arg0, arg1, arg2, arg3)
    arg2:AddSubGoal(GOAL_DarkKnight_Avatar_111050_FrontStep, 10)
    return -1
end

Goal["ActBase12"] = 5001
Goal.Act12 = function (arg0, arg1, arg2, arg3)
    arg2:AddSubGoal(GOAL_DarkKnight_Avatar_111050_SideWalk, 10)
    return -1
end
...
RegisterTableGoal(GOAL_DarkKnight_Avatar_111050_SideWalk, "DarkKnight_Avatar_111050_SideWalk")
Goal.Activate = function (arg0, arg1, arg2)
...
Goal.Interrupt_FindAttack = function (arg0, arg1, arg2)
    ...
    if arg1:GetDist(TARGET_ENE_0) <= 4 and arg1:GetRandam_Int(1, 100) <= 80 then
        ...
        local4("DarkKnight_Avatar_111050_Battle:Attack Fined Step")
...
RegisterTableGoal(GOAL_DarkKnight_Avatar_111050_FrontStep, "DarkKnight_Avatar_111050_FrontStep")
