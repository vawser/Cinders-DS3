RegisterTableGoal(GOAL_PriestSoldier_115000_Battle, "PriestSoldier_115000_Battle")
REGISTER_GOAL_NO_UPDATE(GOAL_PriestSoldier_115000_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, PriestSoldier_115000_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, PriestSoldier_115000_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, PriestSoldier_115000_Act03)
    local1[4] = REGIST_FUNC(arg1, arg2, PriestSoldier_115000_Act04)
    local1[10] = REGIST_FUNC(arg1, arg2, PriestSoldier_115000_Act10)
    local1[11] = REGIST_FUNC(arg1, arg2, PriestSoldier_115000_Act11)
    local1[20] = REGIST_FUNC(arg1, arg2, PriestSoldier_115000_Act20)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, PriestSoldier_115000_ActAfter_AdjustSpace), local2)
    return 
end

function PriestSoldier_115000_Act01(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 2.9 - arg0:GetMapHitRadius(TARGET_SELF), 2.9 - arg0:GetMapHitRadius(TARGET_SELF) + 0.9, 2.9 - arg0:GetMapHitRadius(TARGET_SELF) + 4, 0, 50, 5, 0)
    local local0 = 3000
...
function PriestSoldier_115000_Act02(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 2.5 - arg0:GetMapHitRadius(TARGET_SELF), 2.5 - arg0:GetMapHitRadius(TARGET_SELF) + 0.9, 2.5 - arg0:GetMapHitRadius(TARGET_SELF) + 4, 0, 50, 5, 0)
    local local0 = 3002
    local local1 = 2 - arg0:GetMapHitRadius(TARGET_SELF)
    local local2 = 0
    local local3 = 20
...
function PriestSoldier_115000_Act03(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 2.5 - arg0:GetMapHitRadius(TARGET_SELF), 2.5 - arg0:GetMapHitRadius(TARGET_SELF) + 0.9, 2.5 - arg0:GetMapHitRadius(TARGET_SELF) + 4, 0, 50, 5, 0)
...
function PriestSoldier_115000_Act04(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 2 - arg0:GetMapHitRadius(TARGET_SELF), 2 - arg0:GetMapHitRadius(TARGET_SELF) + 0.9, 2 - arg0:GetMapHitRadius(TARGET_SELF) + 4, 0, 80, 4, 0)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3006, TARGET_ENE_0, 2 - arg0:GetMapHitRadius(TARGET_SELF), 0, 20, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function PriestSoldier_115000_Act10(arg0, arg1, arg2)
    local local0 = 10
...
function PriestSoldier_115000_Act11(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, 4, TARGET_ENE_0, arg0:GetRandam_Int(0, 1), arg0:GetRandam_Int(30, 45), true, true, 9910)
    return 
end

function PriestSoldier_115000_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Turn, 2, TARGET_ENE_0, 0, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function PriestSoldier_115000_ActAfter_AdjustSpace(arg0, arg1, arg2)
...
RegisterTableGoal(GOAL_PriestSoldier_115000_AfterAttackAct, "PriestSoldier_115000_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_PriestSoldier_115000_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)
