RegisterTableGoal(GOAL_TikarouSyuuzin_207000_Battle, "GOAL_TikarouSyuuzin_207000_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_TikarouSyuuzin_207000_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act03)
    local1[4] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act04)
    local1[5] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act05)
    local1[6] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act06)
    local1[7] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act07)
    local1[20] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act20)
    local1[21] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act21)
    local1[22] = REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_Act22)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, TikarouSyuuzin207000_ActAfter_AdjustSpace), local2)
    return 
end

function TikarouSyuuzin207000_Act01(arg0, arg1, arg2)
...
function TikarouSyuuzin207000_Act02(arg0, arg1, arg2)
    if 2.5 <= arg0:GetDist(TARGET_ENE_0) then
...
function TikarouSyuuzin207000_Act03(arg0, arg1, arg2)
    if 2.5 <= arg0:GetDist(TARGET_ENE_0) then
...
function TikarouSyuuzin207000_Act04(arg0, arg1, arg2)
    if 2.5 <= arg0:GetDist(TARGET_ENE_0) then
...
function TikarouSyuuzin207000_Act05(arg0, arg1, arg2)
    if 2.5 <= arg0:GetDist(TARGET_ENE_0) then
...
function TikarouSyuuzin207000_Act06(arg0, arg1, arg2)
    if 2.5 <= arg0:GetDist(TARGET_ENE_0) then
...
function TikarouSyuuzin207000_Act07(arg0, arg1, arg2)
    if 2.5 <= arg0:GetDist(TARGET_ENE_0) then
...
function TikarouSyuuzin207000_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Turn, 2, TARGET_ENE_0, 90)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function TikarouSyuuzin207000_Act21(arg0, arg1, arg2)
...
function TikarouSyuuzin207000_Act22(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_LeaveTarget, 1.8, TARGET_ENE_0, 4, TARGET_ENE_0, true, 0)
    return 
end

function TikarouSyuuzin207000_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_TikarouSyuuzin_207000_AfterAttackAct, 10)
    return 
end
...
RegisterTableGoal(GOAL_TikarouSyuuzin_207000_AfterAttackAct, "GOAL_TikarouSyuuzin_207000_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_TikarouSyuuzin_207000_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)
    local local0 = arg1:GetRandam_Int(1, 100)
    if arg1:GetDist(TARGET_ENE_0) <= 3 then
        TikarouSyuuzin207000_Act22(arg1, arg2, paramTbl)
    else
        TikarouSyuuzin207000_Act21(arg1, arg2, paramTbl)
    end
    return 
end
