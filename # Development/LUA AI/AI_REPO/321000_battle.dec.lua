...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, PoisonAngleInsect321000_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, PoisonAngleInsect321000_Act02)
    local1[10] = REGIST_FUNC(arg1, arg2, PoisonAngleInsect321000_Act10)
    local1[11] = REGIST_FUNC(arg1, arg2, PoisonAngleInsect321000_Act11)
    local1[20] = REGIST_FUNC(arg1, arg2, PoisonAngleInsect321000_Act20)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, PoisonAngleInsect321000_ActAfter_AdjustSpace), local2)
    return 
end

function PoisonAngleInsect321000_Act01(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 2 - arg0:GetMapHitRadius(TARGET_SELF), 999, 999, 0, 0, 10, 0)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3000, TARGET_ENE_0, 2 - arg0:GetMapHitRadius(TARGET_SELF), 0, 0, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function PoisonAngleInsect321000_Act02(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 2 - arg0:GetMapHitRadius(TARGET_SELF), 999, 999, 0, 0, 10, 0)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3001, TARGET_ENE_0, 2 - arg0:GetMapHitRadius(TARGET_SELF), 0, 0, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function PoisonAngleInsect321000_Act10(arg0, arg1, arg2)
    local local0 = 10
...
function PoisonAngleInsect321000_Act11(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, 4, TARGET_ENE_0, arg0:GetRandam_Int(0, 1), arg0:GetRandam_Int(30, 45), true, true, -1)
    return 
end

function PoisonAngleInsect321000_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Turn, 2, TARGET_ENE_0, arg0:GetRandam_Int(15, 20))
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function PoisonAngleInsect321000_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_PoisonAngleInsect_321000_AfterAttackAct, 10)
    return 
end
