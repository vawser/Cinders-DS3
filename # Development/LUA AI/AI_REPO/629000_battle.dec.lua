RegisterTableGoal(GOAL_CapitalDeadWarrior_Pastor_629000_Battle, "CapitalDeadWarrior_Pastor_629000_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_CapitalDeadWarrior_Pastor_629000_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act03)
    local1[4] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act04)
    local1[5] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act05)
    local1[6] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act06)
    local1[7] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act07)
    local1[8] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act08)
    local1[10] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act10)
    local1[20] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act20)
    local1[25] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act25)
    local1[26] = REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_Act26)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, CapitalDeadWarrior_Pastor_629000_Battle_ActAfter_AdjustSpace), local2)
    return 
end

function CapitalDeadWarrior_Pastor_629000_Battle_Act01(arg0, arg1, arg2)
    local local0 = 2.14
    local local1 = 2.14 + 0
    local local2 = 2.14 + 0
    local local3 = 100
    ...
    local local5 = 2
    local local6 = 5
    CapitalDeadWarrior_Pastor_629000_Approach_Act(arg0, arg1, 2.14)
...
function CapitalDeadWarrior_Pastor_629000_Battle_Act02(arg0, arg1, arg2)
    local local0 = 2
    local local1 = 2 + 0
    local local2 = 2 + 0
    local local3 = 100
    ...
    local local5 = 2
    local local6 = 5
    CapitalDeadWarrior_Pastor_629000_Approach_Act(arg0, arg1, 2)
    local local7 = arg0:GetRandam_Int(1, 100)
...
function CapitalDeadWarrior_Pastor_629000_Battle_Act03(arg0, arg1, arg2)
    local local0 = 2
    local local1 = 2 + 0
    local local2 = 2 + 0
    local local3 = 100
...
function CapitalDeadWarrior_Pastor_629000_Battle_Act04(arg0, arg1, arg2)
    local local0 = 2.3
    local local1 = 2.3 + 0
    local local2 = 2.3 + 0
    local local3 = 100
...
function CapitalDeadWarrior_Pastor_629000_Battle_Act05(arg0, arg1, arg2)
    local local0 = 999
    local local1 = 999 + 3
    local local2 = 999 + 3
    local local3 = 100
...
function CapitalDeadWarrior_Pastor_629000_Battle_Act07(arg0, arg1, arg2)
    local local0 = 20
    local local1 = 20 + 3
    local local2 = 20 + 3
    local local3 = 100
...
function CapitalDeadWarrior_Pastor_629000_Battle_Act08(arg0, arg1, arg2)
    local local0 = 3012
    local local1 = 999
...
function CapitalDeadWarrior_Pastor_629000_Battle_Act10(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Wait, 0.5, TARGET_NONE, 0, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function CapitalDeadWarrior_Pastor_629000_Battle_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Turn, 2, TARGET_ENE_0, 30)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function CapitalDeadWarrior_Pastor_629000_Battle_Act25(arg0, arg1, arg2)
...
function CapitalDeadWarrior_Pastor_629000_Battle_Act26(arg0, arg1, arg2)
...
function CapitalDeadWarrior_Pastor_629000_Battle_Act27(arg0, arg1, arg2)
...
function CapitalDeadWarrior_Pastor_629000_Battle_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_CapitalDeadWarrior_Pastor_629000_AfterAttackAct, 10)
    return 
end
...
RegisterTableGoal(GOAL_CapitalDeadWarrior_Pastor_629000_AfterAttackAct, "CapitalDeadWarrior_Pastor_629000_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_CapitalDeadWarrior_Pastor_629000_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)
    ...
    if local2 ~= 1 then
        if local2 == 2 then
            if arg1:GetRandam_Int(1, 100) <= 50 then
                CapitalDeadWarrior_Pastor_629000_Battle_Act25(arg1, arg2, paramTbl)
            else
                CapitalDeadWarrior_Pastor_629000_Battle_Act26(arg1, arg2, paramTbl)
            end
        else
            CapitalDeadWarrior_Pastor_629000_Battle_Act27(arg1, arg2, paramTbl)
        end
    end
    return 
end
...
function CapitalDeadWarrior_Pastor_629000_Approach_Act(arg0, arg1, arg2)
