RegisterTableGoal(GOAL_BlueMan_DirectSword_battle, "BlueMan_DirectSword_battle")
REGISTER_GOAL_NO_UPDATE(GOAL_BlueMan_DirectSword_battle, true)
...
function BlueMan_DirectSword_Act01(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 6.5 - arg0:GetMapHitRadius(TARGET_SELF), 6.5 - arg0:GetMapHitRadius(TARGET_SELF) + 1.5, 6.5 - arg0:GetMapHitRadius(TARGET_SELF) + 5, 60, 0, 5, 5)
    local local0 = 3000
    ...
    if arg0:GetRandam_Int(1, 100) <= 30 then
        ...
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, 5.5 - arg0:GetMapHitRadius(TARGET_SELF) + 1, local2, local3, 0, 0)
...
function BlueMan_DirectSword_Act02(arg0, arg1, arg2)
    ...
    elseif local6 <= 60 then
        ...
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, local2, local4, local5, 0, 0)
        arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local1, TARGET_ENE_0, 4.5 - arg0:GetMapHitRadius(TARGET_SELF) + 1, local4, local5, 0, 0)
...
function BlueMan_DirectSword_Act03(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 5.5 - arg0:GetMapHitRadius(TARGET_SELF), 5.5 - arg0:GetMapHitRadius(TARGET_SELF) + 1.5, 5.5 - arg0:GetMapHitRadius(TARGET_SELF) + 5, 60, 0, 5, 5)
...
function BlueMan_DirectSword_Act04(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 2 - arg0:GetMapHitRadius(TARGET_SELF), 2 - arg0:GetMapHitRadius(TARGET_SELF) + 1.5, 2 - arg0:GetMapHitRadius(TARGET_SELF) + 5, 60, 0, 5, 5)
    local local0 = arg0:GetRandam_Int(1, 100)
...
function BlueMan_DirectSword_Act05(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 10.5 - arg0:GetMapHitRadius(TARGET_SELF), 10.5 - arg0:GetMapHitRadius(TARGET_SELF) + 1.5, 10.5 - arg0:GetMapHitRadius(TARGET_SELF) + 5, 60, 0, 5, 5)
    local local0 = arg0:GetRandam_Int(1, 100)
...
RegisterTableGoal(GOAL_BlueMan_DirectSword_AfterAttackAct, "BlueMan_DirectSword_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_BlueMan_DirectSword_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)
