...
function ComboAttack180_Activate(arg0, arg1)
    arg1:AddSubGoal(GOAL_COMMON_CommonAttack, arg1:GetLife(), arg1:GetParam(0), arg1:GetParam(1), arg1:GetParam(2), 180, 1.5, 20, true, true, false, false, arg1:GetParam(3), arg1:GetParam(4))
    return 
end
