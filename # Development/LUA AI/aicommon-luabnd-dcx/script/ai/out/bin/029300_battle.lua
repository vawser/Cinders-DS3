...
Goal.Activate = function (self, ai, goal)
    ...
    ----------------------------------
    -- Attacks
    actFuncList[1] = REGIST_FUNC(ai, goal, NPC_Creighton_Act01) -- R1 Combo
    actFuncList[2] = REGIST_FUNC(ai, goal, NPC_Creighton_Act02) -- R1/L1 Combo
    actFuncList[3] = REGIST_FUNC(ai, goal, NPC_Creighton_Act03) -- R2 Combo
    actFuncList[4] = REGIST_FUNC(ai, goal, NPC_Creighton_Act04) -- Kick
    actFuncList[5] = REGIST_FUNC(ai, goal, NPC_Creighton_Act05) -- Jump Attack
    actFuncList[6] = REGIST_FUNC(ai, goal, NPC_Creighton_Act06) -- Running R1/R2
    actFuncList[7] = REGIST_FUNC(ai, goal, NPC_Creighton_Act07) -- Right WA: HOLD AND USE
    actFuncList[8] = REGIST_FUNC(ai, goal, NPC_Creighton_Act08) -- Right WA: PRESS
    actFuncList[9] = REGIST_FUNC(ai, goal, NPC_Creighton_Act09) -- Left WA: PRESS
    
    -- Movement
    actFuncList[20] = REGIST_FUNC(ai, goal, NPC_Creighton_Act20) -- Approach
    actFuncList[21] = REGIST_FUNC(ai, goal, NPC_Creighton_Act21) -- Strafe
    actFuncList[22] = REGIST_FUNC(ai, goal, NPC_Creighton_Act22) -- Move Backwards
    actFuncList[23] = REGIST_FUNC(ai, goal, NPC_Creighton_Act23) -- Backstep
    actFuncList[24] = REGIST_FUNC(ai, goal, NPC_Creighton_Act24) -- Forward Roll
    actFuncList[25] = REGIST_FUNC(ai, goal, NPC_Creighton_Act25) -- Side Roll
    actFuncList[26] = REGIST_FUNC(ai, goal, NPC_Creighton_Act26) -- Back Roll
    
    -- Items
    actFuncList[30] = REGIST_FUNC(ai, goal, NPC_Creighton_Act30) -- ITEM_HERE
    
    -- Spells
    actFuncList[40] = REGIST_FUNC(ai, goal, NPC_Creighton_Act40) -- SPELL_HERE
    
    -- Gestures
    actFuncList[50] = REGIST_FUNC(ai, goal, NPC_Creighton_Act50) -- GESTURE_HERE
    
    -- Utility
    actFuncList[60] = REGIST_FUNC(ai, goal, NPC_Creighton_Act60) -- Switch to 1H
    actFuncList[61] = REGIST_FUNC(ai, goal, NPC_Creighton_Act61) -- Switch to 2H
    actFuncList[62] = REGIST_FUNC(ai, goal, NPC_Creighton_Act62) -- Switch Right Hand Primary
    actFuncList[63] = REGIST_FUNC(ai, goal, NPC_Creighton_Act63) -- Switch Right Hand Secondary
    actFuncList[64] = REGIST_FUNC(ai, goal, NPC_Creighton_Act64) -- Switch Left Hand Primary
    actFuncList[65] = REGIST_FUNC(ai, goal, NPC_Creighton_Act65) -- Switch Left Hand Secondary
    
    Common_Battle_Activate(ai, goal, actChanceList, actFuncList, REGIST_FUNC(ai, goal, NPC_Creighton_ActAfter_AdjustSpace), actTblList)
    return 
end
...
--------------------------------------------------
-- R1 Combo
function NPC_Creighton_Act01(self, ai, goal)
...
-- R1/L1 Combo
function NPC_Creighton_Act02(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- R2 Combo
function NPC_Creighton_Act03(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Kick
function NPC_Creighton_Act04(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Jump Attack
function NPC_Creighton_Act05(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Running R1/R2
function NPC_Creighton_Act06(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
    local roll = self:GetRandam_Int(1, 100)
...
function NPC_Creighton_Act07(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Right WA: PRESS
function NPC_Creighton_Act08(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Left WA: PRESS
function NPC_Creighton_Act09(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
--------------------------------------------------
-- Approach
function NPC_Creighton_Act20(self, ai, goal)
...
-- Strafe
function NPC_Creighton_Act21(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Move Backwards
function NPC_Creighton_Act22(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
...
-- Backstep
function NPC_Creighton_Act23(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Forward Roll
function NPC_Creighton_Act24(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Side Roll
function NPC_Creighton_Act25(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Back Roll
function NPC_Creighton_Act26(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
--------------------------------------------------
-- ITEM_HERE
function NPC_Creighton_Act30(self, ai, goal)
...
--------------------------------------------------
-- SPELL_HERE
function NPC_Creighton_Act40(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
--------------------------------------------------
-- GESTURE_HERE
function NPC_Creighton_Act50(self, ai, goal)
...
--------------------------------------------------
-- Switch to 1H
function NPC_Creighton_Act60(self, ai, goal)
    if self:IsBothHandMode(TARGET_SELF) then
        ai:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, NPC_ATK_ButtonTriangle, TARGET_ENE_0, 999, 0, 0) -- Toggle 2H state of Weapon
    end
...
-- Switch to 2H
function NPC_Creighton_Act61(self, ai, goal)
    if not self:IsBothHandMode(TARGET_SELF) then
        ai:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, NPC_ATK_ButtonTriangle, TARGET_ENE_0, 999, 0, 0) -- Toggle 2H state of Weapon
    end
...
function NPC_Creighton_Act62(self, ai, goal)
...
function NPC_Creighton_Act63(self, ai, goal)
    if self:GetEquipWeaponIndex(ARM_R) == WEP_Primary then
        ai:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, NPC_ATK_ArrowKeyRight, TARGET_ENE_0, 999, 0, 0) -- Switch Weapon (Left)
    end
...
function NPC_Creighton_Act64(self, ai, goal)
    if self:GetEquipWeaponIndex(ARM_L) ~= WEP_Primary then
...
function NPC_Creighton_Act65(self, ai, goal)
    if self:GetEquipWeaponIndex(ARM_L) == WEP_Primary then
        ai:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, NPC_ATK_ArrowKeyLeft, TARGET_ENE_0, 999, 0, 0) -- Switch Weapon (Left)
    end
...
-- Act After
-------------------------
function NPC_Creighton_ActAfter_AdjustSpace(self, ai, goal)
    return 
end
...
Goal.Interrupt = function (self, ai, goal)
    ...
    elseif ai:IsInterupt(INTERUPT_FindAttack) then
        ...
        if roll <= avoidance_chance then
            ...
            if distance > avoidance_distance then
                ...
                if roll <= 50 then
                    goal:ClearSubGoal()
                    NPC_Creighton_Act21(ai, goal, paramTbl)
                    return true
                -- Forward Roll
                else 
                    goal:ClearSubGoal()
                    NPC_Creighton_Act24(ai, goal, paramTbl)
                    return true
                end
            -- If attack is close, running attack
                ...
                -- Running R1/R1
                goal:ClearSubGoal()
                NPC_Creighton_Act06(ai, goal, paramTbl)
                return true
            end
        end
    ----------------------------------
    ...
    elseif ai:IsInterupt(INTERUPT_Shoot) then
        ...
        if roll <= avoidance_chance then 
            goal:ClearSubGoal()
            NPC_Creighton_Act25(ai, goal) -- Side Roll
            return true
        end
    else
        return false
