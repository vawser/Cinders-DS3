RegisterTableGoal(GOAL_NPC_ThePursuer, "GOAL_NPC_ThePursuer")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_ThePursuer, true)
...
Goal.Activate = function (self, ai, goal)
    ...
    local local6 = ai:GetNumber(0)
    ai:AddObserveSpecialEffectAttribute(TARGET_SELF, 130201500)
    if ai:IsBothHandMode(TARGET_SELF) then
        Madmode = 1
    else
        Madmode = 0
    end
    if ai:HasSpecialEffectId(TARGET_SELF, 130201500) and not ai:IsBothHandMode(TARGET_SELF) then
        actChanceList[48] = 100
    ...
    actFuncList[1] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act01)
    actFuncList[2] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act02)
    actFuncList[3] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act03)
    actFuncList[4] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act04)
    actFuncList[5] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act05)
    actFuncList[6] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act06)
    actFuncList[19] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act19)
    actFuncList[20] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act20)
    actFuncList[21] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act21)
    actFuncList[22] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act22)
    actFuncList[23] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act23)
    actFuncList[24] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act24)
    actFuncList[25] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act25)
    actFuncList[40] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act40)
    actFuncList[41] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act41)
    actFuncList[42] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act42)
    actFuncList[43] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act43)
    actFuncList[44] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act44)
    actFuncList[45] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act45)
    actFuncList[46] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act46)
    actFuncList[47] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act47)
    actFuncList[48] = REGIST_FUNC(ai, goal, NPC_ThePursuer_Act48)
    Common_Battle_Activate(ai, goal, actChanceList, actFuncList, REGIST_FUNC(ai, goal, NPC_ThePursuer_ActAfter_AdjustSpace), actTblList)
    return 
end

function NPC_ThePursuer_Act19(self, ai, goal)
...
function NPC_ThePursuer_Act01(self, ai, goal)
    local local0 = self:GetRandam_Int(1, 100)
...
function NPC_ThePursuer_Act02(self, ai, goal)
    local local0 = self:GetRandam_Int(1, 100)
    local local1 = self:GetSp(TARGET_SELF)
    local local2 = 3.8
    local local3 = 100
...
function NPC_ThePursuer_Act03(self, ai, goal)
    local local0 = self:GetRandam_Int(1, 100)
    local local1 = self:GetRandam_Int(1, 100)
    local local2 = self:GetDist(TARGET_ENE_0)
    local local3 = 1.4
...
function NPC_ThePursuer_Act04(self, ai, goal)
    local local0 = self:GetRandam_Int(1, 100)
    local local1 = self:GetRandam_Int(1, 100)
    local local2 = self:GetDist(TARGET_ENE_0)
    local local3 = 5.6
...
function NPC_ThePursuer_Act05(self, ai, goal)
    local local0 = self:GetRandam_Int(1, 100)
    local local1 = self:GetRandam_Int(1, 100)
    local local2 = self:GetDist(TARGET_ENE_0)
    local local3 = 1.4
...
function NPC_ThePursuer_Act06(self, ai, goal)
    local local0 = self:GetRandam_Int(1, 100)
    local local1 = self:GetRandam_Int(1, 100)
    local local2 = self:GetDist(TARGET_ENE_0)
    local local3 = 1.4
...
function NPC_ThePursuer_Act20(self, ai, goal)
    local local0 = self:GetRandam_Int(1, 100)
...
function NPC_ThePursuer_Act21(self, ai, goal)
...
function NPC_ThePursuer_Act22(self, ai, goal)
...
function NPC_ThePursuer_Act23(self, ai, goal)
    local local0 = self:GetDist(TARGET_ENE_0)
...
function NPC_ThePursuer_Act24(self, ai, goal)
...
function NPC_ThePursuer_Act25(self, ai, goal)
...
function NPC_ThePursuer_Act40(self, ai, goal)
    local local0 = self:GetRandam_Int(1, 100)
    local local1 = self:GetSp(TARGET_SELF)
    local local2 = 10
    local local3 = 0
...
function NPC_ThePursuer_Act41(self, ai, goal)
    local local0 = self:GetRandam_Int(1, 100)
    local local1 = self:GetSp(TARGET_SELF)
    local local2 = 30
    local local3 = 0
...
function NPC_ThePursuer_Act42(self, ai, goal)
...
function NPC_ThePursuer_Act43(self, ai, goal)
...
Goal.Interrupt = function (self, ai, goal)
    if ai:IsInterupt(INTERUPT_FindAttack) and ai:GetDist(TARGET_ENE_0) < 3 and 20 <= ai:GetSp(TARGET_SELF) and ai:GetRandam_Int(1, 100) <= 50 then
        goal:ClearSubGoal()
        NPC_ThePursuer_Act40(ai, goal, paramTbl)
        return true
    else
        return false
    end
