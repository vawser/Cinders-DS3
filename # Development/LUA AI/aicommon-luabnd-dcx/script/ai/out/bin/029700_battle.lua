...
Goal.Activate = function (self, ai, goal)
    ...
    -- Attacks
    actFuncList[1] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act01)    -- Right Light Attack
    ...
    actFuncList[11] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act11)   -- Forward Roll / Roll Attack
    actFuncList[12] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act12)   -- Forward Angled Directional Roll / Roll Attack
    actFuncList[13] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act13)   -- Side Directional Roll / Roll Attack
    actFuncList[14] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act14)   -- Back Angled Roll / Roll Attack
    actFuncList[15] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act15)   -- Strafe
    actFuncList[16] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act16)   -- Leave Target and Guard
    actFuncList[17] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act17)   -- Approach
    
    -- Items
    actFuncList[20] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act20)   -- Use Item (Slot 0) - Divine Blessing
    actFuncList[21] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act21)   -- Use Item (Slot 1) - Green Blossom
    actFuncList[22] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act22)   -- Use Item (Slot 2) - Firebomb
    actFuncList[23] = REGIST_FUNC(ai, goal, NPC_Pursuer_Act23)   -- Use Item (Slot 3) - Young White Branch
...
-- Use Item (Slot 1) - Green Blossom
function NPC_Pursuer_Act21(self, ai, goal)
...
-- Use Item (Slot 2) - Firebomb
function NPC_Pursuer_Act22(self, ai, goal)
...
-- Use Item (Slot 3) - Young White Branch
function NPC_Pursuer_Act23(self, ai, goal)
    self:ChangeEquipItem(3) 
    self:SetStringIndexedNumber("Young White Branch", self:GetStringIndexedNumber("Young White Branch") - 1)
    ai:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, NPC_ATK_ButtonSquare, TARGET_ENE_0, 999, 0, 0)
...
Goal.Interrupt = function (self, ai, goal)
    ...
    elseif ai:IsInterupt(INTERUPT_FindAttack) then
        goal:ClearSubGoal()
        NPC_Pursuer_Act15(ai, goal, paramTbl) -- Move and Guard
    end
    if ai:IsInterupt(INTERUPT_Shoot) and roll <= 33 and 20 <= stamina then
        goal:ClearSubGoal()
        NPC_Pursuer_Act13(ai, goal) -- Side Directional Roll / Roll Attack
        return true
    else
        return false
    end
