RegisterTableGoal(GOAL_MirrorKnight_817000_Battle, "GOAL_MirrorKnight_817000_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_MirrorKnight_817000_Battle, true)
...
Goal.Activate = function (arg0, ai, enemy)
    ...
    actChanceList[1] = SetCoolTime(ai, enemy, 3000, 3, actChanceList[1], 1)
    actChanceList[2] = SetCoolTime(ai, enemy, 3001, 3, actChanceList[2], 1)
    actChanceList[2] = SetCoolTime(ai, enemy, 3003, 3, actChanceList[2], 1)
    actChanceList[3] = SetCoolTime(ai, enemy, 3004, 3, actChanceList[3], 1)
    actChanceList[4] = SetCoolTime(ai, enemy, 3005, 3, actChanceList[4], 1)
    actChanceList[5] = SetCoolTime(ai, enemy, 3006, 3, actChanceList[5], 1)
    actChanceList[6] = SetCoolTime(ai, enemy, 3015, 3, actChanceList[6], 1)
    actChanceList[8] = SetCoolTime(ai, enemy, 3019, 3, actChanceList[8], 1)
    actChanceList[9] = SetCoolTime(ai, enemy, 3021, 3, actChanceList[9], 1)
    actChanceList[10] = SetCoolTime(ai, enemy, 3023, 8, actChanceList[10], 1)
    actChanceList[11] = SetCoolTime(ai, enemy, 3007, 5, actChanceList[11], 1)
    
    if ai:HasSpecialEffectId(TARGET_SELF, 11300) == false then
        actChanceList[7] = 0
    end
    
    -- Disable lightning slam move
    actChanceList[11] = 0
    
    actFuncList[1] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act01)
    actFuncList[2] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act02)
    actFuncList[3] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act03)
    actFuncList[4] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act04)
    actFuncList[5] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act05)
    actFuncList[6] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act06)
    actFuncList[7] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act07)
    actFuncList[8] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act08)
    actFuncList[9] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act09)
    actFuncList[10] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act10)
    actFuncList[11] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act11)
    actFuncList[20] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act20)
    actFuncList[21] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act21)
    actFuncList[22] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act22)
    actFuncList[23] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act23)
    actFuncList[24] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act24)
    actFuncList[25] = REGIST_FUNC(ai, enemy, MirrorKnight_817000_Act25)
    
    Common_Battle_Activate(ai, enemy, actChanceList, actFuncList, REGIST_FUNC(ai, enemy, MirrorKnight_ActAfter_AdjustSpace), actTblList)
    
    return 
end

function MirrorKnight_817000_Act01(arg0, arg1, arg2)
...
function MirrorKnight_817000_Act02(arg0, arg1, arg2)
    local local0 = 4.54
    local local1 = 4.54 + 2
    local local2 = 4.54 + 2
    local local3 = 0
...
function MirrorKnight_817000_Act03(arg0, arg1, arg2)
...
function MirrorKnight_817000_Act07(arg0, arg1, arg2)
    arg0:SetTimer(1, 20)
        ...
        for local12 = 1 - local11, 4, local11 do
            ...
            if arg0:GetRandam_Int(0, local6) <= local7 then
                if local12 ~= 1 then
                    ...
                    arg1:AddSubGoal(GOAL_MirrorKnight_817000_AfterAttackAct, 10)
                    GetWellSpace_Odds = 100
                    return GetWellSpace_Odds
                end
            end
...
function MirrorKnight_817000_Act08(arg0, arg1, arg2)
...
function MirrorKnight_817000_Act22(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SpinStep, 5, 6001, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function MirrorKnight_817000_Act23(arg0, arg1, arg2)
    ...
    if local0 < 40 and arg0:IsFinishTimer(1) == true and arg0:HasSpecialEffectId(TARGET_SELF, 11300) == true then
        MirrorKnight_817000_Act07(arg0, arg1, arg2)
...
function MirrorKnight_817000_Act24(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 5, TARGET_ENE_0, 3, TARGET_SELF, false, 9910)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function MirrorKnight_817000_Act25(arg0, arg1, arg2)
        ...
        if arg1:GetSpecialEffectActivateInterruptType(0) == 5026 and arg1:HasSpecialEffectAttribute(TARGET_ENE_0, SP_EFFECT_TYPE_TARGET_DOWN) == false and local1 <= 60 then
            ...
            if arg1:GetSpecialEffectActivateInterruptType(0) == 5030 then
                ...
                if arg1:GetSpecialEffectActivateInterruptType(0) == 5031 then
                    arg2:ClearSubGoal()
                    MirrorKnight_817000_Act07(arg1, arg2, paramTbl)
                    return true
                else
                    return false
                end
...
function MirrorKnight_ActAfter_AdjustSpace(arg0, arg1, arg2)
    return 
end

RegisterTableGoal(GOAL_MirrorKnight_817000_AfterAttackAct, "GOAL_MirrorKnight_817000_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_MirrorKnight_817000_AfterAttackAct, true)
