RegisterTableGoal(GOAL_NPC_Dyfan, "GOAL_NPC_Dyfan")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_Dyfan, true)
...
Goal.Activate = function (self, ai, goal)
    ...
    if distance >= 7 then
        ...
        actChanceList[30] = 20 -- Cast Spell (Slot 0) - Fireball
        actChanceList[31] = 20 -- Cast Spell (Slot 1) - Fire Orb
        actChanceList[32] = 0 -- Cast Spell (Slot 2) - Great Combustion
        actChanceList[33] = 10 -- Cast Spell (Slot 2) - Great Chaos Fire Orb
        actChanceList[34] = 10 -- Cast Spell (Slot 2) - Chaos Bed Vestiges
    elseif distance >= 3 then
        ...
        actChanceList[30] = 5 -- Cast Spell (Slot 0) - Fireball
        actChanceList[31] = 5 -- Cast Spell (Slot 1) - Fire Orb
        actChanceList[32] = 20 -- Cast Spell (Slot 2) - Great Combustion
        actChanceList[33] = 10 -- Cast Spell (Slot 2) - Great Chaos Fire Orb
        actChanceList[34] = 10 -- Cast Spell (Slot 2) - Chaos Bed Vestiges
    else
        ...
        actChanceList[16] = 10 -- Backstep Walk
        actChanceList[17] = 0 -- Approach
        
        actChanceList[30] = 0 -- Cast Spell (Slot 0) - Fireball
        actChanceList[31] = 0 -- Cast Spell (Slot 1) - Fire Orb
        actChanceList[32] = 10 -- Cast Spell (Slot 2) - Great Combustion
        actChanceList[33] = 0 -- Cast Spell (Slot 2) - Great Chaos Fire Orb
        actChanceList[34] = 0 -- Cast Spell (Slot 2) - Chaos Bed Vestiges
    end
    ...
    if ai:GetHpRate(TARGET_ENE_0) < 0.1 then
         actChanceList[34] = actChanceList[34] + 50 -- Cast Spell (Slot 2) - Chaos Bed Vestiges
    end
    
    -- Punish a defensive player by healing
    if ai:IsTargetGuard(TARGET_ENE_0) then
        actChanceList[33] = actChanceList[33] + 40 -- Great Chaos Fire Orb
    end
    ...
    ----------------------------------
    -- Attacks
    actFuncList[1] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act01) -- Right Light Attack + Approach
    actFuncList[2] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act02) -- Right Heavy Attack + Approach
    actFuncList[3] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act03) -- Kick + Approach
    actFuncList[4] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act04) -- Jump Attack + Approach
    actFuncList[5] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act05) -- WA: Stance
    
    -- Utility
    actFuncList[10] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act10) -- Approach + Running Attack
    actFuncList[11] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act11) -- Backstep Roll
    actFuncList[12] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act12) -- Forward Roll + Run + Basic Light Attack
    actFuncList[13] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act13) -- Side Roll + Run + Basic Light Attack
    actFuncList[14] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act14) -- Back Roll + Basic Light Attack
    actFuncList[15] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act15) -- Strafe
    actFuncList[16] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act16) -- Backstep Walk
    actFuncList[17] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act17) -- Approach
    
    -- Spells
    actFuncList[30] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act30) -- Cast Spell (Slot 0) - Fireball
    actFuncList[31] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act31) -- Cast Spell (Slot 1) - Fire Orb
    actFuncList[32] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act32) -- Cast Spell (Slot 2) - Great Combustion
    actFuncList[33] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act33) -- Cast Spell (Slot 3) - Great Chaos Fire Orb
    actFuncList[34] = REGIST_FUNC(ai, goal, NPC_Dyfan_Act34) -- Cast Spell (Slot 4) - Chaos Bed Vestiges
    
    Common_Battle_Activate(ai, goal, actChanceList, actFuncList, REGIST_FUNC(ai, goal, NPC_Dyfan_ActAfter_AdjustSpace), actTblList)
    return 
end
...
function NPC_Dyfan_Act01(self, ai, goal)
...
function NPC_Dyfan_Act02(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
...
-- Kick + Approach
function NPC_Dyfan_Act03(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
function NPC_Dyfan_Act04(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
-- WA: Stance
function NPC_Dyfan_Act05(self, ai, goal)
...
function NPC_Dyfan_Act10(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
...
-- Backstep Roll
function NPC_Dyfan_Act11(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_Dyfan_Act12(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_Dyfan_Act13(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_Dyfan_Act14(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Strafe
function NPC_Dyfan_Act15(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
    local duration = 1.8
...
-- Backstep
function NPC_Dyfan_Act16(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local duration = 1.8
...
-- Approach
function NPC_Dyfan_Act17(self, ai, goal)
...
-- Cast Spell (Slot 0) - Fireball
function NPC_Dyfan_Act30(self, ai, goal)
...
-- Cast Spell (Slot 1) - Fire Orb
function NPC_Dyfan_Act31(self, ai, goal)
...
-- Cast Spell (Slot 2) - Great Combustion
function NPC_Dyfan_Act32(self, ai, goal)
...
-- Cast Spell (Slot 3) - Great Chaos Fire Orb
function NPC_Dyfan_Act33(self, ai, goal)
...
-- Cast Spell (Slot 4) - Chaos Bed Vestiges
function NPC_Dyfan_Act34(self, ai, goal)
...
-- Act After
-------------------------
function NPC_Dyfan_ActAfter_AdjustSpace(self, ai, goal)
    return 
end
    ...
    elseif ai:IsInterupt(INTERUPT_FindAttack) then
        if distance < 1.8 and roll <= 80 then
            if roll <= 60 and 30 <= stamina then
                goal:ClearSubGoal()
                NPC_Dyfan_Act15(ai, goal, paramTbl) -- Strafe
                return true
            elseif stamina <= 35 and 0 <= stamina then
                goal:ClearSubGoal()
                NPC_Dyfan_Act12(ai, goal, paramTbl) -- Forward Roll + Run + Basic Light Attack
                return true
            end
        elseif distance <= 3 and 20 <= stamina and roll <= 60 then
            goal:ClearSubGoal()
            NPC_Dyfan_Act10(ai, goal, paramTbl) -- Approach + Running Attack
            return true
        end
    -- Occurs if a ranged attack occurs
    elseif ai:IsInterupt(INTERUPT_Shoot) and roll <= 33 and 20 <= stamina then
        goal:ClearSubGoal()
        NPC_Dyfan_Act13(ai, goal) -- Side Roll + Run + Basic Light Attack
        return true
    else
        return false
    end
