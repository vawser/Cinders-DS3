RegisterTableGoal(GOAL_NPC_Eygor, "GOAL_NPC_Eygor")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_Eygor, true)
...
Goal.Activate = function (self, ai, goal)
    ...
    if distance >= 7 then
        ...
        actChanceList[5] = 0 -- WA: Demonic Flare
        ...
        actChanceList[30] = 10 -- Cast Spell (Slot 0) - Bursting Fireball
        actChanceList[31] = 0 -- Cast Spell (Slot 1) - Sacred Flame
        actChanceList[32] = 10 -- Cast Spell (Slot 2) - Floating Chaos
        actChanceList[33] = 10 -- Cast Spell (Slot 2) - Chaos Beam
    elseif distance >= 3 then
        ...
        actChanceList[30] = 10 -- Cast Spell (Slot 0) - Bursting Fireball
        actChanceList[31] = 10 -- Cast Spell (Slot 1) - Sacred Flame
        actChanceList[32] = 0 -- Cast Spell (Slot 2) - Floating Chaos
        actChanceList[33] = 0 -- Cast Spell (Slot 2) - Chaos Beam
    else
        ...
        actChanceList[5] = 20 -- WA: Demonic Flare
        ...
        actChanceList[30] = 0 -- Cast Spell (Slot 0) - Bursting Fireball
        actChanceList[31] = 10 -- Cast Spell (Slot 1) - Sacred Flame
        actChanceList[32] = 0 -- Cast Spell (Slot 2) - Floating Chaos
        actChanceList[33] = 0 -- Cast Spell (Slot 2) - Chaos Beam
    end
    ...
    if ai:GetHpRate(TARGET_ENE_0) < 0.1 and distance > 3.0 then
         actChanceList[33] = 50 -- Cast Spell (Slot 2) - Chaos Beam
    end
    
    -- Punish a defensive player with Sacred Flame
    if ai:IsTargetGuard(TARGET_ENE_0) and distance <= 1.0 then
        actChanceList[31] = 50 -- Cast Spell (Slot 1) - Sacred Flame
    end
    ...
    ----------------------------------
    -- Attacks
    actFuncList[1] = REGIST_FUNC(ai, goal, NPC_Eygor_Act01) -- Right Light Attack + Approach
    actFuncList[2] = REGIST_FUNC(ai, goal, NPC_Eygor_Act02) -- Right Heavy Attack + Approach
    actFuncList[3] = REGIST_FUNC(ai, goal, NPC_Eygor_Act03) -- Kick + Approach
    actFuncList[4] = REGIST_FUNC(ai, goal, NPC_Eygor_Act04) -- Jump Attack + Approach
    actFuncList[5] = REGIST_FUNC(ai, goal, NPC_Eygor_Act05) -- WA: Demonic Flare
    
    -- Utility
    actFuncList[10] = REGIST_FUNC(ai, goal, NPC_Eygor_Act10) -- Approach + Running Attack
    actFuncList[11] = REGIST_FUNC(ai, goal, NPC_Eygor_Act11) -- Backstep Roll
    actFuncList[12] = REGIST_FUNC(ai, goal, NPC_Eygor_Act12) -- Forward Roll + Run + Basic Light Attack
    actFuncList[13] = REGIST_FUNC(ai, goal, NPC_Eygor_Act13) -- Side Roll + Run + Basic Light Attack
    actFuncList[14] = REGIST_FUNC(ai, goal, NPC_Eygor_Act14) -- Back Roll + Basic Light Attack
    actFuncList[15] = REGIST_FUNC(ai, goal, NPC_Eygor_Act15) -- Strafe
    actFuncList[16] = REGIST_FUNC(ai, goal, NPC_Eygor_Act16) -- Backstep Walk
    actFuncList[17] = REGIST_FUNC(ai, goal, NPC_Eygor_Act17) -- Approach
    
    -- Spells
    actFuncList[30] = REGIST_FUNC(ai, goal, NPC_Eygor_Act30) -- Cast Spell (Slot 0) - Bursting Fireball
    actFuncList[31] = REGIST_FUNC(ai, goal, NPC_Eygor_Act31) -- Cast Spell (Slot 1) - Sacred Flame
    actFuncList[32] = REGIST_FUNC(ai, goal, NPC_Eygor_Act32) -- Cast Spell (Slot 2) - Floating Chaos
    actFuncList[33] = REGIST_FUNC(ai, goal, NPC_Eygor_Act33) -- Cast Spell (Slot 3) - Chaos Beam
    
    Common_Battle_Activate(ai, goal, actChanceList, actFuncList, REGIST_FUNC(ai, goal, NPC_Eygor_ActAfter_AdjustSpace), actTblList)
    return 
end
...
function NPC_Eygor_Act01(self, ai, goal)
...
function NPC_Eygor_Act02(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
...
-- Kick + Approach
function NPC_Eygor_Act03(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
function NPC_Eygor_Act04(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
-- WA: Demonic Flare
function NPC_Eygor_Act05(self, ai, goal)
...
function NPC_Eygor_Act10(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
...
-- Backstep Roll
function NPC_Eygor_Act11(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local roll_a = self:GetRandam_Int(1, 100)
...
function NPC_Eygor_Act12(self, ai, goal)
...
function NPC_Eygor_Act13(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
...
function NPC_Eygor_Act14(self, ai, goal)
...
-- Strafe
function NPC_Eygor_Act15(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local stamina = self:GetSp(TARGET_SELF)
    local duration = 1.8
...
-- Backstep Walk
function NPC_Eygor_Act16(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local stamina = self:GetSp(TARGET_SELF)
    local duration = 1.8
...
-- Approach
function NPC_Eygor_Act17(self, ai, goal)
...
-- Cast Spell (Slot 0) - Bursting Fireball
function NPC_Eygor_Act30(self, ai, goal)
...
function NPC_Eygor_Act31(self, ai, goal)
...
-- Cast Spell (Slot 2) - Floating Chaos
function NPC_Eygor_Act32(self, ai, goal)
...
-- Cast Spell (Slot 3) - Chaos Beam
function NPC_Eygor_Act33(self, ai, goal)
    ...
    -- Cast Spell with Left Light Attack
    local subgoal = ai:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 1, NPC_ATK_L1HOLD, TARGET_ENE_0, 999, 0, 0)
...
-- Act After
-------------------------
function NPC_Eygor_ActAfter_AdjustSpace(self, ai, goal)
    return 
end
    ...
    elseif ai:IsInterupt(INTERUPT_FindAttack) then
        if distance < 1.8 and roll <= 80 then
            if roll <= 60 and 30 <= stamina then
                goal:ClearSubGoal()
                NPC_Eygor_Act15(ai, goal, paramTbl) -- Strafe
                return true
            elseif stamina <= 35 and 0 <= stamina then
                goal:ClearSubGoal()
                NPC_Eygor_Act12(ai, goal, paramTbl) -- Forward Roll + Run + Basic Light Attack
                return true
            end
        elseif distance <= 3 and 20 <= stamina and roll <= 60 then
            goal:ClearSubGoal()
            NPC_Eygor_Act10(ai, goal, paramTbl) -- Approach + Running Attack
            return true
        end
    -- Occurs if a ranged attack occurs
    elseif ai:IsInterupt(INTERUPT_Shoot) and roll <= 33 and 20 <= stamina then
        goal:ClearSubGoal()
        NPC_Eygor_Act13(ai, goal) -- Side Roll + Run + Basic Light Attack
        return true
    else
        return false
    end
