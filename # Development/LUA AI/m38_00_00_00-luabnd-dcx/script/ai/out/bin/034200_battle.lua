RegisterTableGoal(GOAL_NPC_TheMother, "GOAL_NPC_TheMother")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_TheMother, true)
...
Goal.Activate = function (self, ai, goal)
    ...
    if distance >= 6 then
        ...
        actChanceList[30] = 10 -- Cast Spell (Slot 0) - Black Fire Orb
        actChanceList[31] = 0 -- Cast Spell (Slot 1) - Black Flame
    elseif distance >= 3 then
        ...
        actChanceList[5] = 5 -- WA: Hold
        
        actChanceList[10] = 5 -- Approach + Running Attack
        actChanceList[11] = 0 -- Backstep Roll
        actChanceList[12] = 3 -- Forward Roll + Run + Basic Light Attack
        actChanceList[13] = 3 -- Side Roll + Run + Basic Light Attack
        actChanceList[14] = 3 -- Back Roll + Basic Light Attack
        actChanceList[15] = 0 -- Strafe
        actChanceList[16] = 0 -- Backstep
        actChanceList[17] = 0 -- Approach
        
        actChanceList[30] = 5 -- Cast Spell (Slot 0) - Black Fire Orb
        actChanceList[31] = 0 -- Cast Spell (Slot 1) - Black Flame
    else
        ...
        actChanceList[30] = 0 -- Cast Spell (Slot 0) - Black Fire Orb
        actChanceList[31] = 10 -- Cast Spell (Slot 1) - Black Flame
    end
    ...
    if ai:GetHpRate(TARGET_ENE_0) < 0.1 then
        actChanceList[30] = actChanceList[30] + 10 -- Cast Spell (Slot 0) - Black Fire Orb
    end
    ...
    ----------------------------------
    -- Attacks
    actFuncList[1] = REGIST_FUNC(ai, goal, NPC_TheMother_Act01) -- Right Light Attack + Approach
    actFuncList[2] = REGIST_FUNC(ai, goal, NPC_TheMother_Act02) -- Right Heavy Attack + Approach
    actFuncList[3] = REGIST_FUNC(ai, goal, NPC_TheMother_Act03) -- Kick + Approach
    actFuncList[4] = REGIST_FUNC(ai, goal, NPC_TheMother_Act04) -- Jump Attack + Approach
    actFuncList[5] = REGIST_FUNC(ai, goal, NPC_TheMother_Act05) -- WA: Hold
    
    -- Utility
    actFuncList[10] = REGIST_FUNC(ai, goal, NPC_TheMother_Act10) -- Approach + Running Attack
    actFuncList[11] = REGIST_FUNC(ai, goal, NPC_TheMother_Act11) -- Backstep Roll
    actFuncList[12] = REGIST_FUNC(ai, goal, NPC_TheMother_Act12) -- Forward Roll + Run + Basic Light Attack
    actFuncList[13] = REGIST_FUNC(ai, goal, NPC_TheMother_Act13) -- Side Roll + Run + Basic Light Attack
    actFuncList[14] = REGIST_FUNC(ai, goal, NPC_TheMother_Act14) -- Back Roll + Basic Light Attack
    actFuncList[15] = REGIST_FUNC(ai, goal, NPC_TheMother_Act15) -- Strafe
    actFuncList[16] = REGIST_FUNC(ai, goal, NPC_TheMother_Act16) -- Backstep
    actFuncList[17] = REGIST_FUNC(ai, goal, NPC_TheMother_Act17) -- Approach

    -- Spells
    actFuncList[30] = REGIST_FUNC(ai, goal, NPC_TheMother_Act30) -- Cast Spell (Slot 0) - Black Fire Orb
    actFuncList[31] = REGIST_FUNC(ai, goal, NPC_TheMother_Act31) -- Cast Spell (Slot 1) - Black Flame
    
    Common_Battle_Activate(ai, goal, actChanceList, actFuncList, REGIST_FUNC(ai, goal, NPC_TheMother_ActAfter_AdjustSpace), actTblList)
    return 
end
...
function NPC_TheMother_Act01(self, ai, goal)
...
function NPC_TheMother_Act02(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
...
-- Kick + Approach
function NPC_TheMother_Act03(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
function NPC_TheMother_Act04(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
-- WA: Hold
function NPC_TheMother_Act05(self, ai, goal)
...
function NPC_TheMother_Act10(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
...
-- Backstep Roll
function NPC_TheMother_Act11(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_TheMother_Act12(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_TheMother_Act13(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_TheMother_Act14(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Strafe
function NPC_TheMother_Act15(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
    local duration = 1.8
...
-- Backstep
function NPC_TheMother_Act16(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local duration = 1.8
...
-- Approach
function NPC_TheMother_Act17(self, ai, goal)
...
-- Cast Spell (Slot 0) - Black Fire Orb
function NPC_TheMother_Act30(self, ai, goal)
...
-- Cast Spell (Slot 1) - Black Flame
function NPC_TheMother_Act31(self, ai, goal)
    ...
    -- Cast Spell with Left Light Attack
    local subgoal = ai:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 1, NPC_ATK_L1, TARGET_ENE_0, 999, 0, 0)
    subgoal = subgoal:TimingSetTimer(1, 1.0, UPDATE_SUCCESS)
    subgoal:SetLifeEndSuccess(true)
...
-- Act After
-------------------------
function NPC_TheMother_ActAfter_AdjustSpace(self, ai, goal)
    return 
end
    ...
    elseif ai:IsInterupt(INTERUPT_FindAttack) then
        if distance < 1.8 and roll <= 80 then
            if roll <= 60 and 30 <= stamina then
                goal:ClearSubGoal()
                NPC_TheMother_Act15(ai, goal, paramTbl) -- Strafe
                return true
            elseif stamina <= 35 and 0 <= stamina then
                goal:ClearSubGoal()
                NPC_TheMother_Act12(ai, goal, paramTbl) -- Forward Roll + Run + Basic Light Attack
                return true
            end
        elseif distance <= 3 and 20 <= stamina and roll <= 60 then
            goal:ClearSubGoal()
            NPC_TheMother_Act10(ai, goal, paramTbl) -- Approach + Running Attack
            return true
        end
    -- Occurs if a ranged attack occurs
    elseif ai:IsInterupt(INTERUPT_Shoot) and roll <= 33 and 20 <= stamina then
        goal:ClearSubGoal()
        NPC_TheMother_Act13(ai, goal) -- Side Roll + Run + Basic Light Attack
        return true
    else
        return false
    end
