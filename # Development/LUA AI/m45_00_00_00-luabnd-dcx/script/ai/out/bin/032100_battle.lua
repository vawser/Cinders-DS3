RegisterTableGoal(GOAL_NPC_Ezekiel, "GOAL_NPC_Ezekiel")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_Ezekiel, true)
...
Goal.Activate = function (self, ai, goal)
    ...
    if distance >= 6 then
        ...
        actChanceList[20] = 10 -- Use Item (Slot 0) - Frigid Knife
        actChanceList[21] = 0 -- Use Item (Slot 0) - Duel Charm
        
        actChanceList[30] = 0 -- Cast Spell (Slot 0) - Snap Freeze
    elseif distance >= 3 then
        ...
        actChanceList[5] = 5 -- WA: Shield Splitter
        ...
        actChanceList[20] = 10 -- Use Item (Slot 0) - Frigid Knife
        actChanceList[21] = 5 -- Use Item (Slot 1) - Duel Charm
        ...
        actChanceList[5] = 10 -- WA: Shield Splitter
        ...
        actChanceList[20] = 3 -- Use Item (Slot 0) - Frigid Knife
        actChanceList[21] = 0 -- Use Item (Slot 1) - Duel Charm
    ...
    -- Act Modifiers
    ----------------------------------
    -- Start using Snap Freeze if HP is low
    if ai:GetHpRate(TARGET_SELF) <= 0.5 and distance >= 2.0 then
        actChanceList[30] = 15 -- Cast Spell (Slot 0) - Snap Freeze
    end
    
    -- Invalid Item check
    if speffect_no_invalid_item then
        actChanceList[20] = 0 -- Use Item (Slot 0) - Frigid Knife
        actChanceList[21] = 0 -- Use Item (Slot 0) - Duel Charm
    end
    ...
    ----------------------------------
    -- Attacks
    actFuncList[1] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act01) -- Right Light Attack + Approach
    actFuncList[2] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act02) -- Right Heavy Attack + Approach
    actFuncList[3] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act03) -- Kick + Approach
    actFuncList[4] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act04) -- Jump Attack + Approach
    actFuncList[5] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act05) -- WA: Shield Splitter
    
    -- Utility
    actFuncList[10] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act10) -- Approach + Running Attack
    actFuncList[11] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act11) -- Backstep Roll
    actFuncList[12] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act12) -- Forward Roll + Run + Basic Light Attack
    actFuncList[13] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act13) -- Side Roll + Run + Basic Light Attack
    actFuncList[14] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act14) -- Back Roll + Basic Light Attack
    actFuncList[15] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act15) -- Strafe
    actFuncList[16] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act16) -- Backstep
    actFuncList[17] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act17) -- Approach
    
    -- Items
    actFuncList[20] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act20)   -- Use Item (Slot 0) - Frigid Knife
    actFuncList[21] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act21)   -- Use Item (Slot 1) - Duel Charm
    
    -- Spells
    actFuncList[30] = REGIST_FUNC(ai, goal, NPC_Ezekiel_Act30) -- Cast Spell (Slot 0) - Snap Freeze
    
    Common_Battle_Activate(ai, goal, actChanceList, actFuncList, REGIST_FUNC(ai, goal, NPC_Ezekiel_ActAfter_AdjustSpace), actTblList)
    return 
end
...
function NPC_Ezekiel_Act01(self, ai, goal)
...
function NPC_Ezekiel_Act02(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
...
-- Kick + Approach
function NPC_Ezekiel_Act03(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
function NPC_Ezekiel_Act04(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
-- WA: Shield Splitter
function NPC_Ezekiel_Act05(self, ai, goal)
...
function NPC_Ezekiel_Act10(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
...
-- Backstep Roll
function NPC_Ezekiel_Act11(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_Ezekiel_Act12(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_Ezekiel_Act13(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_Ezekiel_Act14(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Strafe
function NPC_Ezekiel_Act15(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
    local duration = 1.8
...
-- Backstep
function NPC_Ezekiel_Act16(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local duration = 1.8
...
-- Approach
function NPC_Ezekiel_Act17(self, ai, goal)
...
-- Use Item (Slot 0) - Frigid Knife
function NPC_Ezekiel_Act20(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    ...
    -- 2nd
    if self:GetRandam_Int(1, 100) <= 50 and distance >= 2.0 then
        ai:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, NPC_ATK_ButtonSquare, TARGET_ENE_0, 999, 0, 0)
    end
...
function NPC_Ezekiel_Act21(self, ai, goal)
...
-- Cast Spell (Slot 0) - Snap Freeze
function NPC_Ezekiel_Act30(self, ai, goal)
...
-- Act After
-------------------------
function NPC_Ezekiel_ActAfter_AdjustSpace(self, ai, goal)
    return 
end
    ...
    elseif ai:IsInterupt(INTERUPT_FindAttack) then
        if distance < 1.8 and roll <= 80 then
            if roll <= 60 and 30 <= stamina then
                goal:ClearSubGoal()
                NPC_Ezekiel_Act15(ai, goal, paramTbl) -- Strafe
                return true
            elseif stamina <= 35 and 0 <= stamina then
                goal:ClearSubGoal()
                NPC_Ezekiel_Act12(ai, goal, paramTbl) -- Forward Roll + Run + Basic Light Attack
                return true
            end
        elseif distance <= 3 and 20 <= stamina and roll <= 60 then
            goal:ClearSubGoal()
            NPC_Ezekiel_Act10(ai, goal, paramTbl) -- Approach + Running Attack
            return true
        end
    -- Occurs if a ranged attack occurs
    elseif ai:IsInterupt(INTERUPT_Shoot) and roll <= 33 and 20 <= stamina then
        goal:ClearSubGoal()
        NPC_Ezekiel_Act13(ai, goal) -- Side Roll + Run + Basic Light Attack
        return true
    else
        return false
    end
