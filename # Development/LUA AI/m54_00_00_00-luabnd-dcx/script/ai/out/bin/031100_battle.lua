RegisterTableGoal(GOAL_NPC_Ashford, "GOAL_NPC_Ashford")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_Ashford, true)
...
Goal.Activate = function (self, ai, goal)
    ...
    if distance >= 8 then
        ...
        actChanceList[5] = 0 -- WA: Moonlight Vortex
        ...
        actChanceList[30] = 0 -- Cast Spell (Slot 0) - Crystal Soulmass
        actChanceList[31] = 5 -- Cast Spell (Slot 1) - Crystal Hail
        actChanceList[32] = 30 -- Cast Spell (Slot 2) - Crystal Soul Spear
        actChanceList[33] = 0 -- Cast Spell (Slot 3) - Twisted Wall of Light
        actChanceList[34] = 0 -- Cast Spell (Slot 4) - Old Moonlight
    elseif distance >= 3 then
        ...
        actChanceList[10] = 0 -- Approach + Running Attack
        actChanceList[11] = 30 -- Backstep Roll
        actChanceList[12] = 0 -- Forward Roll + Run + Basic Light Attack
        actChanceList[13] = 0 -- Side Roll + Run + Basic Light Attack
        ...
        actChanceList[30] = 10 -- Cast Spell (Slot 0) - Crystal Soulmass
        actChanceList[31] = 5 -- Cast Spell (Slot 1) - Crystal Hail
        actChanceList[32] = 20 -- Cast Spell (Slot 2) - Crystal Soul Spear
        actChanceList[33] = 0 -- Cast Spell (Slot 3) - Twisted Wall of Light
        actChanceList[34] = 0 -- Cast Spell (Slot 4) - Old Moonlight
    else
        actChanceList[1] = 3 -- Right Light Attack + Approach
        actChanceList[2] = 3 -- Right Heavy Attack + Approach
        actChanceList[3] = 1 -- Kick + Approach
        actChanceList[4] = 3 -- Jump Attack + Approach
        actChanceList[5] = 3 -- WA: Moonlight Vortex
        ...
        actChanceList[30] = 5 -- Cast Spell (Slot 0) - Crystal Soulmass
        actChanceList[31] = 0 -- Cast Spell (Slot 1) - Crystal Hail
        actChanceList[32] = 10 -- Cast Spell (Slot 2) - Crystal Soul Spear
        actChanceList[33] = 0 -- Cast Spell (Slot 3) - Twisted Wall of Light
        actChanceList[34] = 10 -- Cast Spell (Slot 4) - Old Moonlight
    end

    ----------------------------------
    -- Act Modifiers
    ----------------------------------
    -- Punish a defensive with Crystal Soul Spear
    if ai:IsTargetGuard(TARGET_ENE_0) then
        actChanceList[32] = actChanceList[32] + 30 -- Cast Spell (Slot 2) - Crystal Soul Spear
    end
    
    -- Block repeat usage of Crystal Soulmass while active
    ...
    -- Block spells on low stamina
    if stamina < 50 then
        actChanceList[30] = 0 -- Cast Spell (Slot 0) - Crystal Soulmass
        actChanceList[31] = 0 -- Cast Spell (Slot 1) - Crystal Hail
        actChanceList[32] = 0 -- Cast Spell (Slot 2) - Crystal Soul Spear
        actChanceList[33] = 0 -- Cast Spell (Slot 3) - Twisted Wall of Light
        actChanceList[34] = 0 -- Cast Spell (Slot 4) - Old Moonlight
    end
    ...
    ----------------------------------
    -- Attacks
    actFuncList[1] = REGIST_FUNC(ai, goal, NPC_Ashford_Act01) -- Right Light Attack + Approach
    actFuncList[2] = REGIST_FUNC(ai, goal, NPC_Ashford_Act02) -- Right Heavy Attack + Approach
    actFuncList[3] = REGIST_FUNC(ai, goal, NPC_Ashford_Act03) -- Kick + Approach
    actFuncList[4] = REGIST_FUNC(ai, goal, NPC_Ashford_Act04) -- Jump Attack + Approach
    actFuncList[5] = REGIST_FUNC(ai, goal, NPC_Ashford_Act05) -- WA: Moonlight Vortex
    
    -- Utility
    actFuncList[10] = REGIST_FUNC(ai, goal, NPC_Ashford_Act10) -- Approach + Running Attack
    actFuncList[11] = REGIST_FUNC(ai, goal, NPC_Ashford_Act11) -- Backstep Roll
    actFuncList[12] = REGIST_FUNC(ai, goal, NPC_Ashford_Act12) -- Forward Roll + Run + Basic Light Attack
    actFuncList[13] = REGIST_FUNC(ai, goal, NPC_Ashford_Act13) -- Side Roll + Run + Basic Light Attack
    actFuncList[14] = REGIST_FUNC(ai, goal, NPC_Ashford_Act14) -- Back Roll + Basic Light Attack
    actFuncList[15] = REGIST_FUNC(ai, goal, NPC_Ashford_Act15) -- Strafe
    actFuncList[16] = REGIST_FUNC(ai, goal, NPC_Ashford_Act16) -- Backstep Walk
    actFuncList[17] = REGIST_FUNC(ai, goal, NPC_Ashford_Act17) -- Approach
    
    -- Spells
    actFuncList[30] = REGIST_FUNC(ai, goal, NPC_Ashford_Act30) -- Cast Spell (Slot 0) - Crystal Soulmass
    actFuncList[31] = REGIST_FUNC(ai, goal, NPC_Ashford_Act31) -- Cast Spell (Slot 1) - Crystal Hail
    actFuncList[32] = REGIST_FUNC(ai, goal, NPC_Ashford_Act32) -- Cast Spell (Slot 2) - Crystal Soul Spear
    actFuncList[33] = REGIST_FUNC(ai, goal, NPC_Ashford_Act33) -- Cast Spell (Slot 3) - Twisted Wall of Light
    actFuncList[34] = REGIST_FUNC(ai, goal, NPC_Ashford_Act34) -- Cast Spell (Slot 4) - Old Moonlight
    
    Common_Battle_Activate(ai, goal, actChanceList, actFuncList, REGIST_FUNC(ai, goal, NPC_Ashford_ActAfter_AdjustSpace), actTblList)
    return 
end
...
function NPC_Ashford_Act01(self, ai, goal)
...
function NPC_Ashford_Act02(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
...
-- Kick + Approach
function NPC_Ashford_Act03(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
function NPC_Ashford_Act04(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
-- WA: Moonlight Vortex
function NPC_Ashford_Act05(self, ai, goal)
...
function NPC_Ashford_Act10(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
...
-- Backstep Roll
function NPC_Ashford_Act11(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_Ashford_Act12(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_Ashford_Act13(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
function NPC_Ashford_Act14(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Strafe
function NPC_Ashford_Act15(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
    local duration = 1.8
...
-- Backstep
function NPC_Ashford_Act16(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local duration = 1.8
...
-- Approach
function NPC_Ashford_Act17(self, ai, goal)
...
-- Cast Spell (Slot 0) - Crystal Soulmass
function NPC_Ashford_Act30(self, ai, goal)
    ...
    subgoal = subgoal:TimingSetTimer(0, self:GetRandam_Int(2, 3), UPDATE_SUCCESS)
...
-- Cast Spell (Slot 1) - Crystal Hail
function NPC_Ashford_Act31(self, ai, goal)
...
-- Cast Spell (Slot 2) - Crystal Soul Spear
function NPC_Ashford_Act32(self, ai, goal)
...
-- Cast Spell (Slot 3) - Twisted Wall of Light
function NPC_Ashford_Act33(self, ai, goal)
...
-- Cast Spell (Slot 4) - Old Moonlight
function NPC_Ashford_Act34(self, ai, goal)
    ...
    -- Randomise between normal and empowered
    if roll_b <= 50 then
        -- Cast Spell with Left Light Attack
        local subgoal = ai:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 1, NPC_ATK_L1, TARGET_ENE_0, 999, 0, 0)
        subgoal = subgoal:TimingSetTimer(2, self:GetRandam_Int(1, 2), UPDATE_SUCCESS)
...
-- Act After
-------------------------
function NPC_Ashford_ActAfter_AdjustSpace(self, ai, goal)
    return 
end
    ...
    elseif ai:IsInterupt(INTERUPT_FindAttack) then
        if distance < 1.8 and roll <= 80 then
            if roll <= 60 and 30 <= stamina then
                goal:ClearSubGoal()
                NPC_Ashford_Act15(ai, goal, paramTbl) -- Strafe
                return true
            elseif stamina <= 35 and 0 <= stamina then
                goal:ClearSubGoal()
                NPC_Ashford_Act12(ai, goal, paramTbl) -- Forward Roll + Run + Basic Light Attack
                return true
            end
        elseif distance <= 3 and 20 <= stamina and roll <= 60 then
            goal:ClearSubGoal()
            NPC_Ashford_Act10(ai, goal, paramTbl) -- Approach + Running Attack
            return true
        end
    -- Occurs if a ranged attack occurs
    elseif ai:IsInterupt(INTERUPT_Shoot) then
        goal:ClearSubGoal()
        NPC_Ashford_Act33(ai, goal, paramTbl)-- Cast Spell (Slot 3) - Twisted Wall of Light
        return true
    else
        return false
    end
