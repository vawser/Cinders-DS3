...
DS2pot10100Battle_Activate = function(ai, goal)
   local hprate = ai:GetHpRate(TARGET_SELF)
   DS2pot10100_Battle_Sword(ai, goal)
end

DS2pot10100_Gitai_Move = function(ai, goal)
   goal:AddSubGoal(GOAL_COMMON_ApproachTarget, 5, TARGET_ENE_0, 2, TARGET_ENE_0, false, -1)
end

DS2pot10100_Battle_Sword = function(ai, goal)
...
DS2pot10100_Battle_NormalR_Comb = function(ai, goal)
   local NR_fate = ai:GetRandam_Int(1, 100)
...
DS2pot10100_Battle_Kougeki_Noato = function(ai, goal)
...
DS2pot10100Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

DS2pot10100Battle_Terminate = function(ai, goal)
end

DS2pot10100Battle_Interupt = function(ai, goal)
   local targetDist = ai:GetDist(TARGET_ENE_0)
