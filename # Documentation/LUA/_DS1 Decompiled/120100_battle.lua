...
SmallInunezumi120100Battle_Activate = function(ai, goal)
...
SmallInunezumi120100Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

SmallInunezumi120100Battle_Terminate = function(ai, goal)
end

SmallInunezumi120100Battle_Interupt = function(ai, goal)
   local fate = ai:GetRandam_Int(1, 100)
   local fate2 = ai:GetRandam_Int(1, 100)
   local fate3 = ai:GetRandam_Int(1, 100)
   local targetDist = ai:GetDist(TARGET_ENE_0)
