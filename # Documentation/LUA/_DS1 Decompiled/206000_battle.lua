...
Ghoul_Sword206000Battle_Activate = function(ai, goal)
   local actPerArr = {}
   local actFuncArr = {}
...
Ghoul_Sword206000_Act05 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
...
Ghoul_Sword206000_Act06 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
   local fate = ai:GetRandam_Int(1, 100)
...
Ghoul_Sword206000_Act08 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
   local fate = ai:GetRandam_Int(1, 100)
...
Ghoul_Sword206000_Act10 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
   local fate = ai:GetRandam_Int(1, 100)
...
Ghoul_Sword206000Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

Ghoul_Sword206000Battle_Terminate = function(ai, goal)
end

Ghoul_Sword206000Battle_Interupt = function(ai, goal)
