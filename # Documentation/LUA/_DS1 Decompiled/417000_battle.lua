...
OnIf_417000 = function(ai, goal, codeNo)
   if codeNo == 0 then
      ai:SetTimer(0, 25)
   end
   if codeNo == 1 then
...
HumanityS417000Battle_Activate = function(ai, goal)
   local actPerArr = {}
   local actFuncArr = {}
...
HumanityS417000_Act01 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
...
HumanityS417000_Act03 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
...
HumanityS417000_Act04 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
...
HumanityS417000_Act05 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
...
HumanityS417000_Act06 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
...
HumanityS417000_Act07 = function(ai, goal, paramTbl)
...
HumanityS417000_Act08 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
...
HumanityS417000_Act09 = function(ai, goal, paramTbl)
...
HumanityS417000_Act10 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
   local AttDist = 3
   local fate = ai:GetRandam_Int(1, 100)
   local fate2 = ai:GetRandam_Int(1, 100)
...
HumanityS417000_Act11 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
   local AttDist = 8
   local fate = ai:GetRandam_Int(1, 100)
...
HumanityS417000_Act12 = function(ai, goal, paramTbl)
   local targetDist = ai:GetDist(TARGET_ENE_0)
   local hprate = ai:GetHpRate(TARGET_SELF)
   local AttDist = 20
   local fate = ai:GetRandam_Int(1, 100)
...
HumanityS417000_ActAfter = function(ai, goal)
...
HumanityS417000_ActAfter_AdjustSpace = function(ai, goal, paramTbl)
   goal:AddSubGoal(GOAL_COMMON_If, 10, 2)
end

HumanityS417000Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

HumanityS417000Battle_Terminate = function(ai, goal)
end

HumanityS417000Battle_Interupt = function(ai, goal)
   local fate = ai:GetRandam_Int(1, 100)
   local fate2 = ai:GetRandam_Int(1, 100)
