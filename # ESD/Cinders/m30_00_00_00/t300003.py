...
def t300003_x1(gesture1=17, z1=9019, flag3=6067):
    """State 0,1"""
...
def t300003_x2(actionbutton1=_, flag1=6001, flag2=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t300003_x3(action1=10010713):
    """State 0,1"""
...
def t300003_x5():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """State 3,15"""
        call = t300003_x2(actionbutton1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """State 7"""
            ...
            pass
    """State 14"""
    assert t300003_x2(actionbutton1=6101, flag1=6001, flag2=6000)
    """State 5"""
...
def t300003_x9():
    ...
    """State 21"""
    assert t300003_x1(gesture1=17, z1=9019, flag3=6067)
    """State 17"""
    MainBonfireMenuFlag()
    while True:
        """State 1"""
        ...
        if GetTalkListEntryResult() == 1:
            ...
            if GetEventStatus(2030) == 1:
                ...
                """State 16,20"""
                # action:10010713:"Game installation incomplete.\nCannot travel between bonfires."
                assert t300003_x3(action1=10010713)
        # Level Up
...
def t300003_x40():
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            """State 2"""
            assert (t300003_x41(lot1=80000, goods1=1070, z1=9, z2=-10, action1=99042000, action2=99043000,
                    action3=99040010))
            continue
        # Swift Soul Wave
        elif GetTalkListEntryResult() == 2:
            """State 3"""
            assert (t300003_x41(lot1=80010, goods1=1070, z1=9, z2=-10, action1=99042001, action2=99043001,
                    action3=99040010))
            continue
        # Explosive Soul Arrow
        elif GetTalkListEntryResult() == 3:
            """State 4"""
            assert (t300003_x41(lot1=80020, goods1=1070, z1=9, z2=-10, action1=99042002, action2=99043002,
                    action3=99040010))
            continue
        # Swift Soul Spear
        elif GetTalkListEntryResult() == 4:
            """State 5"""
            assert (t300003_x41(lot1=80030, goods1=1070, z1=14, z2=-15, action1=99042003, action2=99043003,
                    action3=99040011))
            continue
        # Homing Crystal Soul Spear
        elif GetTalkListEntryResult() == 5:
            """State 6"""
            assert (t300003_x41(lot1=80040, goods1=1070, z1=14, z2=-15, action1=99042004, action2=99043004,
                    action3=99040011))
            continue
        # Extended White Dragon Breath
        elif GetTalkListEntryResult() == 6:
            """State 7"""
            assert (t300003_x41(lot1=80050, goods1=1070, z1=14, z2=-15, action1=99042005, action2=99043005,
                    action3=99040011))
            continue
        # Bloodthirsty Flashsword
        elif GetTalkListEntryResult() == 7:
            """State 8"""
            assert (t300003_x41(lot1=80060, goods1=1070, z1=9, z2=-10, action1=99042006, action2=99043006,
                    action3=99040010))
            continue
        # Heavy Soul Greatsword
        elif GetTalkListEntryResult() == 8:
            """State 9"""
            assert (t300003_x41(lot1=80070, goods1=1070, z1=14, z2=-15, action1=99042007, action2=99043007,
                    action3=99040011))
            continue
        # Heavy Old Moonlight
        elif GetTalkListEntryResult() == 9:
            """State 10"""
            assert (t300003_x41(lot1=80080, goods1=1070, z1=14, z2=-15, action1=99042008, action2=99043008,
                    action3=99040011))
            continue
        # Surging Soulmass
        elif GetTalkListEntryResult() == 10:
            """State 11"""
            assert (t300003_x41(lot1=80090, goods1=1070, z1=19, z2=-20, action1=99042009, action2=99043009,
                    action3=99040012))
            continue
        # Weakening Crystal Soulmass
        elif GetTalkListEntryResult() == 11:
            """State 12"""
            assert (t300003_x41(lot1=80100, goods1=1070, z1=19, z2=-20, action1=99042010, action2=99043010,
                    action3=99040012))
            continue
        # Repeating Soul Orb
        elif GetTalkListEntryResult() == 12:
            """State 13"""
            assert (t300003_x41(lot1=80110, goods1=1070, z1=9, z2=-10, action1=99042011, action2=99043011,
                    action3=99040010))
            continue
        # Repeating Crystal Orb
        elif GetTalkListEntryResult() == 13:
            """State 14"""
            assert (t300003_x41(lot1=80120, goods1=1070, z1=14, z2=-15, action1=99042012, action2=99043012,
                    action3=99040011))
            continue
        # Farron Swarm
        elif GetTalkListEntryResult() == 14:
            """State 15"""
            assert (t300003_x41(lot1=80130, goods1=1070, z1=9, z2=-10, action1=99042013, action2=99043013,
                    action3=99040010))
            continue
        # Focused Crystal Hail
        elif GetTalkListEntryResult() == 15:
            """State 16"""
            assert (t300003_x41(lot1=80140, goods1=1070, z1=14, z2=-15, action1=99042014, action2=99043014,
                    action3=99040011))
            continue
        # Swift Orbs of Judgment
        elif GetTalkListEntryResult() == 16:
            """State 17"""
            assert (t300003_x41(lot1=80150, goods1=1070, z1=14, z2=-15, action1=99042015, action2=99043015,
                    action3=99040011))
            continue
        # Repeating Crystal Storm
        elif GetTalkListEntryResult() == 17:
            """State 18"""
            assert (t300003_x41(lot1=80160, goods1=1070, z1=14, z2=-15, action1=99042016, action2=99043016,
                    action3=99040011))
            continue
        # Repeating Blizzard
        elif GetTalkListEntryResult() == 18:
            """State 19"""
            assert (t300003_x41(lot1=80170, goods1=1070, z1=14, z2=-15, action1=99042017, action2=99043017,
                    action3=99040011))
            continue
        # Quickened Soul Stream
        elif GetTalkListEntryResult() == 19:
            """State 20"""
            assert (t300003_x41(lot1=80180, goods1=1070, z1=19, z2=-20, action1=99042018, action2=99043018,
                    action3=99040012))
            continue
        # Crystal Soul Geyser
        elif GetTalkListEntryResult() == 20:
            """State 21"""
            assert (t300003_x41(lot1=80190, goods1=1070, z1=19, z2=-20, action1=99042019, action2=99043019,
                    action3=99040012))
            continue
        # Lingering Pestilent Mist
        elif GetTalkListEntryResult() == 21:
            """State 22"""
            assert (t300003_x41(lot1=80200, goods1=1070, z1=14, z2=-15, action1=99042020, action2=99043020,
                    action3=99040011))
            continue
        # Lingering Snap Freeze
        elif GetTalkListEntryResult() == 22:
            """State 23"""
            assert (t300003_x41(lot1=80210, goods1=1070, z1=9, z2=-10, action1=99042021, action2=99043021,
                    action3=99040010))
            continue
        # Refined Shockwave
        elif GetTalkListEntryResult() == 23:
            """State 24"""
            assert (t300003_x41(lot1=80220, goods1=1070, z1=9, z2=-10, action1=99042022, action2=99043022,
                    action3=99040010))
            continue
        # Refined Blinding Light
        elif GetTalkListEntryResult() == 24:
            """State 25"""
            assert (t300003_x41(lot1=80230, goods1=1070, z1=9, z2=-10, action1=99042023, action2=99043023,
                    action3=99040010))
            continue
        # Impenetrable Wall of Light
        elif GetTalkListEntryResult() == 25:
            """State 26"""
            assert (t300003_x41(lot1=80240, goods1=1070, z1=9, z2=-10, action1=99042024, action2=99043024,
                    action3=99040010))
            continue
        # Refined Aural Decoy
        elif GetTalkListEntryResult() == 26:
            """State 27"""
            assert (t300003_x41(lot1=80250, goods1=1070, z1=9, z2=-10, action1=99042025, action2=99043025,
                    action3=99040010))
            continue
        # Skilled Repair
        elif GetTalkListEntryResult() == 27:
            """State 28"""
            assert (t300003_x41(lot1=80260, goods1=1070, z1=9, z2=-10, action1=99042026, action2=99043026,
                    action3=99040010))
            continue
        # Moonlight Weapon
        elif GetTalkListEntryResult() == 30:
            """State 29"""
            assert (t300003_x41(lot1=80290, goods1=1070, z1=14, z2=-15, action1=99042029, action2=99043029,
                    action3=99040011))
            continue
        # Supreme Frozen Weapon
        elif GetTalkListEntryResult() == 31:
            """State 30"""
            assert (t300003_x41(lot1=80300, goods1=1070, z1=9, z2=-10, action1=99042030, action2=99043030,
                    action3=99040010))
            continue
        # Refined Hidden Weapon
        elif GetTalkListEntryResult() == 32:
            """State 31"""
            assert (t300003_x41(lot1=80310, goods1=1070, z1=9, z2=-10, action1=99042031, action2=99043031,
                    action3=99040010))
            continue
        # Supreme Magic Shield
        elif GetTalkListEntryResult() == 34:
            """State 32"""
            assert (t300003_x41(lot1=80330, goods1=1070, z1=14, z2=-15, action1=99042033, action2=99043033,
                    action3=99040011))
            continue
        # Lingering Unleash Magic
        elif GetTalkListEntryResult() == 35:
            """State 33"""
            assert (t300003_x41(lot1=80340, goods1=1070, z1=14, z2=-15, action1=99042034, action2=99043034,
                    action3=99040011))
            continue
        # Mass Spook
        elif GetTalkListEntryResult() == 36:
            """State 34"""
            assert (t300003_x41(lot1=80350, goods1=1070, z1=9, z2=-10, action1=99042035, action2=99043035,
                    action3=99040010))
            continue
        # Mass Hidden Body
        elif GetTalkListEntryResult() == 37:
            """State 35"""
            assert (t300003_x41(lot1=80360, goods1=1070, z1=9, z2=-10, action1=99042036, action2=99043036,
                    action3=99040010))
            continue
        # Refined Chameleon
        elif GetTalkListEntryResult() == 38:
            """State 36"""
            assert (t300003_x41(lot1=80370, goods1=1070, z1=9, z2=-10, action1=99042037, action2=99043037,
                    action3=99040010))
            continue
        # Refined Cast Light
        elif GetTalkListEntryResult() == 39:
            """State 37"""
            assert (t300003_x41(lot1=80380, goods1=1070, z1=9, z2=-10, action1=99042038, action2=99043038,
                    action3=99040010))
            continue
        # Frigid Roar
        elif GetTalkListEntryResult() == 40:
            """State 38"""
            assert (t300003_x41(lot1=80390, goods1=1070, z1=9, z2=-10, action1=99042039, action2=99043039,
                    action3=99040010))
            continue
        # Lingering Hail of Blades
        elif GetTalkListEntryResult() == 41:
            """State 39"""
            assert (t300003_x41(lot1=80400, goods1=1070, z1=9, z2=-10, action1=99042040, action2=99043040,
                    action3=99040010))
            continue
        # Explosive Ice
        elif GetTalkListEntryResult() == 42:
            """State 40"""
            assert (t300003_x41(lot1=80410, goods1=1070, z1=9, z2=-10, action1=99042041, action2=99043041,
                    action3=99040011))
            continue
        # Chilling Rime
        elif GetTalkListEntryResult() == 43:
            """State 41"""
            assert (t300003_x41(lot1=80420, goods1=1070, z1=14, z2=-15, action1=99042042, action2=99043042,
                    action3=99040011))
            continue
        # Refined Path of Frost
        elif GetTalkListEntryResult() == 44:
            """State 42"""
            assert (t300003_x41(lot1=80430, goods1=1070, z1=9, z2=-10, action1=99042043, action2=99043043,
                    action3=99040010))
            continue
        # Quickened Discs of Dorthinus
        elif GetTalkListEntryResult() == 45:
            """State 43"""
            assert (t300003_x41(lot1=80440, goods1=1070, z1=14, z2=-15, action1=99042044, action2=99043044,
                    action3=99040011))
            continue
        # Refined Teleport
        elif GetTalkListEntryResult() == 46:
            """State 44"""
            assert (t300003_x41(lot1=80450, goods1=1070, z1=14, z2=-15, action1=99042045, action2=99043045,
                    action3=99040011))
            continue
        # Soul Explosion
        elif GetTalkListEntryResult() == 47:
            """State 45"""
            assert (t300003_x41(lot1=80460, goods1=1070, z1=9, z2=-10, action1=99042046, action2=99043046,
                    action3=99040010))
            continue
        # Explosive Crystal Orb
        elif GetTalkListEntryResult() == 48:
            """State 46"""
            assert (t300003_x41(lot1=80470, goods1=1070, z1=14, z2=-15, action1=99042047, action2=99043047,
                    action3=99040011))
            continue
        # Lingering Soul Instability
        elif GetTalkListEntryResult() == 49:
            """State 47"""
            assert (t300003_x41(lot1=80480, goods1=1070, z1=14, z2=-15, action1=99042048, action2=99043048,
                    action3=99040011))
            continue
        # Bloodthirsty Ice Burn
        elif GetTalkListEntryResult() == 50:
            """State 48"""
            assert (t300003_x41(lot1=80490, goods1=1070, z1=14, z2=-15, action1=99042049, action2=99043049,
                    action3=99040011))
            continue
        # Lingering Frigid Orbs
        elif GetTalkListEntryResult() == 51:
            """State 49"""
            assert (t300003_x41(lot1=80500, goods1=1070, z1=14, z2=-15, action1=99042050, action2=99043050,
                    action3=99040011))
            continue
        # Quickened Frozen Chaos
        elif GetTalkListEntryResult() == 52:
            """State 50"""
            assert (t300003_x41(lot1=80510, goods1=1070, z1=14, z2=-15, action1=99042051, action2=99043051,
                    action3=99040011))
            continue
        # Great Rupturing Frostfire
        elif GetTalkListEntryResult() == 53:
            """State 51"""
            assert (t300003_x41(lot1=80520, goods1=1070, z1=14, z2=-15, action1=99042052, action2=99043052,
                    action3=99040011))
            continue
        # Great Frostfire Volley
        elif GetTalkListEntryResult() == 54:
            assert (t300003_x41(lot1=80530, goods1=1070, z1=14, z2=-15, action1=99042053, action2=99043053,
                    action3=99040011))
            continue
...
def t300003_x41(lot1=_, goods1=1070, z1=_, z2=_, action1=_, action2=_, action3=_):
    """State 0"""
    call = t300003_x100(action1=action1)
    if call.Get() == 0:
        """State 1"""
        if ComparePlayerInventoryNumber(3, goods1, 3, z1, 0) == 1:
            """State 2"""
            assert t300003_x101(action3=action3)
        else:
            """State 3"""
            PlayerEquipmentQuantityChange(3, goods1, z2)
            GetItemFromItemLot(lot1)
            assert t300003_x101(action3=action2)
    elif call.Get() == 1:
        pass
    """State 4"""
    return 0
...
def t300003_x50():
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            """State 2"""
            assert (t300003_x51(lot1=81000, goods1=1060, z1=9, z2=-10, action1=99045000, action2=99046000,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 2:
            """State 3"""
            assert (t300003_x51(lot1=81010, goods1=1060, z1=9, z2=-10, action1=99045001, action2=99046001,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 3:
            """State 4"""
            assert (t300003_x51(lot1=81020, goods1=1060, z1=14, z2=-15, action1=99045002, action2=99046002,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 4:
            """State 5"""
            assert (t300003_x51(lot1=81030, goods1=1060, z1=9, z2=-10, action1=99045003, action2=99046003,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 5:
            """State 6"""
            assert (t300003_x51(lot1=81040, goods1=1060, z1=14, z2=-15, action1=99045004, action2=99046004,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 6:
            """State 7"""
            assert (t300003_x51(lot1=81050, goods1=1060, z1=14, z2=-15, action1=99045005, action2=99046005,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 7:
            """State 8"""
            assert (t300003_x51(lot1=81060, goods1=1060, z1=19, z2=-20, action1=99045006, action2=99046006,
                    action3=99040043))
            continue
        elif GetTalkListEntryResult() == 8:
            """State 9"""
            assert (t300003_x51(lot1=81070, goods1=1060, z1=9, z2=-10, action1=99045007, action2=99046007,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 9:
            """State 10"""
            assert (t300003_x51(lot1=81080, goods1=1060, z1=14, z2=-15, action1=99045008, action2=99046008,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 10:
            """State 11"""
            assert (t300003_x51(lot1=81090, goods1=1060, z1=9, z2=-10, action1=99045009, action2=99046009,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 11:
            """State 12"""
            assert (t300003_x51(lot1=81100, goods1=1060, z1=14, z2=-15, action1=99045010, action2=99046010,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 12:
            """State 13"""
            assert (t300003_x51(lot1=81110, goods1=1060, z1=9, z2=-10, action1=99045011, action2=99046011,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 13:
            """State 14"""
            assert (t300003_x51(lot1=81120, goods1=1060, z1=14, z2=-15, action1=99045012, action2=99046012,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 14:
            """State 15"""
            assert (t300003_x51(lot1=81130, goods1=1060, z1=14, z2=-15, action1=99045013, action2=99046013,
                    action3=99040041))
        elif GetTalkListEntryResult() == 15:
            """State 16"""
            assert (t300003_x51(lot1=81140, goods1=1060, z1=9, z2=-10, action1=99045014, action2=99046014,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 16:
            """State 17"""
            assert (t300003_x51(lot1=81150, goods1=1060, z1=14, z2=-15, action1=99045015, action2=99046015,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 17:
            """State 18"""
            assert (t300003_x51(lot1=81160, goods1=1060, z1=14, z2=-15, action1=99045016, action2=99046016,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 18:
            """State 19"""
            assert (t300003_x51(lot1=81170, goods1=1060, z1=19, z2=-20, action1=99045017, action2=99046017,
                    action3=99040043))
            continue
        elif GetTalkListEntryResult() == 19:
            """State 20"""
            assert (t300003_x51(lot1=81180, goods1=1060, z1=9, z2=-10, action1=99045018, action2=99046018,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 20:
            """State 21"""
            assert (t300003_x51(lot1=81190, goods1=1060, z1=14, z2=-15, action1=99045019, action2=99046019,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 21:
            """State 22"""
            assert (t300003_x51(lot1=81200, goods1=1060, z1=14, z2=-15, action1=99045020, action2=99046020,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 22:
            """State 23"""
            assert (t300003_x51(lot1=81210, goods1=1060, z1=14, z2=-15, action1=99045021, action2=99046021,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 23:
            """State 24"""
            assert (t300003_x51(lot1=81220, goods1=1060, z1=19, z2=-20, action1=99045022, action2=99046022,
                    action3=99040043))
            continue
        elif GetTalkListEntryResult() == 24:
            """State 25"""
            assert (t300003_x51(lot1=81230, goods1=1060, z1=9, z2=-10, action1=99045023, action2=99046023,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 25:
            """State 26"""
            assert (t300003_x51(lot1=81240, goods1=1060, z1=14, z2=-15, action1=99045024, action2=99046024,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 26:
            """State 27"""
            assert (t300003_x51(lot1=81250, goods1=1060, z1=14, z2=-15, action1=99045025, action2=99046025,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 27:
            """State 28"""
            assert (t300003_x51(lot1=81260, goods1=1060, z1=9, z2=-10, action1=99045026, action2=99046026,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 28:
            """State 29"""
            assert (t300003_x51(lot1=81270, goods1=1060, z1=14, z2=-15, action1=99045027, action2=99046027,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 29:
            """State 30"""
            assert (t300003_x51(lot1=81280, goods1=1060, z1=14, z2=-15, action1=99045028, action2=99046028,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 30:
            """State 31"""
            assert (t300003_x51(lot1=81290, goods1=1060, z1=14, z2=-15, action1=99045029, action2=99046029,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 31:
            """State 32"""
            assert (t300003_x51(lot1=81300, goods1=1060, z1=14, z2=-15, action1=99045030, action2=99046030,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 32:
            """State 33"""
            assert (t300003_x51(lot1=81310, goods1=1060, z1=14, z2=-15, action1=99045031, action2=99046031,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 33:
            """State 34"""
            assert (t300003_x51(lot1=81320, goods1=1060, z1=9, z2=-10, action1=99045032, action2=99046032,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 34:
            """State 35"""
            assert (t300003_x51(lot1=81330, goods1=1060, z1=9, z2=-10, action1=99045033, action2=99046033,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 35:
            """State 36"""
            assert (t300003_x51(lot1=81340, goods1=1060, z1=9, z2=-10, action1=99045034, action2=99046034,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 36:
            """State 37"""
            assert (t300003_x51(lot1=81350, goods1=1060, z1=9, z2=-10, action1=99045035, action2=99046035,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 37:
            """State 38"""
            assert (t300003_x51(lot1=81360, goods1=1060, z1=9, z2=-10, action1=99045036, action2=99046036,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 38:
            """State 39"""
            assert (t300003_x51(lot1=81370, goods1=1060, z1=9, z2=-10, action1=99045037, action2=99046037,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 39:
            """State 40"""
            assert (t300003_x51(lot1=81380, goods1=1060, z1=14, z2=-15, action1=99045038, action2=99046038,
                    action3=99040041))
            continue
        elif GetTalkListEntryResult() == 40:
            """State 41"""
            assert (t300003_x51(lot1=81390, goods1=1060, z1=9, z2=-10, action1=99045039, action2=99046039,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 41:
            """State 42"""
            assert (t300003_x51(lot1=81400, goods1=1060, z1=9, z2=-10, action1=99045040, action2=99046040,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 42:
            """State 43"""
            assert (t300003_x51(lot1=81410, goods1=1060, z1=9, z2=-10, action1=99045041, action2=99046041,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 43:
            """State 44"""
            assert (t300003_x51(lot1=81420, goods1=1060, z1=9, z2=-10, action1=99045042, action2=99046042,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 44:
            """State 45"""
            assert (t300003_x51(lot1=81430, goods1=1060, z1=9, z2=-10, action1=99045043, action2=99046043,
                    action3=99040040))
            continue
        elif GetTalkListEntryResult() == 99:
            """State 46"""
...
def t300003_x51(lot1=_, goods1=1060, z1=_, z2=_, action1=_, action2=_, action3=_):
    """State 0"""
    call = t300003_x100(action1=action1)
    if call.Get() == 0:
        """State 1"""
...
def t300003_x60():
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            """State 2"""
            assert (t300003_x61(lot1=82000, goods1=1090, z1=9, z2=-10, action1=99048000, action2=99049000,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 2:
            """State 3"""
            assert (t300003_x61(lot1=82010, goods1=1090, z1=9, z2=-10, action1=99048001, action2=99049001,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 3:
            """State 4"""
            assert (t300003_x61(lot1=82020, goods1=1090, z1=14, z2=-15, action1=99048002, action2=99049002,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 4:
            """State 5"""
            assert (t300003_x61(lot1=82030, goods1=1090, z1=14, z2=-15, action1=99048003, action2=99049003,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 5:
            """State 6"""
            assert (t300003_x61(lot1=82040, goods1=1090, z1=19, z2=-20, action1=99048004, action2=99049004,
                    action3=99040022))
            continue
        elif GetTalkListEntryResult() == 6:
            """State 7"""
            assert (t300003_x61(lot1=82050, goods1=1090, z1=9, z2=-10, action1=99048005, action2=99049005,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 7:
            """State 8"""
            assert (t300003_x61(lot1=82060, goods1=1090, z1=14, z2=-15, action1=99048006, action2=99049006,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 8:
            """State 9"""
            assert (t300003_x61(lot1=82070, goods1=1090, z1=14, z2=-15, action1=99048007, action2=99049007,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 9:
            """State 10"""
            assert (t300003_x61(lot1=82080, goods1=1090, z1=14, z2=-15, action1=99048008, action2=99049008,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 10:
            """State 11"""
            assert (t300003_x61(lot1=82090, goods1=1090, z1=19, z2=-20, action1=99048009, action2=99049009,
                    action3=99040022))
            continue
        elif GetTalkListEntryResult() == 11:
            """State 12"""
            assert (t300003_x61(lot1=82100, goods1=1090, z1=14, z2=-15, action1=99048010, action2=99049010,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 12:
            """State 13"""
            assert (t300003_x61(lot1=82110, goods1=1090, z1=9, z2=-10, action1=99048011, action2=99049011,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 13:
            """State 14"""
            assert (t300003_x61(lot1=82120, goods1=1090, z1=14, z2=-15, action1=99048012, action2=99049012,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 14:
            """State 15"""
            assert (t300003_x61(lot1=82130, goods1=1090, z1=9, z2=-10, action1=99048013, action2=99049013,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 15:
            """State 16"""
            assert (t300003_x61(lot1=82140, goods1=1090, z1=14, z2=-15, action1=99048014, action2=99049014,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 16:
            """State 17"""
            assert (t300003_x61(lot1=82150, goods1=1090, z1=9, z2=-10, action1=99048015, action2=99049015,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 17:
            """State 18"""
            assert (t300003_x61(lot1=82160, goods1=1090, z1=19, z2=-20, action1=99048016, action2=99049016,
                    action3=99040022))
            continue
        elif GetTalkListEntryResult() == 18:
            """State 19"""
            assert (t300003_x61(lot1=82170, goods1=1090, z1=14, z2=-15, action1=99048017, action2=99049017,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 19:
            """State 20"""
            assert (t300003_x61(lot1=82180, goods1=1090, z1=14, z2=-15, action1=99048018, action2=99049018,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 20:
            """State 21"""
            assert (t300003_x61(lot1=82190, goods1=1090, z1=19, z2=-20, action1=99048019, action2=99049019,
                    action3=99040022))
            continue
        elif GetTalkListEntryResult() == 21:
            """State 22"""
            assert (t300003_x61(lot1=82200, goods1=1090, z1=14, z2=-15, action1=99048020, action2=99049020,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 22:
            """State 23"""
            assert (t300003_x61(lot1=82210, goods1=1090, z1=14, z2=-15, action1=99048021, action2=99049021,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 23:
            """State 24"""
            assert (t300003_x61(lot1=82220, goods1=1090, z1=9, z2=-10, action1=99048022, action2=99049022,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 24:
            """State 25"""
            assert (t300003_x61(lot1=82230, goods1=1090, z1=9, z2=-10, action1=99048023, action2=99049023,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 25:
            """State 26"""
            assert (t300003_x61(lot1=82240, goods1=1090, z1=9, z2=-10, action1=99048024, action2=99049024,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 26:
            """State 27"""
            assert (t300003_x61(lot1=82250, goods1=1090, z1=9, z2=-10, action1=99048025, action2=99049025,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 27:
            """State 28"""
            assert (t300003_x61(lot1=82260, goods1=1090, z1=9, z2=-10, action1=99048026, action2=99049026,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 28:
            """State 29"""
            assert (t300003_x61(lot1=82270, goods1=1090, z1=9, z2=-10, action1=99048027, action2=99049027,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 29:
            """State 30"""
            assert (t300003_x61(lot1=82280, goods1=1090, z1=14, z2=-15, action1=99048028, action2=99049028,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 30:
            """State 31"""
            assert (t300003_x61(lot1=82290, goods1=1090, z1=14, z2=-15, action1=99048029, action2=99049029,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 31:
            """State 32"""
            assert (t300003_x61(lot1=82300, goods1=1090, z1=19, z2=-20, action1=99048030, action2=99049030,
                    action3=99040022))
            continue
        elif GetTalkListEntryResult() == 32:
            """State 33"""
            assert (t300003_x61(lot1=82310, goods1=1090, z1=9, z2=-10, action1=99048031, action2=99049031,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 33:
            """State 34"""
            assert (t300003_x61(lot1=82320, goods1=1090, z1=14, z2=-15, action1=99048032, action2=99049032,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 34:
            """State 35"""
            assert (t300003_x61(lot1=82330, goods1=1090, z1=14, z2=-15, action1=99048033, action2=99049033,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 35:
            """State 36"""
            assert (t300003_x61(lot1=82340, goods1=1090, z1=14, z2=-15, action1=99048034, action2=99049034,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 37:
            """State 37"""
            assert (t300003_x61(lot1=82360, goods1=1090, z1=14, z2=-15, action1=99048036, action2=99049036,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 38:
            """State 38"""
            assert (t300003_x61(lot1=82370, goods1=1090, z1=9, z2=-10, action1=99048037, action2=99049037,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 39:
            """State 39"""
            assert (t300003_x61(lot1=82380, goods1=1090, z1=14, z2=-15, action1=99048038, action2=99049038,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 40:
            """State 40"""
            assert (t300003_x61(lot1=82390, goods1=1090, z1=14, z2=-15, action1=99048039, action2=99049039,
                    action3=99040021))
            continue
        elif GetTalkListEntryResult() == 41:
            """State 41"""
            assert (t300003_x61(lot1=82400, goods1=1090, z1=9, z2=-10, action1=99048040, action2=99049040,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 42:
            """State 42"""
            assert (t300003_x61(lot1=82410, goods1=1090, z1=9, z2=-10, action1=99048041, action2=99049041,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 43:
            """State 43"""
            assert (t300003_x61(lot1=82420, goods1=1090, z1=9, z2=-10, action1=99048042, action2=99049042,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 44:
            """State 44"""
            assert (t300003_x61(lot1=82430, goods1=1090, z1=9, z2=-10, action1=99048043, action2=99049043,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 45:
            """State 45"""
            assert (t300003_x61(lot1=82440, goods1=1090, z1=9, z2=-10, action1=99048044, action2=99049044,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 46:
            """State 46"""
            assert (t300003_x61(lot1=82450, goods1=1090, z1=9, z2=-10, action1=99048045, action2=99049045,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 47:
            """State 47"""
            assert (t300003_x61(lot1=82460, goods1=1090, z1=9, z2=-10, action1=99048046, action2=99049046,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 48:
            """State 48"""
            assert (t300003_x61(lot1=82470, goods1=1090, z1=9, z2=-10, action1=99048047, action2=99049047,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 49:
            """State 49"""
            assert (t300003_x61(lot1=82480, goods1=1090, z1=9, z2=-10, action1=99048048, action2=99049048,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 50:
            """State 50"""
            assert (t300003_x61(lot1=82490, goods1=1090, z1=9, z2=-10, action1=99048049, action2=99049049,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 51:
            """State 51"""
            assert (t300003_x61(lot1=82500, goods1=1090, z1=9, z2=-10, action1=99048050, action2=99049050,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 52:
            """State 52"""
            assert (t300003_x61(lot1=82510, goods1=1090, z1=9, z2=-10, action1=99048051, action2=99049051,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 53:
            """State 53"""
            assert (t300003_x61(lot1=82520, goods1=1090, z1=9, z2=-10, action1=99048052, action2=99049052,
                    action3=99040020))
            continue
        elif GetTalkListEntryResult() == 99:
            """State 54"""
...
def t300003_x61(lot1=_, goods1=1090, z1=_, z2=_, action1=_, action2=_, action3=_):
    """State 0"""
    call = t300003_x100(action1=action1)
    if call.Get() == 0:
        """State 1"""
...
def t300003_x70():
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            """State 2"""
            assert (t300003_x71(lot1=83000, goods1=1080, z1=9, z2=-10, action1=99051000, action2=99052000,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 2:
            """State 3"""
            assert (t300003_x71(lot1=83010, goods1=1080, z1=9, z2=-10, action1=99051001, action2=99052001,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 3:
            """State 4"""
            assert (t300003_x71(lot1=83020, goods1=1080, z1=14, z2=-15, action1=99051002, action2=99052002,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 4:
            """State 5"""
            assert (t300003_x71(lot1=83030, goods1=1080, z1=19, z2=-20, action1=99051003, action2=99052003,
                    action3=99040032))
            continue
        elif GetTalkListEntryResult() == 5:
            """State 6"""
            assert (t300003_x71(lot1=83040, goods1=1080, z1=9, z2=-10, action1=99051004, action2=99052004,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 6:
            """State 7"""
            assert (t300003_x71(lot1=83050, goods1=1080, z1=19, z2=-20, action1=99051005, action2=99052005,
                    action3=99040032))
            continue
        elif GetTalkListEntryResult() == 7:
            """State 8"""
            assert (t300003_x71(lot1=83060, goods1=1080, z1=14, z2=-15, action1=99051006, action2=99052006,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 8:
            """State 9"""
            assert (t300003_x71(lot1=83070, goods1=1080, z1=9, z2=-10, action1=99051007, action2=99052007,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 9:
            """State 10"""
            assert (t300003_x71(lot1=83080, goods1=1080, z1=14, z2=-15, action1=99051008, action2=99052008,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 10:
            """State 11"""
            assert (t300003_x71(lot1=83090, goods1=1080, z1=19, z2=-20, action1=99051009, action2=99052009,
                    action3=99040032))
            continue
        elif GetTalkListEntryResult() == 11:
            """State 12"""
            assert (t300003_x71(lot1=83100, goods1=1080, z1=14, z2=-15, action1=99051010, action2=99052010,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 12:
            """State 13"""
            assert (t300003_x71(lot1=83110, goods1=1080, z1=9, z2=-10, action1=99051011, action2=99052011,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 13:
            """State 14"""
            assert (t300003_x71(lot1=83120, goods1=1080, z1=14, z2=-15, action1=99051012, action2=99052012,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 14:
            """State 15"""
            assert (t300003_x71(lot1=83130, goods1=1080, z1=14, z2=-15, action1=99051013, action2=99052013,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 15:
            """State 16"""
            assert (t300003_x71(lot1=83140, goods1=1080, z1=14, z2=-15, action1=99051014, action2=99052014,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 16:
            """State 17"""
            assert (t300003_x71(lot1=83150, goods1=1080, z1=14, z2=-15, action1=99051015, action2=99052015,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 17:
            """State 18"""
            assert (t300003_x71(lot1=83160, goods1=1080, z1=9, z2=-10, action1=99051016, action2=99052016,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 18:
            """State 19"""
            assert (t300003_x71(lot1=83170, goods1=1080, z1=19, z2=-20, action1=99051017, action2=99052017,
                    action3=99040032))
            continue
        elif GetTalkListEntryResult() == 19:
            """State 20"""
            assert (t300003_x71(lot1=83180, goods1=1080, z1=14, z2=-15, action1=99051018, action2=99052018,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 20:
            """State 21"""
            assert (t300003_x71(lot1=83190, goods1=1080, z1=14, z2=-15, action1=99051019, action2=99052019,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 21:
            """State 22"""
            assert (t300003_x71(lot1=83200, goods1=1080, z1=19, z2=-20, action1=99051020, action2=99052020,
                    action3=99040032))
            continue
        elif GetTalkListEntryResult() == 22:
            """State 23"""
            assert (t300003_x71(lot1=83210, goods1=1080, z1=14, z2=-15, action1=99051021, action2=99052021,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 23:
            """State 24"""
            assert (t300003_x71(lot1=83220, goods1=1080, z1=19, z2=-20, action1=99051022, action2=99052022,
                    action3=99040032))
            continue
        elif GetTalkListEntryResult() == 24:
            """State 25"""
            assert (t300003_x71(lot1=83230, goods1=1080, z1=9, z2=-10, action1=99051023, action2=99052023,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 25:
            """State 26"""
            assert (t300003_x71(lot1=83240, goods1=1080, z1=14, z2=-15, action1=99051024, action2=99052024,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 26:
            """State 27"""
            assert (t300003_x71(lot1=83250, goods1=1080, z1=14, z2=-15, action1=99051025, action2=99052025,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 27:
            """State 28"""
            assert (t300003_x71(lot1=83260, goods1=1080, z1=14, z2=-15, action1=99051026, action2=99052026,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 28:
            """State 29"""
            assert (t300003_x71(lot1=83270, goods1=1080, z1=14, z2=-15, action1=99051027, action2=99052027,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 29:
            """State 30"""
            assert (t300003_x71(lot1=83280, goods1=1080, z1=9, z2=-10, action1=99051028, action2=99052028,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 30:
            """State 31"""
            assert (t300003_x71(lot1=83290, goods1=1080, z1=9, z2=-10, action1=99051029, action2=99052029,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 31:
            """State 32"""
            assert (t300003_x71(lot1=83300, goods1=1080, z1=9, z2=-10, action1=99051030, action2=99052030,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 32:
            """State 33"""
            assert (t300003_x71(lot1=83310, goods1=1080, z1=9, z2=-10, action1=99051031, action2=99052031,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 33:
            """State 34"""
            assert (t300003_x71(lot1=83320, goods1=1080, z1=14, z2=-15, action1=99051032, action2=99052032,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 34:
            """State 35"""
            assert (t300003_x71(lot1=83330, goods1=1080, z1=14, z2=-15, action1=99051033, action2=99052033,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 35:
            """State 36"""
            assert (t300003_x71(lot1=83340, goods1=1080, z1=14, z2=-15, action1=99051034, action2=99052034,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 36:
            """State 37"""
            assert (t300003_x71(lot1=83350, goods1=1080, z1=14, z2=-15, action1=99051035, action2=99052035,
                    action3=99040031))
            continue
        elif GetTalkListEntryResult() == 37:
            """State 38"""
            assert (t300003_x71(lot1=83360, goods1=1080, z1=9, z2=-10, action1=99051036, action2=99052036,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 38:
            """State 39"""
            assert (t300003_x71(lot1=83370, goods1=1080, z1=9, z2=-10, action1=99051037, action2=99052037,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 39:
            """State 40"""
            assert (t300003_x71(lot1=83380, goods1=1080, z1=19, z2=-20, action1=99051038, action2=99052038,
                    action3=99040032))
            continue
        elif GetTalkListEntryResult() == 40:
            """State 41"""
            assert (t300003_x71(lot1=83390, goods1=1080, z1=9, z2=-10, action1=99051039, action2=99052039,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 41:
            """State 42"""
            assert (t300003_x71(lot1=83400, goods1=1080, z1=19, z2=-20, action1=99051040, action2=99052040,
                    action3=99040032))
            continue
        elif GetTalkListEntryResult() == 42:
            """State 43"""
            assert (t300003_x71(lot1=83410, goods1=1080, z1=19, z2=-20, action1=99051041, action2=99052041,
                    action3=99040032))
            continue
        elif GetTalkListEntryResult() == 43:
            """State 44"""
            assert (t300003_x71(lot1=83420, goods1=1080, z1=9, z2=-10, action1=99051042, action2=99052042,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 44:
            """State 45"""
            assert (t300003_x71(lot1=83430, goods1=1080, z1=9, z2=-10, action1=99051043, action2=99052043,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 45:
            """State 46"""
            assert (t300003_x71(lot1=83440, goods1=1080, z1=9, z2=-10, action1=99051044, action2=99052044,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 46:
            """State 47"""
            assert (t300003_x71(lot1=83450, goods1=1080, z1=9, z2=-10, action1=99051045, action2=99052045,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 47:
            """State 48"""
            assert (t300003_x71(lot1=83460, goods1=1080, z1=9, z2=-10, action1=99051046, action2=99052046,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 48:
            """State 49"""
            assert (t300003_x71(lot1=83470, goods1=1080, z1=9, z2=-10, action1=99051047, action2=99052047,
                    action3=99040030))
            continue
        elif GetTalkListEntryResult() == 99:
            """State 50"""
...
def t300003_x71(lot1=_, goods1=1080, z1=_, z2=_, action1=_, action2=_, action3=_):
    """State 0"""
    call = t300003_x100(action1=action1)
    if call.Get() == 0:
        """State 1"""
