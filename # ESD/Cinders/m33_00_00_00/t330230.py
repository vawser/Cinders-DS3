...
def t330230_x6(z2=10):
    ...
    if GetEventStatus(73300102) == 1:
        """State 3,27"""
        # talk:23000500:"Have you changed your mind?"
        assert t330230_x5(text1=23000500, flag1=0, mode1=0)
        """State 11"""
        Label('L0')
        ClearTalkListData()
        """State 12"""
        # action:14013002:"Make a promise"
        AddTalkListData(1, 14013002, -1)
        # action:14013003:"Make no promise"
        ...
        if ComparePlayerStatus(5, 1, z2) == 1:
            """State 25"""
            # talk:23000700:"Oh, I thought you'd already given up."
            assert t330230_x5(text1=23000700, flag1=0, mode1=1)
        else:
            """State 26"""
            # talk:23000800:"Well, well... There's something different about you, isn't there?"
        ...
        if GetTalkListEntryResult() == 1:
            ...
            if ComparePlayerStatus(5, 1, z2) == 1:
                """State 21"""
                # talk:23000600:"You'd better not. Sorcery is not for everyone."
                assert t330230_x4(text2=23000600, z3=73300101, flag2=0, mode2=1)
            else:
                Goto('L1')
        elif GetTalkListEntryResult() == 2:
            """State 20"""
            # talk:23000900:"Yes, I see."
            assert t330230_x4(text2=23000900, z3=73300100, flag2=0, mode2=1)
        else:
            pass
    else:
        """State 2,18"""
        # talk:23000000:"Well, this is unexpected. I don't often have visitors."
...
def t330230_x15():
    ...
    if not GetEventStatus(73300123):
        """State 5"""
        # talk:23001400:"What's the meaning of this?"
...
def t330230_x16():
    ...
    if not GetEventStatus(73300120):
        """State 3"""
        # talk:23001600:"Is that how it is?"
...
def t330230_x17():
    """State 0,1,2"""
    # talk:23001700:"Gods, this business never did agree with me..."
