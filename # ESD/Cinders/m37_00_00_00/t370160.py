...
def t370160_x0(action4=12006001):
    """State 0,1"""
...
def t370160_x1(actionbutton1=_, flag6=1095, flag7=6000, flag8=6000, flag9=6000, flag10=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t370160_x4(text5=_, z10=_, flag5=0, mode4=1):
    """State 0,5"""
...
def t370160_x5(text4=_, z9=73700102, flag4=0, mode3=1):
    """State 0,5"""
    assert t370160_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t370160_x6(text3=_, flag3=0, mode2=1):
    """State 0,4"""
    assert t370160_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t370160_x9(goods1=372, z8=12000005):
    """State 0,2"""
    ClearQuantityValueOfChooseQuantityDialog()
    """State 1"""
    OpenChooseQuantityDialog(goods1, z8)
    ...
    if GetEventStatus(1098) == 1:
        ...
        if GetDistanceToPlayer() < 10:
            ...
            if GetEventStatus(6750) == 1:
                ...
                call = t370160_x6(text3=16002300, flag3=0, mode2=1)
                if call.Done():
                    Goto('L0')
                elif GetDistanceToPlayer() > 12:
                    pass
                ...
                call = t370160_x6(text3=16001700, flag3=0, mode2=1)
                if call.Done():
                    Goto('L0')
                elif GetDistanceToPlayer() > 12:
                    pass
...
def t370160_x19():
    ...
    if not GetEventStatus(73700146):
        """State 5"""
        # talk:16001800:" "
        assert t370160_x4(text5=16001800, z10=73700146, flag5=0, mode4=1)
    elif not GetEventStatus(73700147):
        """State 6"""
        # talk:16001900:" "
        assert t370160_x4(text5=16001900, z10=73700147, flag5=0, mode4=1)
    elif not GetEventStatus(73700148):
        """State 7"""
        # talk:16002100:"Please, stop this!"
        assert t370160_x4(text5=16002100, z10=73700148, flag5=0, mode4=1)
        """State 3"""
        if GetEventStatus(6750) == 1:
            pass
        else:
        ...
        """State 8"""
        # talk:16002200:"Thou'rt no 1 knight!"
        assert t370160_x4(text5=16002200, z10=73700149, flag5=0, mode4=1)
        """State 2"""
        SetEventState(73700146, 0)
        SetEventState(73700147, 0)
        SetEventState(73700148, 0)
...
def t370160_x20():
    ...
    if not GetEventStatus(6751):
        ...
        assert t370160_x4(text5=16000000, z10=-1, flag5=0, mode4=1)
...
def t370160_x21():
    ...
    assert t370160_x6(text3=16000600, flag3=0, mode2=1)
    """State 2"""
    return 0
...
def t370160_x22():
    ...
    if not GetEventStatus(73700117):
        ...
        if GetEventStatus(73700102) == 1:
            ...
            assert t370160_x6(text3=16000300, flag3=0, mode2=1)
        else:
            """State 9"""
            # talk:16000000:"Name thyself, stranger."
            assert t370160_x6(text3=16000000, flag3=0, mode2=1)
        """State 5"""
        ClearTalkListData()
        """State 2"""
        ...
        if GetTalkListEntryResult() == 1:
            ...
            if not GetEventStatus(73700102):
                ...
                assert t370160_x5(text4=16000200, z9=73700102, flag4=0, mode3=1)
            else:
                """State 14"""
                # talk:16000310:"May the Darkmoon watch over thee."
                assert t370160_x5(text4=16000310, z9=73700102, flag4=0, mode3=1)
    ...
    assert t370160_x4(text5=16000120, z10=73700117, flag5=0, mode4=1)
    """State 12"""
...
def t370160_x23():
    """State 0,6"""
    # action:12006001:"Give <?gdsparam@2136?>?"
    call = t370160_x0(action4=12006001)
    if call.Get() == 0:
        """State 3"""
        # talk:16001200:"Oh, this is...my brother's...finger."
        assert t370160_x6(text3=16001200, flag3=0, mode2=1)
        """State 4"""
        # talk:16001300:"Oh, my thanks. I'm certain thou'st given my brother peace."
        assert t370160_x4(text5=16001300, z10=73700106, flag5=0, mode4=1)
        """State 5"""
        # lot:60640:Kukri
...
def t370160_x24():
    ...
    while True:
        ...
        if not GetEventStatus(73700130):
            ...
            assert t370160_x6(text3=16000700, flag3=0, mode2=1)
            """State 4"""
            SetEventState(73700130, 1)
        elif not GetEventStatus(73700131):
            """State 10"""
            # talk:16000800:"May I pose thee a question?"
            assert t370160_x6(text3=16000800, flag3=0, mode2=1)
            """State 7"""
            ClearTalkListData()
            """State 2"""
            ...
            if GetTalkListEntryResult() == 1:
                ...
                assert t370160_x6(text3=16000900, flag3=0, mode2=1)
                """State 5"""
                Label('L0')
                ...
                assert t370160_x6(text3=16001000, flag3=0, mode2=1)
                Goto('L0')
    ...
    assert t370160_x6(text3=16001100, flag3=0, mode2=1)
    """State 6"""
...
def t370160_x25():
    ...
    assert (t370160_x26(goods1=372, z1=12006000, z2=13006000, text2=16002400, text3=16002500, z3=16002550,
            z4=6751, flag2=6752, lot1=60610, lot2=60630, z5=99, z6=17, z7=24))
    """State 2"""
    return 0

def t370160_x26(goods1=372, z1=12006000, z2=13006000, text2=16002400, text3=16002500, z3=16002550, z4=6751,
                flag2=6752, lot1=60610, lot2=60630, z5=99, z6=17, z7=24):
    """State 0,1,11"""
    # goods:372:Proof of a Concord Kept
    if ComparePlayerInventoryNumber(3, goods1, 2, 0, 0) == 1:
        """State 12,9"""
        SetWorkValue(0, GetPlayerStatus(z7))
        """State 31"""
        call = t370160_x9(goods1=goods1, z8=12000005)
        if call.Get() == 0:
            """State 3"""
            ...
            """State 18"""
            ChangePlayerStats(z6, 0, GetValueFromNumberSelectDialog() * 1)
            """State 26"""
            ...
            if GetWorkValue(0) > 2:
                ...
                """State 17"""
                if ComparePlayerStatus(z7, 2, GetWorkValue(0)):
                    """State 7,28"""
                    # action:13000015:"Covenant allegiance deepened. Rank gained."
                    assert t370160_x8(action3=13000015)
                    """State 13"""
                    if ComparePlayerStatus(z7, 3, 1) == 1:
                        """State 20,37"""
                        assert t370160_x6(text3=text2, flag3=0, mode2=1)
                        """State 33"""
                        assert t370160_x7(lot1=lot1)
                        Goto('L0')
                    elif ComparePlayerStatus(z7, 3, 2) == 1:
                        """State 21"""
                        pass
                    else:
                        """State 22"""
                        if not GetEventStatus(flag2):
                            ...
                            Goto('L0')
                    """State 14,35"""
                    assert t370160_x6(text3=text3, flag3=0, mode2=1)
                    """State 34"""
            ...
            assert t370160_x8(action3=13000005)
        elif call.Get() == 1:
            """State 4"""
            pass
    else:
        ...
        assert t370160_x8(action3=13000035)
    """State 38"""
    Label('L0')
    return 0
...
def t370160_x27():
    ...
    if ComparePlayerStatus(24, 0, 1) == 1 and not GetEventStatus(6751):
        ...
        assert t370160_x6(text3=16002400, flag3=0, mode2=1)
        """State 6"""
        ...
        if ComparePlayerStatus(24, 4, 2) == 1 and not GetEventStatus(6752):
            ...
            assert t370160_x6(text3=16002500, flag3=0, mode2=1)
            """State 7"""
            ...
            assert t370160_x6(text3=16000500, flag3=0, mode2=1)
    """State 11"""
    return 0
...
def t370160_x29():
    ...
    if not GetEventStatus(6750):
        """State 2"""
        assert t370160_x1(actionbutton1=6160, flag6=1095, flag7=6000, flag8=6000, flag9=6000, flag10=6000)
    else:
        """State 3"""
        assert t370160_x1(actionbutton1=6161, flag6=1095, flag7=6000, flag8=6000, flag9=6000, flag10=6000)
    """State 4"""
    return 0
...
def t370160_x40(text1=_, flag1=0, mode1=0):
    """State 0,4"""
...
def t370160_x50():
    while True:
        ...
        # Form Covenant
        AddTalkListDataIf(not IsEquipmentIDObtained(2, 10000), 1, 15003019, -1)
        ...
        # Form Covenant
        if GetTalkListEntryResult() == 1:
            GetItemFromItemLot(800001160)
            return 0
        # View Inventory
        elif GetTalkListEntryResult() == 2:
            """State 3"""
            OpenTranspositionShop(21000, 21099)
        # Leave
...
def t370160_x51(action2=99062004):
    """State 0,1"""
