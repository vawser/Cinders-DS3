...
def t380500_x9():
    while True:
        ...
        # Propose Marriage
        AddTalkListDataIf(not GetEventStatus(25008090) and ComparePlayerInventoryNumber(3, 2000, 2, 0, 0) == 1,
                          10, 15015040, -1)
...
def t380500_x10(text1=_, flag1=0, mode1=0):
    """State 0,4"""
...
def t380500_x50(z1=_, z2=_, z3=_):
    """State 0,1"""
