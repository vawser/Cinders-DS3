...
def t400120_x4(text4=12002600, z7=74000115, flag3=0, mode3=1):
    """State 0,5"""
...
def t400120_x5(text3=_, z6=_, flag2=0, mode2=0):
    """State 0,5"""
    assert t400120_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t400120_x6(text2=_, flag1=0, mode1=_):
    """State 0,4"""
    assert t400120_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
    TalkToPlayer(text2, -1, -1, flag1)
    assert CheckSpecificPersonTalkHasEnded(0) == 1
    """State 3"""
    if not mode1:
        pass
...
def t400120_x8(goods1=2138, goods2=390, z1=2002, goods3=2000, z2=2016):
    """State 0,8"""
    MainBonfireMenuFlag()
    while True:
        """State 1"""
        ...
        if GetTalkListEntryResult() == 1:
            ...
            if GetEventStatus(2051) == 1 or IsMultiplayerInProgress() == 1:
                ...
                assert t400120_x6(text2=12000200, flag1=0, mode1=0)
                """State 11"""
                def WhilePaused():
                    SetTalkTime(0.1)
        ...
        # Propose Marriage
            ...
            assert t400120_x6(text2=10101030, flag1=0, mode1=0)
            continue
        # Flirt
            ...
            if GetEventStatus(25008900):
                """State 26"""
                assert t400120_x6(text2=10101000, flag1=0, mode1=0)
                """State 27"""
                GetItemFromItemLot(90010)
                continue
            elif GetEventStatus(25008901):
                """State 28"""
                assert t400120_x6(text2=10101010, flag1=0, mode1=0)
                continue
            elif GetEventStatus(25008902):
                """State 29"""
                assert t400120_x6(text2=10101020, flag1=0, mode1=0)
                continue
        # Divorce
        ...
        # Heal the Dark Sigil
            ...
            if GetEventStatus(2051) == 1 or IsMultiplayerInProgress() == 1:
                ...
                assert t400120_x23(goods4=490, z5=0)
                continue
        """State 12,20"""
...
def t400120_x9():
    ...
    if GetEventStatus(1002) == 1:
        ...
        if GetEventStatus(74000121) == 1:
            ...
            assert t400120_x6(text2=12003150, flag1=0, mode1=0)
            """State 6"""
            Label('L2')
            ...
            assert t400120_x6(text2=12002000, flag1=0, mode1=0)
        else:
            """State 13,21"""
            # talk:12002200:"Ashen one, if, when thou peerest upon the First Flame..."
            assert t400120_x6(text2=12002200, flag1=0, mode1=0)
        ...
        if GetEventStatus(74000121) == 1:
            ...
            assert t400120_x5(text3=12001300, z6=74000101, flag2=0, mode2=0)
        else:
            """State 10,18"""
            # talk:12001400:"Ashen one, with the Lords as thy witness, bend thy knee afore the bonfire's coiled sword."
            assert t400120_x6(text2=12001400, flag1=0, mode1=0)
    else:
        """State 2"""
        if GetEventStatus(74000121) == 1:
            """State 5,17"""
            # talk:12003100:"I'm truly sorry."
            assert t400120_x6(text2=12003100, flag1=0, mode1=0)
            Goto('L2')
        elif not GetEventStatus(74000100):
            """State 3,16"""
            # talk:12000000:"Welcome to the bonfire, Unkindled One."
            assert t400120_x5(text3=12000000, z6=74000100, flag2=0, mode2=0)
        else:
            """State 4"""
            if not GetEventStatus(131):
                ...
                assert t400120_x6(text2=12003200, flag1=0, mode1=0)
            else:
                """State 15"""
                # talk:12000100:"Welcome home, ashen one."
                assert t400120_x6(text2=12000100, flag1=0, mode1=0)
    """State 14"""
    # goods:2138:Eyes of a Fire Keeper, goods:390:Fire Keeper Soul
    assert t400120_x8(goods1=2138, goods2=390, z1=2002, goods3=2000, z2=2016)
    """State 24"""
    return 0
    """Unused"""
    """State 25"""
    ...
    if GetEventStatus(1018) == 1:
        ...
        if GetDistanceToPlayer() < 10:
            ...
            if GetEventStatus(50006020) == 1:
                """State 6,9"""
                # talk:12002900:" "
                call = t400120_x6(text2=12002900, flag1=0, mode1=1)
                if call.Done():
                    Goto('L0')
                elif GetDistanceToPlayer() > 12:
                    pass
                ...
                """State 7,10"""
                # talk:12002950:" "
                call = t400120_x6(text2=12002950, flag1=0, mode1=1)
                if call.Done():
                    Goto('L0')
                elif GetDistanceToPlayer() > 12:
                    pass
...
def t400120_x18():
    ...
    if not GetEventStatus(74000115):
        """State 2,5"""
        # talk:12002600:" "
        assert t400120_x4(text4=12002600, z7=74000115, flag3=0, mode3=1)
    else:
        """State 3,6"""
        # talk:12002700:" "
        assert t400120_x6(text2=12002700, flag1=0, mode1=1)
        """State 4"""
...
def t400120_x19():
    ...
    if GetEventStatus(1002) == 1:
        ...
        if GetEventStatus(50006020) == 1:
            ...
            assert t400120_x6(text2=12002100, flag1=0, mode1=1)
        else:
            """State 7,11"""
            # talk:12002300:"Mayst thou thy peace discov'r."
            assert t400120_x6(text2=12002300, flag1=0, mode1=1)
    else:
        """State 2"""
        if GetEventStatus(50006020) == 1:
            """State 3,8"""
            # talk:12000400:"Farewell, ashen one."
            assert t400120_x6(text2=12000400, flag1=0, mode1=1)
        else:
            """State 4,9"""
            # talk:12000500:"Farewell, ashen one."
            assert t400120_x6(text2=12000500, flag1=0, mode1=1)
    """State 12"""
    return 0
...
def t400120_x20():
    ...
    if GetEventStatus(50006020) == 1:
        ...
        if GetEventStatus(9300) == 1 and not GetEventStatus(1002):
            ...
            assert t400120_x6(text2=12000700, flag1=0, mode1=0)
        else:
            """State 3,19"""
            # talk:12000600:"Ashen one, to be unkindled is to be a vessel for souls."
            assert t400120_x6(text2=12000600, flag1=0, mode1=0)
    else:
        """State 5"""
        if not GetEventStatus(74000130) and not GetEventStatus(74000131):
            ...
            assert (t400120_x6(text2=12000800, flag1=0, mode1=0) and (not CheckSpecificPersonGenericDialogIsOpen(2)
            ...
            if GetTalkListEntryResult() == 1:
                ...
                assert t400120_x5(text3=12000900, z6=74000130, flag2=0, mode2=0)
            elif GetTalkListEntryResult() == 2:
                """State 16,25"""
                # talk:12001100:"Of course not."
                assert t400120_x5(text3=12001100, z6=74000131, flag2=0, mode2=0)
            else:
                """State 18"""
                pass
        else:
            ...
            if GetEventStatus(74000130) == 1:
                ...
                if not GetEventStatus(74000132) or GetEventStatus(74000110) == 1:
                    ...
                    assert t400120_x6(text2=12001000, flag1=0, mode1=0)
                else:
                    """State 11,26"""
                    # talk:12001900:"Ashen one, forgive me if this soundeth strange."
                    assert t400120_x5(text3=12001900, z6=74000110, flag2=0, mode2=0)
            else:
                """State 9,22"""
                # talk:12001200:"Ashen one, kill me, and take these eyes away."
                assert t400120_x6(text2=12001200, flag1=0, mode1=0)
    """State 27"""
    return 0
...
def t400120_x21(goods1=2138):
    ...
    if call.Get() == 0:
        ...
        assert t400120_x6(text2=12003300, flag1=0, mode1=0)
    elif call.Done():
        """State 4"""
        pass
    """State 8"""
...
def t400120_x22(goods5=390):
    ...
    if call.Get() == 0:
        ...
        assert (t400120_x6(text2=12003400, flag1=0, mode1=0) and (not CheckSpecificPersonGenericDialogIsOpen(2)
                and not (CheckSpecificPersonMenuIsOpen(-1, 2) == 1 and not CheckSpecificPersonGenericDialogIsOpen(2))))
        """State 7"""
        ...
        assert t400120_x6(text2=12003500, flag1=0, mode1=0)
    elif call.Done():
        """State 4"""
        pass
    """State 9"""
...
def t400120_x23(goods4=490, z5=0):
    """State 0,1"""
    # goods:490:Dark Sigil
    if ComparePlayerInventoryNumber(3, goods4, 0, 0, 0) == 1:
        """State 3,20"""
        # action:13002021:"You have no dark sigil"
        assert t400120_x7(action1=13002021)
    else:
        """State 2,24"""
        assert t400120_x24(goods4=goods4, z5=z5)
        """State 10"""
        SetMessageTagValue(0, GetLevelUpSoulCost(GetStatus(33), GetStatus(33) + GetWorkValue(z5)))
        """State 21"""
        # action:12002002:"Requires <?evntAcquittalPrice?> souls. \nWill you choose to heal the dark sigil?"
        call = t400120_x0(action2=12002002)
        if call.Get() == 0:
            """State 6"""
            if ComparePlayerStatus(8, 2, GetLevelUpSoulCost(GetStatus(33), GetStatus(33) + GetWorkValue(z5))):
                """State 4,13"""
                ...
                """State 8"""
                # goods:490:Dark Sigil
                PlayerEquipmentQuantityChange(3, goods4, -1 * GetWorkValue(z5))
                """State 9"""
                ChangePlayerStats(8, 1, GetLevelUpSoulCost(GetStatus(33), GetStatus(33) + GetWorkValue(z5)))
                """State 11"""
...
def t400120_x24(goods4=490, z5=0):
    """State 0,1"""
    # goods:490:Dark Sigil
    SetWorkValue(z5, GetItemHeldNumLimit(3, goods4))
    while True:
        """State 5"""
        # goods:490:Dark Sigil
        if ComparePlayerInventoryNumber(3, goods4, 0, GetWorkValue(z5), 0) or GetWorkValue(z5) <= 0:
            break
        else:
            """State 3,2"""
...
def t400120_x27(z4=_):
    """State 0,1"""
    OpenGenericDialog(8, z4, 1, 0, 1)
    assert not CheckSpecificPersonGenericDialogIsOpen(0)
    """State 2"""
    if GetGenericDialogButtonResult() == 1:
        """State 3"""
...
def t400120_x28(z3=_):
    """State 0,1"""
    OpenGenericDialog(8, z3, 1, 0, 1)
    assert not CheckSpecificPersonGenericDialogIsOpen(0)
    """State 2"""
    if GetGenericDialogButtonResult() == 1:
        """State 3"""
...
def t400120_x29(text1=12003600):
    """State 0,4"""
    assert t400120_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
