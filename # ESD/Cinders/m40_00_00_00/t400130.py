...
def t400130_x4(text3=_, z8=_, flag3=0, mode3=1):
    """State 0,5"""
...
def t400130_x5(text2=_, z7=_, flag2=0, mode2=1):
    """State 0,5"""
    assert t400130_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t400130_x6(text1=_, flag1=0, mode1=_):
    """State 0,4"""
    assert t400130_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t400130_x10(z3=2135, z4=390, weapon1=6260000, weapon2=6280000):
    """State 0,9"""
    MainBonfireMenuFlag()
    while True:
        """State 1"""
        ...
        AddTalkListDataIf(GetEventStatus(74000171) == 1 and GetEventStatus(74000182) == 1,
                          3, 15003002, -1)
        AddTalkListDataIf(not GetEventStatus(25008100) and ComparePlayerInventoryNumber(3, 2000, 2, 0, 0) == 1,
                          10, 15015040, -1)
        ...
        if GetTalkListEntryResult() == 1:
            ...
            """State 7,13"""
            assert t400130_x24(z4=z4)
            """State 16"""
            return 0

def t400130_x11(z3=2135, z4=390, goods1=2138):
    """State 0,1,2"""
    if not GetEventStatus(74000150):
        """State 3,21"""
        # talk:13000000:"Oh, thou'rt unkindled, and a seeker of Lords."
        assert t400130_x4(text3=13000000, z8=74000150, flag3=0, mode3=1)
    else:
        """State 4"""
        if GetEventStatus(74000170) == 1:
            ...
            elif not GetEventStatus(74000151) and ComparePlayerInventoryNumber(3, goods1, 2, 0, 0) == 1:
                """State 15,29"""
                # talk:13001720:"Ahh, found her, did we?"
                assert t400130_x5(text2=13001720, z7=74000151, flag2=0, mode2=1)
            else:
                """State 14"""
                if not GetEventStatus(74000171):
                    """State 11,26"""
    ...
    assert t400130_x10(z3=z3, z4=z4, weapon1=6260000, weapon2=6280000)
    """State 34"""
    return 0
...
def t400130_x12():
    ...
    if GetDistanceToPlayer() < 10:
        ...
        if not GetEventStatus(74000165):
            """State 3,9"""
            # talk:13001300:" "
            call = t400130_x4(text3=13001300, z8=74000165, flag3=0, mode3=1)
            if call.Done():
                pass
            ...
            """State 12"""
            # talk:13001400:" "
            call = t400130_x4(text3=13001400, z8=74000166, flag3=0, mode3=1)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 12:
                """State 13"""
...
def t400130_x15(z4=390):
    """State 0,1"""
    if (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonMenuIsOpen(12, 0) and not
        CheckSpecificPersonGenericDialogIsOpen(0)):
        """State 2,5"""
        call = t400130_x24(z4=z4)
        if call.Done():
            pass
        elif GetDistanceToPlayer() > 12:
            """State 4"""
...
def t400130_x16():
    ...
    if not GetEventStatus(9308):
        ...
        assert t400130_x4(text3=13001200, z8=74000160, flag3=0, mode3=1)
    else:
        """State 2,4"""
        # talk:13001100:"See ye not? I am a Lord..."
        assert t400130_x4(text3=13001100, z8=74000160, flag3=0, mode3=1)
    """State 6"""
    return 0
...
def t400130_x17():
    ...
    while True:
        """State 1"""
        # goods:2138:Eyes of a Fire Keeper
        call = t400130_x19(z3=2135, z4=390, goods1=2138)
...
def t400130_x19(z3=2135, z4=390, goods1=2138):
    """State 0,1"""
    call = t400130_x26(z3=z3, z4=z4, goods1=goods1)
...
def t400130_x21(weapon1=6260000, weapon2=6280000):
    ...
    if GetEventStatus(74000171) == 1 and not GetEventStatus(74000153) and GetEventStatus(74000182) == 1:
        ...
        assert t400130_x5(text2=13002500, z7=74000153, flag2=0, mode2=1)
    else:
        """State 8,6"""
        if not GetEventStatus(54000280):
            ...
            if not GetEventStatus(9307):
                ...
                if GetEventStatus(132) == 1 and not GetEventStatus(74000171):
                    ...
                    assert t400130_x5(text2=13000700, z7=74000155, flag2=0, mode2=1)
            else:
                """State 3,12"""
...
def t400130_x22(z5=_):
    ...
    if call.Get() == 0:
        ...
        """State 3"""
        PlayerEquipmentQuantityChange(3, z5, -1)
        """State 6"""
...
def t400130_x26(z3=2135, z4=390, goods1=2138):
    """State 0"""
    while True:
        """State 6"""
        call = t400130_x23()
        if call.Done():
            """State 3"""
            call = t400130_x11(z3=z3, z4=z4, goods1=goods1)
            if call.Done():
                pass
...
def t400130_x32(z2=_):
    """State 0,1"""
    OpenGenericDialog(8, z2, 3, 4, 2)
    assert not CheckSpecificPersonGenericDialogIsOpen(0)
    """State 2"""
    if GetGenericDialogButtonResult() == 1:
        """State 3"""
