...
def t400200_x1(actionbutton1=6000, flag6=1175, flag7=1176, flag8=6000, flag9=6000, flag10=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t400200_x4(text3=_, z6=_, flag5=0, mode3=1):
    """State 0,5"""
...
def t400200_x5(text2=_, z5=_, flag4=0, mode2=1):
    """State 0,5"""
    assert t400200_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t400200_x6(text1=_, flag3=0, mode1=_):
    """State 0,4"""
    assert t400200_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t400200_x8(gesture2=12, z4=9002, flag2=6062):
    """State 0,1"""
...
def t400200_x11(goods1=2103, goods2=2104, goods3=2105, goods4=2106, goods5=150, goods6=2141, val1=10,
                z2=2172):
    """State 0,18"""
    MainBonfireMenuFlag()
    while True:
        ...
        # Propose Marriage
        AddTalkListDataIf(not GetEventStatus(25008130) and ComparePlayerInventoryNumber(3, 2000, 2, 0, 0) == 1,
                          30, 15015040, -1)
        ...
        # Repair Equipment
            ...
            """State 30,31"""
            assert t400200_x27(gesture1=24, z3=9025, flag1=6074)
            ...
            assert t400200_x6(text1=10111030, flag3=0, mode1=0)
        elif GetTalkListEntryResult() == 31:
            """State 35"""
            if GetEventStatus(25008900):
                """State 36"""
                assert t400200_x6(text1=10111000, flag3=0, mode1=0)
                """State 37"""
                GetItemFromItemLot(90120)
            elif GetEventStatus(25008901):
                """State 38"""
                assert t400200_x6(text1=10111010, flag3=0, mode1=0)
            elif GetEventStatus(25008902):
                """State 39"""
                assert t400200_x6(text1=10111020, flag3=0, mode1=0)
            ...
            assert t400200_x6(text1=20000500, flag3=0, mode1=1)
            """State 28"""
            return 0
...
def t400200_x12():
    ...
    if GetEventStatus(1175) == 1:
        ...
        if not GetEventStatus(74000200):
            ...
            assert t400200_x5(text2=20000000, z5=74000200, flag4=0, mode2=1)
            ...
            if not GetEventStatus(50006100):
                ...
                assert t400200_x6(text1=20001200, flag3=0, mode1=1)
                """State 14"""
                # lot:61000:Hawkwood's Swordgrass
            ...
            assert t400200_x5(text2=20001250, z5=74000210, flag4=0, mode2=1)
        else:
            """State 4,10"""
            # talk:20000100:"Ahh, well met."
            assert t400200_x6(text1=20000100, flag3=0, mode1=1)
        """State 9"""
        ...
        assert t400200_x6(text1=20001700, flag3=0, mode1=1)
    """State 16"""
    return 0
...
def t400200_x13():
    ...
    if GetDistanceToPlayer() < 10:
        ...
        if not GetEventStatus(74000214):
            """State 6,14"""
            # talk:20001300:" "
            call = t400200_x4(text3=20001300, z6=74000214, flag5=0, mode3=1)
            if call.Done():
                pass
            ...
            """State 7,15"""
            # talk:20001400:" "
            call = t400200_x4(text3=20001400, z6=74000215, flag5=0, mode3=1)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 12:
                """State 11"""
            ...
            call = t400200_x6(text1=20001500, flag3=0, mode1=1)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 12:
                """State 12"""
...
def t400200_x14():
    ...
    if GetEventStatus(1178) == 1:
        ...
        if GetDistanceToPlayer() < 10:
            """State 4,7"""
            # talk:20001600:" "
            call = t400200_x6(text1=20001600, flag3=0, mode1=1)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 12:
                """State 6"""
...
def t400200_x16():
    ...
    if CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0):
        """State 2,5"""
        # talk:20000500:"Prithee, be careful."
        call = t400200_x6(text1=20000500, flag3=0, mode1=1)
        if call.Done():
            pass
        elif GetDistanceToPlayer() > 12:
            """State 4"""
...
def t400200_x19(goods1=2103, goods2=2104, goods3=2105, goods4=2106):
    ...
    if GetTalkListEntryResult() == 10:
        ...
        assert t400200_x6(text1=20000900, flag3=0, mode1=1)
    elif GetTalkListEntryResult() == 11:
        """State 4,10"""
        SetEventState(301, 1)
        """State 11"""
        ...
        assert t400200_x6(text1=20001900, flag3=0, mode1=1)
    elif GetTalkListEntryResult() == 12:
        """State 5,12"""
        SetEventState(302, 1)
        """State 13"""
        ...
        assert t400200_x6(text1=20001000, flag3=0, mode1=1)
    elif GetTalkListEntryResult() == 13:
        """State 6,14"""
        SetEventState(303, 1)
        """State 15"""
        ...
        assert t400200_x6(text1=20001100, flag3=0, mode1=1)
...
def t400200_x20():
    ...
    if GetEventStatus(300) == 1 and GetEventStatus(301) == 1 and GetEventStatus(302) == 1:
        ...
        if not GetEventStatus(74000205):
            ...
            assert t400200_x5(text2=20000600, z5=74000205, flag4=0, mode2=1)
        elif not GetEventStatus(74000206):
            """State 5,21"""
            # talk:20000700:"There are two ways to smith weapons."
            assert t400200_x5(text2=20000700, z5=74000206, flag4=0, mode2=1)
            """State 23"""
            assert t400200_x8(gesture2=12, z4=9002, flag2=6062)
        else:
            """State 15,20"""
            # talk:20001800:"Oh, by the by."
            assert t400200_x6(text1=20001800, flag3=0, mode1=1)
            """State 14"""
        ...
        if not GetEventStatus(74000205):
            ...
            assert t400200_x5(text2=20000800, z5=74000207, flag4=0, mode2=1)
        else:
            """State 9,19"""
            # talk:20001800:"Oh, by the by."
            assert t400200_x6(text1=20001800, flag3=0, mode1=1)
...
def t400200_x26():
    ...
    while True:
        """State 5"""
        call = t400200_x1(actionbutton1=6000, flag6=1175, flag7=1176, flag8=6000, flag9=6000, flag10=6000)
        if call.Done():
            """State 3"""
            call = t400200_x12()
            if call.Done():
...
def t400200_x27(gesture1=24, z3=9025, flag1=6074):
    """State 0,1"""
...
def t400200_x28(z1=_):
    """State 0,1"""
    OpenGenericDialog(7, z1, 1, 0, 1)
    assert not CheckSpecificPersonGenericDialogIsOpen(0)
    """State 2"""
    return 0
