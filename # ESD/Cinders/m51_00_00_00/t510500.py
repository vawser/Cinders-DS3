...
def t510500_x9():
    ...
    # Browse Wares
    AddTalkListDataIf(GetEventStatus(25000070) == 1, 1, 15000600, -1)
    # Browse Wares
    AddTalkListDataIf(GetEventStatus(25000071) == 1, 2, 15000600, -1)
    # Browse Wares
    AddTalkListDataIf(GetEventStatus(25000072) == 1, 3, 15000600, -1)
    # Browse Wares
    AddTalkListDataIf(GetEventStatus(25000073) == 1, 4, 15000600, -1)
    # Browse Wares
    AddTalkListDataIf(GetEventStatus(25000074) == 1, 5, 15000600, -1)
