...
# Parts
#----------------------------------------
To save space, the low detail parts are not included in the download by default.
Instead, you can generate them locally with a small C# application.

1. Run the SetupCinders.exe
2. Select the folder you have placed the Cinders folders and files in.
3. Press Setup.

All of the low detail parts (_l.partsbnd.dcx) will be have been created from the regular parts.