...
// <speffect>, <spawn point>, <warp id>, <map id>, <block id>, <ceremony id>
//----------------------------------------------
Event(20090301, Restart, function(X0_4, X4_4, X8_4, X12_1) {
    IfCharacterHasSpeffect(AND_01, 10000, X0_4, true, ComparisonType.Equal, 1);
    IfConditionGroup(MAIN, PASS, AND_01);

    SetPlayerRespawnPoint(X4_4);
    SetMapCeremony(X12_1, 1, 0);
    
    WaitFixedTimeFrames(1);
    SaveRequest(0);
    WaitFixedTimeFrames(1);
    
    WarpPlayer(X12_1, 1, X8_4);
});

//----------------------------------------------
// Boss Warp - Dark Firelink
// <speffect>, <spawn point>, <warp id>, <map id>, <block id>, <ceremony id>
//----------------------------------------------
Event(20090302, Restart, function(X0_4, X4_4, X8_4, X12_1) {
    IfCharacterHasSpeffect(AND_01, 10000, X0_4, true, ComparisonType.Equal, 1);
    IfConditionGroup(MAIN, PASS, AND_01);

    SetPlayerRespawnPoint(X4_4);
    SetMapCeremony(X12_1, 0, 10);
