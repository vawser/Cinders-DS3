...
Goal.Activate = function (goal, ai, arg2)
    ...
    elseif ai:HasSpecialEffectId(TARGET_SELF, 130201500) and not ai:IsBothHandMode(TARGET_SELF) then
    ...
    actFuncList[1] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act01)
    actFuncList[2] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act02)
    actFuncList[3] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act03)
    actFuncList[4] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act04)
    actFuncList[5] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act05)
    actFuncList[6] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act06)
    actFuncList[19] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act19)
    actFuncList[20] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act20)
    actFuncList[21] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act21)
    actFuncList[22] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act22)
    actFuncList[23] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act23)
    actFuncList[24] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act24)
    actFuncList[25] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act25)
    actFuncList[40] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act40)
    actFuncList[41] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act41)
    actFuncList[42] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act42)
    actFuncList[43] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act43)
    actFuncList[44] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act44)
    actFuncList[45] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act45)
    actFuncList[46] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act46)
    actFuncList[47] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act47)
    actFuncList[48] = REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_Act48)
    Common_Battle_Activate(ai, arg2, actChanceList, actFuncList, REGIST_FUNC(ai, arg2, NPC_SnakeShaman_Minion1_ActAfter_AdjustSpace), actTblList)
    return 
end
