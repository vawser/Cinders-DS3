RegisterTableGoal(GOAL_DragonGuardianKnight_316010, "GOAL_DragonGuardianKnight_316010")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_DragonGuardianKnight_316010, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act03)
    local1[4] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act04)
    local1[5] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act05)
    local1[6] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act06)
    local1[7] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act07)
    local1[8] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act08)
    local1[9] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act09)
    local1[10] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act10)
    local1[11] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act11)
    local1[20] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act20)
    local1[21] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act21)
    local1[22] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act22)
    local1[23] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act23)
    local1[24] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act24)
    local1[25] = REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_Act25)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, DragonGuardianKnight_316010_ActAfter_AdjustSpace), local2)
    return 
end

function DragonGuardianKnight_316010_Act01(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 8, 8 + 2, 8 + 2, 0, 100, 2, 2)
    local local0 = 3000
    local local1 = 3017
    local local2 = 3025
    local local3 = 2.24
    local local4 = ATT3025_DIST_MAX
    local local5 = 999
    local local6 = 0
    local local7 = 0
...
function DragonGuardianKnight_316010_Act02(arg0, arg1, arg2)
    local local0 = 4.54
    local local1 = 4.54 + 2
    local local2 = 4.54 + 2
    local local3 = 0
...
function DragonGuardianKnight_316010_Act03(arg0, arg1, arg2)
...
function DragonGuardianKnight_316010_Act07(arg0, arg1, arg2)
    arg0:SetTimer(1, 20)
    local local0 = arg0:GetDist(TARGET_ENE_0)
        ...
        for local12 = 1 - local11, 4, local11 do
            ...
            if arg0:GetRandam_Int(0, local6) <= local7 then
                if local12 ~= 1 then
                    ...
                    arg1:AddSubGoal(GOAL_DragonGuardianKnight_316010_AttackStance, 10)
                    GetWellSpace_Odds = 100
                    return GetWellSpace_Odds
                end
            end
...
function DragonGuardianKnight_316010_Act08(arg0, arg1, arg2)
...
function DragonGuardianKnight_316010_Act09(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3021, TARGET_ENE_0, 5 - arg0:GetMapHitRadius(TARGET_SELF), 0, 0, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function DragonGuardianKnight_316010_Act10(arg0, arg1, arg2)
...
function DragonGuardianKnight_316010_Act11(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3007, TARGET_ENE_0, 5 - arg0:GetMapHitRadius(TARGET_SELF), 0, 0, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function DragonGuardianKnight_316010_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Turn, 2, TARGET_ENE_0, 90)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function DragonGuardianKnight_316010_Act21(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function DragonGuardianKnight_316010_Act22(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SpinStep, 5, 6001, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function DragonGuardianKnight_316010_Act23(arg0, arg1, arg2)
    ...
    if local0 < 40 and arg0:IsFinishTimer(1) == true and arg0:HasSpecialEffectId(TARGET_SELF, 11300) == true then
        DragonGuardianKnight_316010_Act07(arg0, arg1, arg2)
...
function DragonGuardianKnight_316010_Act24(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 5, TARGET_ENE_0, 3, TARGET_SELF, false, 9910)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function DragonGuardianKnight_316010_Act25(arg0, arg1, arg2)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_SuccessGuard) then
        if local0 < 4 and local1 <= 50 then
            arg2:ClearSubGoal()
        ...
        if arg1:GetSpecialEffectActivateInterruptType(0) == 5026 and arg1:HasSpecialEffectAttribute(TARGET_ENE_0, SP_EFFECT_TYPE_TARGET_DOWN) == false and local1 <= 60 then
            ...
            if arg1:GetSpecialEffectActivateInterruptType(0) == 5030 then
                ...
                if arg1:GetSpecialEffectActivateInterruptType(0) == 5031 then
                    arg2:ClearSubGoal()
                    DragonGuardianKnight_316010_Act07(arg1, arg2, paramTbl)
                    return true
                else
                    return false
                end
...
RegisterTableGoal(GOAL_DragonGuardianKnight_316010_AttackStance, "DragonGuardianKnight_316010_AttackStance")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_DragonGuardianKnight_316010_AttackStance, true)
Goal.Activate = function (arg0, arg1, arg2)
    local local0 = 3
    local local1 = 999
    local local2 = 0
