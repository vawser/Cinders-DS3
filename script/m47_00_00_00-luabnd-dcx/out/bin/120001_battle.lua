RegisterTableGoal(GOAL_DwarfishHuman_120001_Battle, "DwarfishHuman_120001_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_DwarfishHuman_120001_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act03)
    local1[4] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act04)
    local1[5] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act05)
    local1[6] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act06)
    local1[10] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act10)
    local1[11] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act11)
    local1[12] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act12)
    local1[13] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act13)
    local1[14] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act14)
    local1[20] = REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_Act20)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, DwarfishHuman_120001_ActAfter_AdjustSpace), local2)
    return 
end

function DwarfishHuman_120001_Act01(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 3 - arg0:GetMapHitRadius(TARGET_SELF), 3 - arg0:GetMapHitRadius(TARGET_SELF), 3 - arg0:GetMapHitRadius(TARGET_SELF), 100, 0, 5, 8)
    local local0 = 3000
    ...
    if arg0:GetRandam_Int(1, 100) <= 25 then
        ...
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, 3 - arg0:GetMapHitRadius(TARGET_SELF) + 1, local2, local3, 0, 0)
...
function DwarfishHuman_120001_Act02(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 3 - arg0:GetMapHitRadius(TARGET_SELF), 3 - arg0:GetMapHitRadius(TARGET_SELF), 3 - arg0:GetMapHitRadius(TARGET_SELF), 100, 0, 5, 8)
    local local0 = 3 - arg0:GetMapHitRadius(TARGET_SELF) + 1
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3002, TARGET_ENE_0, 2 - arg0:GetMapHitRadius(TARGET_SELF), 0, 20, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function DwarfishHuman_120001_Act03(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 3 - arg0:GetMapHitRadius(TARGET_SELF), 3 - arg0:GetMapHitRadius(TARGET_SELF), 3 - arg0:GetMapHitRadius(TARGET_SELF), 100, 0, 5, 8)
...
function DwarfishHuman_120001_Act04(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 2 - arg0:GetMapHitRadius(TARGET_SELF), 2 - arg0:GetMapHitRadius(TARGET_SELF), 2 - arg0:GetMapHitRadius(TARGET_SELF), 100, 0, 5, 8)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3004, TARGET_ENE_0, 2 - arg0:GetMapHitRadius(TARGET_SELF), 0, 20, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function DwarfishHuman_120001_Act05(arg0, arg1, arg2)
...
function DwarfishHuman_120001_Act06(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 8 - arg0:GetMapHitRadius(TARGET_SELF), 8 - arg0:GetMapHitRadius(TARGET_SELF), 8 - arg0:GetMapHitRadius(TARGET_SELF), 100, 0, 5, 8)
...
function DwarfishHuman_120001_Act10(arg0, arg1, arg2)
    local local0 = 10
...
function DwarfishHuman_120001_Act11(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, 4, TARGET_ENE_0, arg0:GetRandam_Int(0, 1), arg0:GetRandam_Int(30, 45), true, true, -1)
    return 
end

function DwarfishHuman_120001_Act12(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, ATT3011_DIST_MAX, ATT3011_DIST_MAX + 0.9, ATT3011_DIST_MAX + 4, 0, 0, 5, 0)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3011, TARGET_ENE_0, 2 - arg0:GetMapHitRadius(TARGET_SELF), 0, 20, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function DwarfishHuman_120001_Act13(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_EnemyStepLR, 5, TARGET_ENE_0, 5)
    return 
end

function DwarfishHuman_120001_Act14(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SpinStep, 5, 6001, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 5)
    return 
end

function DwarfishHuman_120001_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Turn, 2, TARGET_ENE_0, 0, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function DwarfishHuman_120001_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_DwarfishHuman_120001_AfterAttackAct, 10)
    return 
end
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if Damaged_Act(arg1, arg2, 4.5, 50) then
        if arg1:GetHpRate(TARGET_SELF) <= 0.3 then
            DwarfishHuman_120001_Act14(arg1, arg2, paramTbl)
            return true
        elseif arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 90) and arg1:GetDist(TARGET_ENE_0) <= 1 then
            DwarfishHuman_120001_Act04(arg1, arg2, paramTbl)
            return true
        end
    end
    local local1 = arg1:GetDist(TARGET_ENE_0)
    if arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 90) then
        DwarfishHuman_120001_Act20(arg1, arg2, paramTbl)
        return true
    else
        return false
    end
...
RegisterTableGoal(GOAL_DwarfishHuman_120001_AfterAttackAct, "DwarfishHuman_120001_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_DwarfishHuman_120001_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)
