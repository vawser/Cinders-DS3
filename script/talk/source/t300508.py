...
def t300508_1():
    ...
    """ State 2 """
    while True:
        call = t300508_x0() # Host Player
        assert IsClientPlayer() == 1
        """ State 3 """
        call = t300508_x1() # Client Player
...
def t300508_x1():
    """ State 0,1 """
    assert t300508_x2() # Clear Talk State
    """ State 2 """
    return 0
...
def t300508_x4():
    """ State 0,5 """
    while True:
        call = t300508_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000) # Interaction State
        if call.Done():
            """ State 3 """
            call = t300508_x8() # Menu Pre-loop
            if call.Done():
                pass
            elif IsAttackedBySomeone() == 1:
                """ State 1 """
                Label('L0')
                call = t300508_x6() # Attack Check
                def ExitPause():
                    RemoveMyAggro()
                if call.Done():
                    pass
                ...
                """ State 4 """
                call = t300508_x7() # Distance Check
            ...
            break
    """ State 2 """
    t300508_x2() # Clear Talk State
    
# Interaction State
def t300508_x5(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """ State 0,1 """
    while True:
...
#----------------------------------------------------
# Acquire Gesture
def t300508_x50(z2=_, z3=_, flag1=_):
    """ State 0,1 """
