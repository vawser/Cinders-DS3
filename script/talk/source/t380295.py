...
def t380295_x0():
    ...
    if GetEventStatus(1344) == 1:
        ...
        if not GetEventStatus(73800100):
            ...
            assert t380295_x15(text1=29000500, flag1=0, mode1=1)
            """ State 4 """
            ClearTalkListData()
            """ State 5 """
            # action:14019000:No
            ...
            if GetTalkListEntryResult() == 1:
                ...
                assert t380295_x14(text2=29000600, z1=73800100, flag2=0, mode2=1)
            else:
                pass
        else:
            """ State 8,22 """
            # talk:29000700:If you happen upon Horace, please tell him.
            assert t380295_x15(text1=29000700, flag1=0, mode1=1)
    else:
        """ State 9 """
        if GetEventStatus(50006190) == 1:
            """ State 17,25 """
            # talk:29001000:I will soon head to the lake.
            assert t380295_x15(text1=29001000, flag1=0, mode1=1)
        else:
            """ State 18 """
            if not GetEventStatus(73800101):
                """ State 10,23 """
                # talk:29000800:Ah, hello, we meet again.
                assert t380295_x15(text1=29000800, flag1=0, mode1=1)
            else:
                """ State 26 """
                # talk:29001200:Oh, Horace. Where have you run off to?
                assert t380295_x15(text1=29001200, flag1=0, mode1=1)
            """ State 11 """
            ClearTalkListData()
            """ State 12 """
            ...
            if GetTalkListEntryResult() == 1:
                ...
                assert t380295_x14(text2=29000900, z1=73800102, flag2=0, mode2=1)
                """ State 19 """
                SetEventState(73800101, 1)
                """ State 27 """
                # lot:61900:Ring of the Evil Eye
                assert t380295_x16(lot1=61900)
                ...
                if GetEventStatus(73800101) == 1:
                    ...
                    assert t380295_x14(text2=29001100, z1=73800101, flag2=0, mode2=1)
            else:
                pass
    """ State 29 """
    return 0
...
def t380295_x2():
    ...
    if GetEventStatus(1358) == 1:
        ...
        if GetDistanceToPlayer() < 10:
            """ State 4,7 """
            # talk:29002320: 
            call = t380295_x15(text1=29002320, flag1=0, mode1=1)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 12:
                """ State 6 """
...
def t380295_x7():
    ...
    if not GetEventStatus(73800123):
        ...
        assert t380295_x13(text3=29001820, z2=73800123, flag3=0, mode3=1)
    else:
        """ State 6,5 """
        ...
        assert t380295_x15(text1=29001920, flag1=0, mode1=1)
    """ State 11 """
    return 0
...
def t380295_x8():
    ...
    if not GetEventStatus(73800120):
        ...
        assert t380295_x13(text3=29002020, z2=73800120, flag3=0, mode3=1)
    else:
        """ State 2 """
        pass
    """ State 5 """
...
def t380295_x9():
    """ State 0,5 """
    while True:
        call = t380295_x10(z3=6000, flag4=1355, flag5=6000, flag6=6000, flag7=6000, flag8=6000)
        if call.Done():
            """ State 3 """
            call = t380295_x0()
            if call.Done():
...
def t380295_x10(z3=6000, flag4=1355, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """ State 0,1 """
    while True:
...
def t380295_x13(text3=_, z2=_, flag3=0, mode3=1):
    """ State 0,5 """
    assert t380295_x12() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 2 """
    SetEventState(z2, 1)
    """ State 1 """
...
def t380295_x14(text2=_, z1=_, flag2=0, mode2=1):
    """ State 0,5 """
    assert t380295_x12() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t380295_x15(text1=_, flag1=0, mode1=1):
    """ State 0,4 """
    assert t380295_x12() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t380295_x17():
    ...
    while True:
        call = t380295_x5()
        assert not GetEventStatus(1344) or GetEventStatus(9013) == 1
        """ State 2 """
        call = t380295_x6()
        assert GetEventStatus(1344) == 1 and not GetEventStatus(9013)
