...
def t400009_x1(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """ State 0,1 """
    while True:
...
def t400009_x4(text3=12002600, z3=74000115, flag3=0, mode3=1):
    """ State 0,5 """
    assert t400009_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 2 """
    SetEventState(z3, 1)
    """ State 1 """
    # talk:12002600: 
...
def t400009_x5(text2=_, z2=_, flag2=0, mode2=0):
    """ State 0,5 """
    assert t400009_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t400009_x6(text1=_, flag1=0, mode1=_):
    """ State 0,4 """
    assert t400009_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
    ...
    if GetEventStatus(1018) == 1:
        ...
        if GetDistanceToPlayer() < 10:
            ...
            if GetEventStatus(50006020) == 1:
                """ State 6,9 """
                # talk:12002900: 
                call = t400009_x6(text1=12002900, flag1=0, mode1=1)
                if call.Done():
                    Goto('L0')
                elif GetDistanceToPlayer() > 12:
                    pass
                ...
                """ State 7,10 """
                # talk:12002950: 
                call = t400009_x6(text1=12002950, flag1=0, mode1=1)
                if call.Done():
                    Goto('L0')
                elif GetDistanceToPlayer() > 12:
                    pass
...
def t400009_x18():
    ...
    if not GetEventStatus(74000115):
        """ State 2,5 """
        # talk:12002600: 
        assert t400009_x4(text3=12002600, z3=74000115, flag3=0, mode3=1)
    else:
        """ State 3,6 """
        # talk:12002700: 
        assert t400009_x6(text1=12002700, flag1=0, mode1=1)
        """ State 4 """
...
def t400009_x19():
    ...
    if GetEventStatus(1002) == 1:
        ...
        if GetEventStatus(50006020) == 1:
            ...
            assert t400009_x6(text1=12002100, flag1=0, mode1=1)
        else:
            """ State 7,11 """
            # talk:12002300:Mayst thou thy peace discov'r.
            assert t400009_x6(text1=12002300, flag1=0, mode1=1)
    else:
        """ State 2 """
        if GetEventStatus(50006020) == 1:
            """ State 3,8 """
            # talk:12000400:Farewell, ashen one.
            assert t400009_x6(text1=12000400, flag1=0, mode1=1)
        else:
            """ State 4,9 """
            # talk:12000500:Farewell, ashen one.
            assert t400009_x6(text1=12000500, flag1=0, mode1=1)
    """ State 12 """
    return 0
...
def t400009_x20():
    ...
    if GetEventStatus(50006020) == 1:
        ...
        if GetEventStatus(9300) == 1 and not GetEventStatus(1002):
            ...
            assert t400009_x6(text1=12000700, flag1=0, mode1=0)
        else:
            """ State 3,19 """
            # talk:12000600:Ashen one, to be unkindled is to be a vessel for souls.
            assert t400009_x6(text1=12000600, flag1=0, mode1=0)
    else:
        """ State 5 """
        if not GetEventStatus(74000130) and not GetEventStatus(74000131):
            ...
            assert (t400009_x6(text1=12000800, flag1=0, mode1=0) and (not CheckSpecificPersonGenericDialogIsOpen(2)
            ...
            if GetTalkListEntryResult() == 1:
                ...
                assert t400009_x5(text2=12000900, z2=74000130, flag2=0, mode2=0)
            elif GetTalkListEntryResult() == 2:
                """ State 16,25 """
                # talk:12001100:Of course not.
                assert t400009_x5(text2=12001100, z2=74000131, flag2=0, mode2=0)
            else:
                """ State 18 """
                pass
        else:
            ...
            if GetEventStatus(74000130) == 1:
                ...
                if not GetEventStatus(74000132) or GetEventStatus(74000110) == 1:
                    ...
                    assert t400009_x6(text1=12001000, flag1=0, mode1=0)
                else:
                    """ State 11,26 """
                    # talk:12001900:Ashen one, forgive me if this soundeth strange.
                    assert t400009_x5(text2=12001900, z2=74000110, flag2=0, mode2=0)
            else:
                """ State 9,22 """
                # talk:12001200:Ashen one, kill me, and take these eyes away.
                assert t400009_x6(text1=12001200, flag1=0, mode1=0)
    """ State 27 """
    return 0

def t400009_x21(goods1=2138):
    """ State 0,6 """
    # action:12002000:Give <?gdsparam@2138?>?
    call = t400009_x0(action2=12002000)
    if call.Get() == 0:
        """ State 2,1 """
        ...
        assert t400009_x6(text1=12003300, flag1=0, mode1=0)
    elif call.Done():
        """ State 4 """
        pass
    """ State 8 """
...
def t400009_x22(goods2=390):
    """ State 0,5 """
    # action:12002001:Give <?gdsparam@390?>?
    call = t400009_x0(action2=12002001)
    if call.Get() == 0:
        """ State 2,1 """
        ...
        assert (t400009_x6(text1=12003400, flag1=0, mode1=0) and (not CheckSpecificPersonGenericDialogIsOpen(2)
                and not (CheckSpecificPersonMenuIsOpen(-1, 2) == 1 and not CheckSpecificPersonGenericDialogIsOpen(2))))
        """ State 7 """
        # action:13002030:The Fire Keeper is now able to heal the dark sigil
        assert t400009_x7(action1=13002030)
        """ State 8 """
        # talk:12003500:Forgive me, sister.
        assert t400009_x6(text1=12003500, flag1=0, mode1=0)
    elif call.Done():
        """ State 4 """
        pass
    """ State 9 """
...
def t400009_x23(goods3=490, z1=0):
    ...
    if ComparePlayerInventoryNumber(3, goods3, 0, 0, 0) == 1:
        ...
        call = t400009_x0(action2=12002002)
        if call.Get() == 0:
            """ State 6 """
            if ComparePlayerStatus(8, 2, GetLevelUpSoulCost(GetStatus(33), GetStatus(33) + GetWorkValue(z1))):
                ...
                assert t400009_x7(action1=13002020) and GetWhetherChrEventAnimHasEnded(10000) == 1
            else:
                """ State 5,22 """
                # action:13000050:Insufficient souls
                assert t400009_x7(action1=13000050)
        elif call.Done():
            """ State 7 """
            pass
    """ State 25 """
...
def t400009_x24(goods3=490, z1=0):
    """ State 0,1 """
    # goods:490:Dark Sigil
...
def t400009_x26():
    """ State 0,5 """
    while True:
        call = t400009_x1(z4=6120, flag4=1015, flag5=6000, flag6=6000, flag7=6000, flag8=6000)
        if call.Done():
            """ State 3 """
