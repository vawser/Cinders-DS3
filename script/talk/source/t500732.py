...
def t500732_x1(flag1=75000120, flag2=75000121, z1=75000121, z2=75000121, flag3=1810):
    """ State 0,9 """
    assert t500732_x21()
    """ State 3 """
    ...
    if not GetEventStatus(1816) and not GetEventStatus(1817):
        ...
        if GetDistanceToPlayer() < 10:
            """ State 5,11 """
            call = t500732_x11(flag2=flag2, z1=z1, z2=z2, flag3=flag3)
            if call.Done():
                pass
                ...
                if GetDistanceToPlayer() < 10 and GetPlayerYDistance() < 4.9:
                    """ State 7,12 """
                    call = t500732_x12(flag1=flag1, flag3=flag3)
                    if call.Done():
                        pass
...
def t500732_x3(flag3=1810):
    """ State 0,3 """
    if GetEventStatus(1816) == 1 or GetEventStatus(1817) == 1:
        """ State 1 """
        if GetDistanceToPlayer() < 10:
            """ State 4,7 """
            call = t500732_x13(flag3=flag3)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 12:
                """ State 6 """
...
def t500732_x5(flag1=75000120, flag2=75000121, z1=75000121, z2=75000121):
    """ State 0,2 """
    call = t500732_x9(flag1=flag1, flag2=flag2, z1=z1, z2=z2, flag3=1810)
...
def t500732_x7(flag2=75000121, z1=75000121, z2=75000121, text2=_, text3=_):
    """ State 0,1 """
    if not GetEventStatus(flag2):
        """ State 3 """
        assert t500732_x23(text5=text2, flag1=flag2, flag8=0, mode3=1)
    else:
        """ State 2 """
        SetEventState(flag2, 0)
        """ State 4 """
        assert t500732_x25(text1=text3, flag6=0, mode1=1)
    """ State 5 """
    return 0

def t500732_x8(flag1=75000120, text5=_):
    """ State 0,3 """
    if not GetEventStatus(flag1):
        """ State 1,4 """
        assert t500732_x23(text5=text5, flag1=flag1, flag8=0, mode3=1)
    else:
        """ State 2 """
        pass
    """ State 5 """
...
def t500732_x9(flag1=75000120, flag2=75000121, z1=75000121, z2=75000121, flag3=1810):
    """ State 0,5 """
    while True:
        ...
        if call.Done():
            ...
            if call.Done():
                ...
                """ State 1 """
                Label('L0')
                call = t500732_x1(flag1=flag1, flag2=flag2, z1=z1, z2=z2, flag3=flag3)
                def ExitPause():
                    RemoveMyAggro()
                if call.Done():
                    pass
...
def t500732_x10(flag5=1810):
    ...
    if GetEventStatus(flag5) == 1:
        """ State 3 """
        assert t500732_x25(text1=83002800, flag6=0, mode1=1)
    else:
        """ State 2 """
        assert t500732_x25(text1=83002400, flag6=0, mode1=1)
    """ State 4 """
    return 0

def t500732_x11(flag2=75000121, z1=75000121, z2=75000121, flag3=1810):
    """ State 0,1 """
    if GetEventStatus(flag3) == 1:
        """ State 3 """
        assert t500732_x7(flag2=flag2, z1=z1, z2=z2, text2=83002600, text3=83002610)
    else:
        """ State 2 """
        assert t500732_x7(flag2=flag2, z1=z1, z2=z2, text2=83002200, text3=83002210)
    """ State 4 """
    return 0

def t500732_x12(flag1=75000120, flag3=1810):
    """ State 0,1 """
    if GetEventStatus(flag3) == 1:
        """ State 3 """
        assert t500732_x8(flag1=flag1, text5=83002700)
    else:
        """ State 2 """
        assert t500732_x8(flag1=flag1, text5=83002300)
    """ State 4 """
    return 0

def t500732_x13(flag3=1810):
    """ State 0,1 """
    if GetEventStatus(flag3) == 1:
        """ State 3 """
        assert t500732_x25(text1=83002900, flag6=0, mode1=1)
    else:
        """ State 2 """
        assert t500732_x25(text1=83002500, flag6=0, mode1=1)
    """ State 4 """
    return 0
...
def t500732_x14():
    ...
    if not GetEventStatus(75000100):
        ...
        if not GetEventStatus(75000101):
            ...
            """ State 5 """
            assert t500732_x25(text1=83000200, flag6=0, mode1=1)
    """ State 6 """
    return 0
...
def t500732_x15():
    ...
    if GetEventStatus(15000703) == 1:
        ...
        if not GetEventStatus(50006621):
            ...
            """ State 14 """
            Label('L0')
            assert t500732_x25(text1=83000800, flag6=0, mode1=1)
    else:
        """ State 2 """
        if GetEventStatus(55000450) == 1:
            ...
            if not GetEventStatus(50006620):
                """ State 11 """
                assert t500732_x25(text1=83000600, flag6=0, mode1=1)
                """ State 12 """
                # lot:66200:Siegbräu
                assert t500732_x26(lot1=66200)
            else:
                """ State 6 """
            ...
            if not GetEventStatus(75000102):
                ...
                if not GetEventStatus(75000103):
                    ...
                    """ State 10 """
                    assert t500732_x25(text1=83000500, flag6=0, mode1=1)
    """ State 17 """
    return 0
...
def t500732_x16():
    ...
    if not GetEventStatus(50006622):
        """ State 10 """
        assert t500732_x25(text1=83000900, flag6=0, mode1=1)
        """ State 5 """
        # lot:66220:Siegbräu
        assert t500732_x26(lot1=66220)
        """ State 6 """
        Label('L0')
        assert t500732_x25(text1=83000950, flag6=1, mode1=1)
        """ State 4 """
        ...
        if not GetEventStatus(75100200):
            ...
            if not GetEventStatus(75100201):
                ...
                """ State 9 """
                assert t500732_x25(text1=83001100, flag6=0, mode1=1)
    """ State 12 """
    return 0
...
def t500732_x17():
    ...
    if not GetEventStatus(75100205):
        ...
        if not GetEventStatus(75100206):
            ...
            """ State 7 """
            assert t500732_x25(text1=83001800, flag6=0, mode1=1)
    """ State 12 """
    return 0
...
def t500732_x18():
    ...
    if not GetEventStatus(75100207):
        ...
        """ State 4 """
        assert t500732_x25(text1=83002000, flag6=0, mode1=1)
    """ State 6 """
    return 0
...
def t500732_x19(text1=_, z5=_):
    ...
    if GetTalkListEntryResult() == 1:
        ...
        if not GetEventStatus(75100202):
            """ State 9 """
            assert t500732_x25(text1=83001300, flag6=0, mode1=1)
            Goto('L0')
        else:
            Goto('L0')
    else:
...
def t500732_x23(text5=_, flag1=_, flag8=0, mode3=1):
    """ State 0,5 """
...
def t500732_x25(text1=_, flag6=_, mode1=1):
    """ State 0,4 """
    assert t500732_x22() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
...
def t500732_x28():
    """ State 0,1 """
    while True:
        call = t500732_x5(flag1=75000120, flag2=75000121, z1=75000121, z2=75000121)
        assert not GetEventStatus(1802) and not GetEventStatus(1806)
        """ State 2 """
        call = t500732_x6()
