...
def t511001_x1():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """ State 3,16 """
        call = t511001_x9(z1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """ State 7 """
    ...
    """ State 15 """
    while True:
        call = t511001_x9(z1=6101, flag1=6001, flag2=6000)
        if call.Done():
            break
        elif GetEventStatus(15115852) == 1:
            """ State 12 """
            assert not GetEventStatus(15115852)
    """ State 5 """
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            if GetEventStatus(2030) == 1:
                ...
                assert t511001_x10(action1=10010713)
...
def t511001_x8(z2=17, z3=9019, flag3=6067):
    """ State 0,1 """
...
def t511001_x9(z1=_, flag1=6001, flag2=6000):
    """ State 0,1 """
    while True:
...
def t511001_x10(action1=10010713):
    """ State 0,1 """
    # action:10010713:Game installation incomplete.\nCannot travel between bonfires.
