...
def t511504_1():
    ...
    """ State 2 """
    while True:
        call = t511504_x0() # Host Player
        assert IsClientPlayer() == 1
        """ State 3 """
        call = t511504_x1() # Client Player
...
def t511504_x1():
    """ State 0,1 """
    assert t511504_x2() # Clear Talk State
    """ State 2 """
    return 0
...
def t511504_x4():
    """ State 0,5 """
    while True:
        call = t511504_x5() # Interaction State
        if call.Done():
            """ State 3 """
            call = t511504_x8() # Menu Pre-loop
            if call.Done():
                pass
            elif IsAttackedBySomeone() == 1:
                """ State 1 """
                Label('L0')
                call = t511504_x6() # Attack Check
                def ExitPause():
                    RemoveMyAggro()
                if call.Done():
                    pass
...
def t511504_x9():
    ...
    while True:
        ...
        # Talk
            ...
            assert t511504_x10(text1=10019000, flag1=0, mode1=0)
            return 0
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0

# Talk Function
def t511504_x10(text1=_, flag1=0, mode1=_):
    """ State 0,4 """
    assert t511504_x11() and CheckSpecificPersonTalkHasEnded(0) == 1
    """ State 1 """
