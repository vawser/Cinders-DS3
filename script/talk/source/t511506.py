...
def t511506_x1(action_button=_, flag=_):
    """State 0"""
    while True:
        """State 1"""
...
# Talk to Player
def t511506_x4(text=_, end_mode=_):
    """State 0,5"""
...
# Talk to Player
def t511506_x5(text=_, end_mode=_):
    """State 0,5"""
    assert t511506_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
    TalkToPlayer(text, -1, -1, 0)
...
# Talk to Player
def t511506_x6(text=_, end_mode=_):
    """State 0,4"""
    assert t511506_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
    TalkToPlayer(text, -1, -1, 0)
